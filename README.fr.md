...
> **🆕 Dernière version — v1.225.0** — **Bannière de logos de fournisseurs** — une bannière des 18 fournisseurs de LLM — vrais logos pour 11, monogramme pour 7 — coiffe désormais le README et le guide d'aide. **2784 tests.**
