...
> **🆕 Dernière version — v1.227.0** — **Hong Kong et des relances plus nettes** — JobsDB Hong Kong rejoint Jobstreet/SEEK (désormais sur l'API v5), un filtre « à traiter uniquement » sur le tableau de cadence, et les employeurs confidentiels affichent l'agence qui les a présentés — parité avec la 1.30.0 du projet parent. **2837 tests.**
