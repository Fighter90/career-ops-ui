...
> **🆕 Dernière version — v1.197.0** — **Suivez un tableau Getro rien qu'avec son URL** — donnez à un tableau Getro suivi sa propre `careers_url` et l'id numérique de collection **se résout désormais automatiquement** depuis la page (une requête protégée contre le SSRF), sans recherche manuelle. **2527 tests.**
>
