...
> **🆕 Dernière version — v1.223.0** — **Correctif du badge d'éval + installation du coworker** — une ⚡ éval en direct réussie n'est plus peinte en rouge, et le coworker OpenWorker s'installe depuis son URL GitHub / .zip / une commande. **2783 tests.**
>
