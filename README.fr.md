...
> **🆕 Dernière version — v1.214.0** — **Les descriptions alimentent le filtre de contenu + séniorité plus fine** — les annonces Greenhouse / Ashby / Recruitee peuvent désormais être filtrées par contenu, et « Associate <titre senior> » (rangs académiques compris) est classé senior au lieu d'entry-level. **2736 tests.**
>
