...
> **🆕 Dernière version — v1.212.1** — **Correctif du compteur de sources de la landing** — cvstart.org listait 80 sources et écartait Job Bank (Canada) après la v1.212.0 ; retour à 81 en phase avec l'app, et la build du site échoue désormais dur à tout écart de compte. **2687 tests.**
>
