...
> **🆕 Dernière version — v1.191.0** — **Quoi apprendre ensuite** — un nouvel onglet `#/stats` classe les compétences qui coulent le plus souvent vos faibles compatibilités (pondérées, niveaux Critical/High/Medium) — pour savoir quoi étudier en premier. **2504 tests.**
>
