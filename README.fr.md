...
> **🆕 Dernière version — v1.227.3** — **Les préfixes du filtre de titres fonctionnent** — `word:` / `stem:` étaient comparés au texte littéral, rendant ces lignes inopérantes (une règle `word:intern` ne filtrait rien ici et fonctionnait en CLI). Porté du parent, frontières Unicode comprises. **2852 tests.**
