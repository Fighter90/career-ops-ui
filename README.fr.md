...
> **🆕 Dernière version — v1.224.0** — **Vrais logos des fournisseurs** — les tuiles des fournisseurs LLM affichent désormais le vrai logo de marque (Anthropic, OpenAI, Gemini, DeepSeek, Mistral, Ollama, …) là où le fournisseur publie une icône open-source — toujours sûr pour la CSP (SVG en ligne, aucune ressource distante). **2784 tests.**
>
