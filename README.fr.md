...
> **🆕 Dernière version — v1.227.2** — **Correctif petits écrans** — `#/config` ne défile plus latéralement à ≤ 352 px : 18 selects portaient un `min-width: 300px` en ligne incapable de rétrécir. Désormais sous garde via un balayage Playwright à 320 px. **2846 tests · 101 Playwright.**
