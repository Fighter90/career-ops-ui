...
> **🆕 Dernière version — v1.184.0** — **Grille régulière du Tableau de bord** — les tuiles d'action rapide utilisent désormais des colonnes de largeur égale, si bien qu'un groupe de 3 n'est plus plus large qu'un groupe de 4 et chaque section s'aligne à droite. **2479 tests.**
>
