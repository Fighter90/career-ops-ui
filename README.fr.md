...
> **🆕 Dernière version — v1.207.2** — **Les plans IA s'affichent de nouveau correctement** — le plan de développement et le profil d'orientation n'apparaissent plus comme un vidage de code à chasse fixe quand le modèle enveloppe toute sa réponse dans une clôture ```markdown. **2621 tests.**
>
