...
> **🆕 Dernière version — v1.220.0** — **Get on Board, plusieurs catégories** — une entrée peut désormais scanner `programming`, `operations-management`, `machine-learning-ai`, … (dédupliqué, plafonné à 12) pour que les recherches EM/data ne ratent pas les rôles que le tableau sépare. **2771 tests.**
>
