...
> **🆕 Dernière version — v1.200.0** — **Vérification « toujours ouverte ? » pour les offres ATS** — sur #/tracker, un clic interroge le JSON public d'une offre Greenhouse/Lever/Ashby/Workday/SmartRecruiters (zéro token, sans navigateur) et affiche **Ouverte / Expirée / Inconnue**. **2557 tests.**
>
