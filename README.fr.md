...
> **🆕 Dernière version — v1.217.1** — **Ark rejoint la liste** — BytePlus Ark + Volcengine Ark (Doubao de ByteDance) sont désormais des fournisseurs d’évaluation ⚡ en direct (**18 au total**), chacun avec son monogramme de marque dans les Réglages. **2756 tests.**
>
