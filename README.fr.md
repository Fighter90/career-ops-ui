...
> **🆕 Dernière version — v1.225.1** — **Correction de la bannière fournisseurs** — la bannière de logos s'affiche désormais correctement dans le README et l'aide (PNG rendu via URL absolue ; le SVG au XML invalide est corrigé). **2784 tests.**
