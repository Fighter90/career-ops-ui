...
[![tests](https://img.shields.io/badge/tests-2858%20passed-brightgreen)](#tests)
...
> **🆕 Dernière version — v1.227.4** — **Correctif des préfixes, partie 2** — `word:` / `stem:` étaient encore ignorés par `content_filter` ; la v1.227.3 n'avait câblé que le filtre de titres. Repéré en revue IA. **2858 tests.**
