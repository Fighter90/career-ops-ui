...
> **🆕 Dernière version — v1.180.0** — **Rapports en tableau** — `#/reports` est désormais un tableau (Rapport · Date · Légitimité · Score) ; une longue puce « Score non détecté » ne coupe plus le nom caractère par caractère, et un score réel que masquait un espace réservé de Machine Summary est récupéré. **2465 tests.**
>
