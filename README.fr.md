...
> **🆕 Dernière version — v1.199.0** — **Les tableaux larges défilent horizontalement** — les tableaux plus larges que la fenêtre (Scan, Suivi, Statistiques…) étaient coupés sans barre de défilement ; ils affichent désormais une **barre horizontale** au besoin, donc chaque colonne reste accessible. **2540 tests.**
>
