...
[![tests](https://img.shields.io/badge/tests-2510%20passed-brightgreen)](#tests)
...
> **🆕 Dernière version — v1.193.0** — **Silence après l'entretien** — un nouvel onglet `#/stats` liste les entretiens devenus silencieux au-delà d'une fenêtre de courtoisie (30 jours par défaut) — avec la durée du silence et la date du dernier entretien. **2510 tests.**
>
