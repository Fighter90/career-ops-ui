...
> **🆕 Dernière version — v1.221.0** — **Durcissement anti-DNS-rebinding** — le scanner refuse désormais toute source dont l’hôte se résout vers une adresse privée/loopback/de métadonnées cloud (p. ex. `169.254.169.254`) — défense en profondeur au-dessus des protections SSRF existantes. **2775 tests.**
>
