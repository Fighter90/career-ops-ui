...
> **🆕 Dernière version — v1.226.0** — **Deux sources d'emploi vietnamiennes** — ITviec + CareerViet rejoignent le scanner (85 sources · 80 adaptateurs) — parité avec le projet parent 1.30.0. **2818 tests.**
