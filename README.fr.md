...
> **🆕 Dernière version — v1.175.0** — **Garde de régression de la description SEO** — un test CI échoue désormais si l'une des 17 langues du site perd le placeholder `{adapters}` ou recode un compte (la dérive du bug "~55"), plus un strip de légitimité résistant aux nuls. **2451 tests.**
>
