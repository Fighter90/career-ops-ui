...
> **🆕 Dernière version — v1.198.0** — **Nouvelles tentatives de scan plus intelligentes** — quand un tableau limite le débit (HTTP 429/5xx) en cours de scan, les tentatives utilisent désormais un **backoff exponentiel + jitter** et respectent un `Retry-After` (borné) au lieu d'un délai court fixe. **2536 tests.**
>
