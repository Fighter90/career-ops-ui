...
> **🆕 Dernière version — v1.222.0** — **Aides de fournisseur localisées** — les aides de clé, de modèle et d'URL de base des fournisseurs étendus (DeepSeek … Volcengine Ark) sous Paramètres → Clés API sont désormais traduites dans les 17 langues, plus seulement en anglais. **2779 tests.**
>
