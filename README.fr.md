...
> **🆕 Dernière version — v1.192.0** — **Vérifiez les faits de votre CV** — un nouveau garde-fou dans `#/cv-studio` vérifie un CV ou une lettre adaptés par rapport à vos vrais CV/profil/two-pager et signale chaque métrique inventée ou affirmation non étayée (pass/warn/block). **2508 tests.**
>
