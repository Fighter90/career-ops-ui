...
> **🆕 Dernière version — v1.194.0** — **URLs Workday à un seul segment corrigées** — des pages comme `https://parsons.wd5.myworkdayjobs.com/Search` (un seul segment) pointent désormais vers le bon flux d'offres au lieu de retomber sur `External`. Signalé dans #255. **2517 tests.**
>
