...
> **🆕 Dernière version — v1.201.0** — **Les en-têtes de suivi localisés ne s'affichent plus vides** — un `data/applications.md` avec des en-têtes non anglais ou variantes (`empresa`/`estado`, `position`/`stage`/`link`…) se replie désormais sur les champs canoniques. **2563 tests.**
>
