...
> **🆕 Dernière version — v1.148.0** — **Filtres de recherche plus clairs** — le panneau de filtres de `#/scan` est désormais une grille responsive ordonnée (auparavant un flex-wrap irrégulier), avec Appliquer / Réinitialiser sur une ligne dédiée alignée à droite. Mêmes filtres, plus lisibles. **2381 tests.**
>
