...
[![tests](https://img.shields.io/badge/tests-2458%20passed-brightgreen)](#tests)
...
> **🆕 Dernière version — v1.179.0** — **Consolidation des décodeurs** — 20 décodeurs d'entités HTML dupliqués dans les sources de scan passent désormais par un module partagé unique (−237 lignes), avec une garde contre la reduplication. Comportement préservé. **2458 tests.**
>
