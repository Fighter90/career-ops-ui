...
> **🆕 Dernière version — v1.216.0** — **Neuf fournisseurs LLM de plus** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks et Ollama local rejoignent l’évaluation ⚡ en direct (désormais **16 fournisseurs**), chacun avec un monogramme de marque dans les Réglages. **2752 tests.**
>
