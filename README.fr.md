...
[![tests](https://img.shields.io/badge/tests-2456%20passed-brightgreen)](#tests)
...
> **🆕 Dernière version — v1.178.0** — **Rafraîchissement de constantes (parité parent)** — le User-Agent du navigateur passe à Chrome 151 (parité des filtres WAF/bot) et le fallback des états du tracker reçoit les alias d'état turcs du parent. **2456 tests.**
>
