...
> **🆕 Dernière version — v1.172.0** — **Correction du plantage du décodeur d'entités HTML** — une entité numérique malformée (p. ex. `&#99999999;`) pouvait lever un `RangeError` et interrompre une source de scan ; un décodeur partagé limite désormais les références numériques au jeu Char de XML 1.0 (parité career-ops #2150). **2444 tests.**
>
