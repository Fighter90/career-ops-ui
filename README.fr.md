...
> **🆕 Dernière version — v1.227.5** — **Le scan régional n'épuise plus la mémoire** — il retenait tous les résultats bruts des 21 requêtes jusqu'à la fin (742 Mo contre le plafond de 490 Mo de la machine, 4 chutes du service en un jour) ; déduplication et filtrage se font désormais par requête → **177 Mo**. Plus un flake Playwright corrigé. **2865 tests.**
