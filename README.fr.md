...
> **🆕 Dernière version — v1.208.0** — **L'app tient sur votre téléphone** — plus aucune page ne défile sur le côté : la barre du haut s'enroule, les tableaux/code larges défilent dans leur cadre, l'aide s'empile et les longs chemins se coupent au lieu d'étirer la mise en page. **2621 tests.**
>
