...
> **🆕 Dernière version — v1.182.0** — **Fourchettes de salaire neutres** — les montants d'un seul côté dans le scan et le suivi s'affichent en `≥` / `≤` (p. ex. `≥ 120000 EUR`) au lieu de « from » / « up to » en anglais, pour se lire pareil dans toutes les langues. **2470 tests.**
>
