...
[![tests](https://img.shields.io/badge/tests-2845%20passed-brightgreen)](#tests)
...
> **🆕 Dernière version — v1.227.1** — **Corrections de l'aide** — la répartition des sources du §17 tombe juste (80 EN + 5 RU, contre 78+5=83), l'ancre de version périmée disparaît et la bannière GitHub ne s'imprime plus en balisage brut en tête de `#/help` — les trois sont désormais sous test. **2845 tests.**
