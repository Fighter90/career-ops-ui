...
**बदला गया (निम्न, स्कैनर) — Getro पैरिटी पोर्ट (पैरेंट #2640): वेतन, सभी स्थान, और `work_mode` रिमोट पहचान।**

### बदला गया
- पैरेंट के `providers/getro.mjs` विस्तार (#2640) का सुरक्षित हिस्सा `server/lib/sources/getro.mjs` में पोर्ट किया गया। एक Getro नौकरी अब एक **वेतन** प्रदर्शन स्ट्रिंग रखती है (`compensation_amount_min/max_cents` + मुद्रा से, केवल वार्षिक — remotli/lever स्ट्रिंग परिपाटी का अनुसरण जिसे क्लाइंट वेतन फ़िल्टर फिर से पार्स करता है), इसका **स्थान** **सभी** `locations` को जोड़ता है (पहले केवल पहला), और `work_mode: 'remote'` को मौजूदा `remote` फ़्लैग / स्थान टेक्स्ट के साथ रिमोट संकेत के रूप में माना जाता है। उस API प्रतिक्रिया से शुद्ध डेटा मैपिंग जिसे web-ui पहले से लाता है — कोई नया होस्ट नहीं, कोई SSRF सतह परिवर्तन नहीं।

### टिप्पणियाँ
- जानबूझकर पोर्ट नहीं किया गया: पैरेंट का `collection_id` **ऑटो-रिज़ॉल्व** (यह बोर्ड के अपने `careers_url` — एक मनमाना होस्ट — को लाता है, इसलिए यह web-ui की `safeGet` SSRF सीमा से गुज़रने वाले अलग बदलाव में आता है) और बढ़ी हुई 1500-पृष्ठ हार्ड कैप (web-ui ब्राउज़र-ट्रिगर स्कैन के लिए अपनी 200-पृष्ठ / 4000-नौकरी कैप रखता है)। इस समन्वयन में शेष 11 पैरेंट कमिट का web-ui में कोई मिरर नहीं है। टेस्ट: `tests/sources-getro.test.mjs` (+5)। सूट: **2470** (+5)।
