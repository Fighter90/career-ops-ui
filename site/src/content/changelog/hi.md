...
### जोड़ा गया
- **प्रदाता-लोगो बैनर।** एक स्व-निहित `images/providers.svg` — **18 LLM प्रदाता**, आइकन प्रकाशित करने वाले 11 के लिए **असली ब्रांड लोगो** ([simple-icons](https://simpleicons.org), CC0) और शेष 7 के लिए ब्रांड-रंग मोनोग्राम के साथ — अब README (×17) और इन-ऐप हेल्प गाइड के शीर्ष पर है। (ऐप स्वयं असली लोगो टाइलें रेंडर करता है; बैनर GitHub पर रेंडर होता है और ऐप में XSS-सुरक्षित रेंडरर उसे हटा देता है।)
...
### बदला गया
- **[OpenWorker coworker](https://github.com/Fighter90/career-ops-coworker) को उसके GitHub URL / .zip से इंस्टॉल करें।** coworker के दस्तावेज़ अब `docs/integrations/openworker.md`, इन-ऐप हेल्प §32 (×17) और README में एक-कमांड इंस्टॉलर (`curl … | bash`, idempotent — मौजूदा career-ops / web-ui को फिर से उपयोग करता है) और OpenWorker के तीन इंस्टॉल पथ (GitHub URL · `.zip` · सिंगल-फ़ाइल इम्पोर्ट) का वर्णन करते हैं।
...
### जोड़ा गया
- **OpenWorker coworker।** एक कोड-रहित [OpenWorker](https://github.com/andrewyng/openworker) coworker — [Fighter90/career-ops-coworker](https://github.com/Fighter90/career-ops-coworker) — पूरी नौकरी खोज (स्कैन, स्कोर, टेलर, ट्रैक, फॉलो-अप) चलाता है और **इस डैशबोर्ड को लॉन्च** कर सकता है, सब आपके डेस्कटॉप पर। यह 17 भाषाओं में उपलब्ध एक-फ़ाइल persona है, जिसे OpenWorker के अपने लोडर से इंस्टॉल-योग्य सत्यापित किया गया है।
