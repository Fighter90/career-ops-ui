...
**ガイドに質問。** サイドバー(ヘルプの下)の**ガイドに質問 💬**を開いて使い方を質問 — あなたの言語でこのガイドのみから回答し、履歴書は決して読みません。
...
**AI使用量とコスト。** **AI使用量**ページ(💳、ヘルスの隣)はライブAI生成のトークンをプロバイダーごとに24時間/7日/30日/全期間で表示し、編集可能な価格表からの推定USDコストを併記します(請求なし)。
