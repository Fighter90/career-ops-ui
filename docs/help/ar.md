...
**Hermes من Nous Research** وكيل مستقل مفتوح — استدعاء الأدوات والمهارات وأكثر من 20 قناة مراسلة، من بينها Telegram. يشرح هذا القسم كيف يمكنك تشغيل career-ops-ui على خادم سحابي وربط أحداثه بـ Telegram عبر وكيل Hermes. **هذه خطة، وليست ميزة مُطلقة:** لم يُوصَّل بعد Hermes كمزوّد LLM (معطَّل بانتظار تأكيد عقد واجهة برمجة تطبيقات Nous Portal)، لذا لا شيء في التطبيق يستدعي Hermes اليوم. الدليل الكامل للتصميم + النشر موجود في `docs/integrations/HERMES.md`، ومهارة `hermes-bridge` ترشدك عبر الخطوات.

### ما هو Hermes

Hermes هو بيئة تشغيل وكيل — وليس، على حدّ ما نستطيع تأكيده، مجرد واجهة chat-completions مستضافة. هذا يُشكّل التكامل بطريقتين. **الشكل A:** إذا تبيّن أن نقطة نهاية Nous Portal متوافقة مع OpenAI، يُضاف Hermes كمزوّد LLM آخر في سلسلة التطبيق. **الشكل B:** إذا لم يكن الوصول إليه ممكنًا إلا كبيئة تشغيل وكيل، فإن التطبيق يتواصل معه عبر مسار relay مخصّص أو وكيل يعمل محليًا. أيّهما ينطبق يُؤكَّد من Nous Portal ومستودع `NousResearch/hermes-agent` *قبل* كتابة أي كود — ولهذا لم يُبنَ المزوّد بعد عن قصد.
