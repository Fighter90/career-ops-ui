...
**اسأل الدليل.** افتح **اسأل الدليل 💬** (الشريط الجانبي، تحت المساعدة) واكتب سؤالاً — يجيب فقط من هذا الدليل بلغتك ولا يقرأ سيرتك الذاتية أبداً.
...
**استخدام الذكاء الاصطناعي وتكلفته.** تعرض صفحة **استخدام الذكاء الاصطناعي** (💳، بجوار الصحة) رموز التوليدات الحيّة لكل مزوّد خلال 24س/7أ/30ي/الكل، مع تكلفة تقديرية بالدولار من جدول أسعار قابل للتعديل (لا تُحتسب فاتورةً).
