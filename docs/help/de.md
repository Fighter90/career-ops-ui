...
das als Slash-Befehle innerhalb jeder KI-Coding-CLI läuft (Claude Code, Gemini CLI, Codex, Qwen Code, OpenCode, GitHub Copilot CLI — andere Claude-kompatible CLIs funktionieren über dieselbe Slash-Befehl-Oberfläche ebenfalls). Modellunabhängig. Es
...
|---|---|---|
| Wo es läuft | innerhalb Claude Code / Gemini CLI / Codex / Qwen Code / OpenCode / GitHub Copilot CLI | `http://127.0.0.1:4317` in Ihrem Browser |
