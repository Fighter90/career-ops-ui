...
**Nous Research का Hermes** एक ओपन, स्वायत्त एजेंट है — टूल-कॉलिंग, स्किल्स, और Telegram सहित 20+ मैसेजिंग चैनल। यह अनुभाग बताता है कि आप career-ops-ui को किसी क्लाउड सर्वर पर कैसे चलाएँगे और इसके इवेंट्स को Hermes एजेंट के ज़रिए Telegram से कैसे जोड़ेंगे। **यह एक योजना है, कोई जारी की गई सुविधा नहीं:** LLM प्रोवाइडर के रूप में Hermes अभी जुड़ा नहीं है (Nous Portal के API अनुबंध की पुष्टि तक रुका हुआ), इसलिए आज ऐप में कुछ भी Hermes को कॉल नहीं करता। पूरा डिज़ाइन + डिप्लॉयमेंट गाइड `docs/integrations/HERMES.md` में है, और `hermes-bridge` स्किल चरणों से गुज़ारती है।

### Hermes क्या है

Hermes एक एजेंट रनटाइम है — जहाँ तक हम पुष्टि कर सकते हैं, कोई साधारण होस्टेड chat-completions API नहीं। यह इंटीग्रेशन को दो तरह से आकार देता है। **रूप A:** यदि कोई Nous Portal एंडपॉइंट OpenAI-संगत निकलता है, तो Hermes ऐप की कैस्केड में एक और LLM प्रोवाइडर के रूप में जुड़ जाता है। **रूप B:** यदि वह केवल एजेंट रनटाइम के रूप में उपलब्ध है, तो ऐप उससे एक समर्पित relay रूट या स्थानीय रूप से चल रहे एजेंट के ज़रिए बात करता है। कौन-सा लागू होता है, यह कोई भी कोड लिखने से *पहले* Nous Portal और `NousResearch/hermes-agent` रिपॉज़िटरी से पुष्ट किया जाता है — इसीलिए प्रोवाइडर जानबूझकर अभी नहीं बनाया गया है।
