...
सबसे अधिक ज़रूरत पड़ने वाली कुंजियाँ। यह चयन है, पंजिका नहीं — `#/config` सभी पहचानी जाने वाली कुंजियाँ समूहबद्ध रूप में और हर एक के संकेत के साथ दिखाता है।
...
- **Save** (`POST /api/config`) हर मान वैलिडेट करता है, `<parent>/.env`
  ...
  की ज़रूरत नहीं।
- **खाली मान कुंजी को हटा देता है** — सेटिंग फिर से *अनसेट* हो जाती है और परियोजना का डिफ़ॉल्ट दोबारा लागू होता है।
- **ड्रॉपडाउन «डिफ़ॉल्ट का उपयोग करें (…)» से शुरू होते हैं।** इसे चुनने का अर्थ है कि कुंजी `.env` में **नहीं** है: ऐप परियोजना के डिफ़ॉल्ट का उपयोग करता है, और परियोजना जब भी उसे बदलेगी आपको नया मिलता रहेगा। नीचे की सूची से वही मान चुनना उसे **जड़** देता है — डिफ़ॉल्ट बदलने पर भी वह बना रहेगा।
- **जिस फ़ील्ड को आप छूते नहीं, वह कभी नहीं लिखा जाता।** अनसेट फ़ील्ड डिफ़ॉल्ट दिखाता है ताकि आप देख सकें कि सर्वर क्या उपयोग करेगा; जब तक आप वास्तव में फ़ील्ड संपादित न करें, वह दिखाया गया मान सहेजा नहीं जाता।
- **सहेजना बताता है कि क्या बदला।** सूचना लिखी गई *और* हटाई गई दोनों कुंजियाँ गिनती है, इसलिए फ़ील्ड खाली करने पर «· 1» दिखता है, «· 0» नहीं।
...
**Personio टेनेंट को पिन करना (v1.237.0)।** कई कंपनियां अपने Personio
बोर्ड को एक ब्रांडेड करियर पेज पर **iframe** के रूप में एम्बेड करती हैं,
इसलिए `careers_url` कंपनी के अपने डोमेन की ओर इशारा करता है जबकि फ़ीड असल
में `<slug>.jobs.personio.de` पर होती है। पिन के बिना ऐसे बोर्ड कहीं नहीं
पहुँचते। टेनेंट स्लग स्पष्ट रूप से दें, और यह `careers_url` पर भारी पड़ता
है:
...
स्लग का कैरेक्टर सेट सीमित है (अक्षर, अंक और हाइफ़न, हाइफ़न से शुरू नहीं
हो सकता, अधिकतम 63 वर्ण), और बनने वाला URL अब भी उसी होस्ट allowlist और
HTTPS जांच से गुज़रता है — जिस स्लग में डॉट, स्लैश, `@` या `:` हो, उसे
रिजेक्ट कर दिया जाता है और एंट्री `careers_url` पर वापस चली जाती है।

**शीर्षक में रोज़गार प्रकार दिखाना (Jobstreet / SEEK, v1.237.0)।**
`appendWorkType` से ऑप्ट-इन करें और लिस्टिंग के कार्य प्रकार शीर्षक में
जोड़ दिए जाते हैं, ताकि शीर्षक फ़िल्टर और triage उन्हें स्कैन के समय ही
देख सकें। डिफ़ॉल्ट रूप से बंद:
...
| scan लॉग में `hh.ru: HTTP 451` या `403` | निर्गम IP रूस के बाहर है, या hh.ru ने उसे VPN/डेटासेंटर माना | रूसी **घरेलू** IP से चलाएँ। कोई कुंजी या User-Agent सेटिंग मौजूद नहीं है — स्कैनर स्वयं ब्राउज़र UA भेजता है। |
...
`server/lib/sources/` रजिस्ट्री **94** adapters शिप करती है — **89 अंग्रेज़ी + 5 रूसी**
...
**यह ऐप ख़ुद कैसे बनाया गया है।** मेनिफेस्टो इस बारे में है कि जॉब-सर्च कैसे
चलाई जाए; इसका मुखौटा बनाने वाला सॉफ़्टवेयर ख़ुद कोडिंग एजेंट्स से बनाया गया
है, और उस प्रैक्टिस की अपनी एक कैटलॉग है: [Agentic Coding Design
Patterns](https://mokevnin.github.io/agentic-coding-design-patterns/en/),
किरिल मोकेव्निन द्वारा ([रूसी
संस्करण](https://mokevnin.github.io/agentic-coding-design-patterns/ru/))।
career-ops-ui इसे जान-बूझकर अपनाता है — एक कमिट किए गए pre-commit hook में
executable guardrails, स्किल्स के रूप में पैकेज्ड वर्कफ़्लो, आइसोलेटेड
पैरेलल fan-outs, एक डोमेन डिक्शनरी, ADRs, एक प्रोग्रेस लॉग, और वर्कफ़्लो
evals। वास्तव में क्या लागू है और क्या नहीं, इसका ऑडिट प्रोजेक्ट विकी के
*Agentic Practices* पेज पर होता है।
