...
> **🆕 Última versión — v1.195.0** — **Detección de reposts más rápida** — la detección de duplicados ya no es O(N²) en historiales grandes; el agrupamiento de títulos por empresa ahora es un índice invertido. La salida es idéntica (probado con un test diferencial), solo mucho más rápido. **2521 pruebas.**
>
