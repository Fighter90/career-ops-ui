...
> **🆕 Última versión — v1.192.0** — **Verifica los datos de tu CV** — un nuevo control en `#/cv-studio` comprueba un CV o carta adaptados contra tu CV/perfil/two-pager reales y marca cada métrica inventada o afirmación sin respaldo (pass/warn/block). **2508 pruebas.**
>
