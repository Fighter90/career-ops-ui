...
> **🆕 Última versión — v1.108.0**
>
> **Refuerzo de seguridad (triaje de CodeQL, ronda 2).** El constructor de prompts resuelve la línea de rol por clave propia + `typeof === function`, el slug del nombre de archivo PDF se limita antes de su regex (ReDoS polinómico) y la importación de documentos coacciona un `filename` array a cadena (type-confusion). En v1.106–v1.108 el backlog de análisis estático pasó de 167 a ~14, cada hallazgo real corregido y el resto descartado con justificación.
>
> _refuerzo de seguridad 2 · refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
