...
> **🆕 Última versión — v1.96.0**
>
> **Orientación profesional (Epic 27):** una nueva página **`#/orientation`** responde a la pregunta «¿qué direcciones encajan realmente conmigo?» — la lectura que obtendrías de un test vocacional, pero inferida a partir de tu propio CV y perfil en lugar de un cuestionario. Haz clic en **Generar perfil** y el modelo devuelve tus **vectores de carrera con mejor ajuste** (cuáles de los ocho arquetipos encajan, con evidencia), una inclinación de tipo profesional, roles recomendados, fortalezas profesionales ligadas a tu CV, tendencias de estilo de trabajo y recomendaciones de desarrollo. Es una **reflexión de IA sobre cómo se lee tu CV — no un test psicométrico**: nunca inventa logros ni informa puntuaciones numéricas como si fueran medidas. Expórtalo a **Markdown o PDF**; no se escribe nada en el disco. Se basa en la v1.95.0 (plan de carrera) y la v1.94.0 (rediseño de estadísticas).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
