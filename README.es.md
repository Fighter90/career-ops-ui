...
> **🆕 Última versión — v1.107.0**
>
> **Refuerzo del saneador (XSS en reposo).** El saneador de markdown de CV/oferta ahora elimina HTML peligroso **hasta un punto fijo** (para detectar una eliminación que reforme una carga), coincide con etiquetas de cierre script/style con basura final (`</script foo>`) y elimina un abridor ejecutable sin cerrar. Defensa en profundidad tras el cliente con escape-al-renderizar; cierra los hallazgos de CodeQL correspondientes.
>
> _refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
