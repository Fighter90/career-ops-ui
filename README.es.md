...
> **🆕 Última versión — v1.198.0** — **Reintentos de escaneo más inteligentes** — cuando un tablero limita la tasa (HTTP 429/5xx) durante un escaneo, los reintentos usan ahora **retroceso exponencial + jitter** y respetan un `Retry-After` (acotado) en vez de un retardo corto fijo. **2536 pruebas.**
>
