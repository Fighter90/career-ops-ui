...
> **🆕 Última versión — v1.91.0**
>
> **Networking e investigación profunda de empresas (Epic 16):** una nueva página **`#/networking`** convierte una empresa en un plan accionable — un **dossier de empresa**, **a quién contactar** (personas + cadenas de búsqueda de LinkedIn), la **vía de presentación más cálida** y **borradores de contacto** a medida — todo anclado en tu CV y tu two-pager. Se ejecuta en vivo con cualquier clave LLM o te devuelve un prompt para copiar y pegar, y puedes **guardar planes** por empresa. Se basa en la v1.90.0 (mock interview), la v1.89.0 (encaje candidato-mercado con el two-pager) y la v1.88.0 (i18n de Scan + higiene de la API).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · planificador de networking · mock interview · encaje de mercado con el two-pager · estadísticas de mercado por rol objetivo · detector de reposteos · paridad con el career-ops v1.16.0._
