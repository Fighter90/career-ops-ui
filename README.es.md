...
> **🆕 Última versión — v1.95.0**
>
> **Plan de carrera (Epic 26):** una nueva página **`#/career-plan`** convierte tu CV y tu perfil en un plan de desarrollo concreto y personalizado. Elige un **horizonte** (6/12/24 meses) y un enfoque opcional, y el modelo redacta una instantánea del punto de partida, un DAFO de fortalezas/crecimiento, objetivos como **SMART / OKR / WOOP**, trayectorias alternativas, un plan de competencias técnicas y blandas, una **hoja de ruta mes a mes**, seguimiento del progreso, escollos y palancas de apoyo — anclado en tus propios materiales, sin inventar nunca tu historial. Edítalo en línea, **Guárdalo** en la capa de usuario y expórtalo a **Markdown o PDF**. Se basa en la v1.94.0 (rediseño de estadísticas) y la v1.93.0 (capa de memoria).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
