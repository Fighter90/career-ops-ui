...
> **🆕 Última versión — v1.116.0**
>
> **Medidor de uso rehecho + primer test end-to-end de widgets.** El medidor de uso de IA está ahora fijado al fondo de la barra lateral izquierda (sin tapar el menú — reserva espacio para que la navegación se desplace libre), se actualiza en vivo y muestra tokens · coste estimado reales por ventana. Una barrera typeof duradera cierra un falso positivo recurrente de CodeQL, y un nuevo test end-to-end de Playwright ejercita ambos widgets en un navegador real.
>
> _rework medidor de uso · retoque de diseño · medidor de uso · asistente flotante de ayuda · consolidación docs y QA · cierre backlog seguridad · docs y QA ×16 · Excluir en Scan · resumen pipeline · refuerzo de seguridad 2 · refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
