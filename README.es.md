...
> **🆕 Última versión — v1.109.0**
>
> **Filtro Excluir en Scan + resumen del pipeline.** El cuadro Buscar trata las comas como O ("roles a encontrar") y un nuevo campo Excluir oculta filas que coincidan con cualquier palabra separada por comas; ambos persisten en las búsquedas guardadas. La página del pipeline gana una tira de resumen compacta — N en la bandeja, N en seguimiento y recuentos Applied / Responded / Interview / Offer del tracker, cada uno enlaza a `#/tracker`.
>
> _Excluir en Scan · resumen pipeline · refuerzo de seguridad 2 · refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
