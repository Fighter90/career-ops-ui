...
> **🆕 Última versión — v1.86.0**
>
> **Estadísticas por roles objetivo** (`#/stats`): una nueva página de Analytics lee tus **roles objetivo del perfil** (no fijados en el código) y tu escaneo más reciente para graficar **vacantes y salario mediano por país**, con filtros de rol/país y una **tendencia de instantáneas guardadas** — agregada del lado del cliente a partir de los datos dispersos que los escáneres ya recopilan (sin cifras inventadas), en los 16 idiomas. Se basa en la v1.85.0 (locales alemán/italiano/turco), la v1.84.0 (cooldown de repostulación) y la v1.83.0 (detector de reposteos).
>
> _16 locales · 6 proveedores LLM · 41 adaptadores de escáner · estadísticas de mercado por rol objetivo · detector de reposteos · paridad con el career-ops v1.16.0._
