...
> **🆕 Última versión — v1.111.0**
>
> **Seguridad — cierre del backlog de CodeQL.** Tres refuerzos de defensa en profundidad cierran los hallazgos de análisis estático restantes en el origen: el saneador de markdown del CV ahora escapa cualquier apertura de etiqueta peligrosa truncada, de modo que su salida nunca puede contener un `<script`/`<iframe` vivo; la importación de CV lee el tamaño del búfer mediante una coerción numérica explícita; y las líneas de rol de los modos son cadenas de plantilla interpoladas con `String.replace` en vez de funciones almacenadas, eliminando la última llamada de despacho dinámico. Sin cambios visibles.
>
> _cierre backlog seguridad · docs y QA ×16 · Excluir en Scan · resumen pipeline · refuerzo de seguridad 2 · refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
