...
> **🆕 Última versión — v1.101.0**
>
> **CV Studio: adaptar a un empleo + carta.** Una nueva tarjeta **Adaptar a un empleo** en `#/cv-studio` convierte una descripción de empleo en un CV adaptado más una carta de presentación a juego, y luego los pasa por una **verificación** tipo reclutador (los errores bloquean, las advertencias aconsejan). Destilado de la práctica de coaching de carrera en reglas genéricas — basado solo en tu CV, perfil y two-pager; nunca inventa. Exporta el resultado a Markdown / PDF / DOCX.
>
> _adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
