...
> **🆕 Última versión — v1.212.1** — **Corrección del recuento de fuentes de la landing** — cvstart.org listaba 80 fuentes y descartaba Job Bank (Canadá) tras v1.212.0; vuelve a 81 en sincronía con la app, y la compilación del sitio ahora falla ante cualquier desajuste de recuento. **2687 pruebas.**
>
