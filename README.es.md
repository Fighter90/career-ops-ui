...
> **🆕 Última versión — v1.144.0** — **ajustes y filtros (Fase 4): activar/desactivar portales seguidos** — enciende o apaga una empresa vigilada desde `#/portals` (`POST /api/portals/toggle`, escritura quirúrgica de portals.yml); el escáner ya omite las empresas `enabled: false`. **2370 tests.**
>
