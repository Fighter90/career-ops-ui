...
> **🆕 Última versión — v1.216.0** — **Nueve proveedores LLM más** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks y Ollama local se suman a la evaluación ⚡ en vivo (ahora **16 proveedores**), cada uno con un monograma de marca en Ajustes. **2752 pruebas.**
>
