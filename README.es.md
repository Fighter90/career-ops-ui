...
> **🆕 Última versión — v1.201.0** — **Los encabezados de seguimiento localizados ya no se muestran en blanco** — un `data/applications.md` con encabezados no ingleses o variantes (`empresa`/`estado`, `position`/`stage`/`link`…) ahora se pliega a los campos canónicos. **2563 pruebas.**
>
