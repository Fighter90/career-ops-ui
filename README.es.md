...
> **🆕 Última versión — v1.214.0** — **Las descripciones alimentan el filtro de contenido + seniority más inteligente** — las publicaciones de Greenhouse / Ashby / Recruitee ya se pueden filtrar por contenido, y "Associate <título senior>" (incluidos rangos académicos) se clasifica como senior en vez de entry-level. **2736 pruebas.**
>
