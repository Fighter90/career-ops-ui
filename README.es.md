...
> **🆕 Última versión — v1.199.0** — **Las tablas anchas se desplazan lateralmente** — las tablas más anchas que la ventana (Scan, Seguimiento, Estadísticas…) se cortaban sin barra de desplazamiento; ahora muestran una **barra horizontal** cuando hace falta, así toda columna es accesible. **2540 pruebas.**
>
