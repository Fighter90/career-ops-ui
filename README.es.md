...
> **🆕 Última versión — v1.196.0** — **Endurecimiento del endpoint de Workday** — un `api:` de Workday en `portals.yml` ahora se valida por su **hostname**, no por una subcadena, así una URL manipulada como `https://evil.com/?x=myworkdayjobs.com` ya no pasa como destino de fetch. Reportado por CodeQL (#443). **2522 pruebas.**
>
