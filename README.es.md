...
> **🆕 Última versión — v1.180.0** — **Informes en tabla** — `#/reports` ahora es una tabla (Informe · Fecha · Legitimidad · Puntuación); un chip largo de "Puntuación no detectada" ya no rompe el nombre carácter por carácter, y se recupera una puntuación real que ocultaba un marcador de Machine Summary. **2465 pruebas.**
>
