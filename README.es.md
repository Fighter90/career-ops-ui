...
> **🆕 Última versión — v1.89.0**
>
> **Encaje candidato-mercado — el two-pager (Epic 14):** una nueva página **`#/two-pager`** captura lo que _tú_ realmente quieres de tu próximo puesto (lo que te encanta, los imprescindibles, lo que odias, los deal-breakers, los innegociables) en el formato "two-pager de Mnookin". Un **asistente de relleno con IA** lo redacta a partir de tu CV + perfil, cada oferta en `#/scan` recibe una puntuación **`◎` de encaje-con-lo-que-quieres**, y el two-pager alimenta cada evaluación. Se basa en la v1.88.0 (i18n de Scan + higiene de la API), la v1.87.0 (4 nuevos proveedores de escaneo) y la v1.86.0 (estadísticas por rol objetivo).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · encaje de mercado con el two-pager · estadísticas de mercado por rol objetivo · detector de reposteos · paridad con el career-ops v1.16.0._
