...
> **🆕 Última versión — v1.212.0** — **Job Bank (Canadá) + correcciones** — la bolsa federal de Canadá ya es escaneable, las bolsas con Consider vuelven a dar resultados y las vacantes de Lever multi-ubicación muestran todas sus ubicaciones. (EchoJobs retirada — su feed está bloqueado por anti-bots.) **2685 pruebas.**
>
