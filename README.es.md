...
> **🆕 Última versión — v1.193.0** — **Silencio tras la entrevista** — una nueva pestaña en `#/stats` lista entrevistas que quedaron en silencio más allá de una ventana de cortesía (30 días por defecto) — con cuánto lleva cada una en silencio y la fecha de la última — para que nada que merezca un recordatorio se escape. **2510 pruebas.**
>
