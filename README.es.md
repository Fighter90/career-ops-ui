...
> **🆕 Última versión — v1.105.0**
>
> **Página de uso y coste de IA.** Una nueva página **Uso de IA** muestra cuántos tokens has gastado en generaciones de IA en vivo, por proveedor, en 24 h / 7 d / 30 d / todo el tiempo, con un coste estimado en USD. Cada llamada añade un registro `{provider, in, out}` a `data/llm-usage.jsonl` (nada sale de tu máquina); los dólares vienen de una tabla de precios editable por proveedor — los tokens son exactos, el USD es una estimación, nunca se factura.
>
> _uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
