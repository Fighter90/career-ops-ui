...
> **🆕 Última versión — v1.227.0** — **Hong Kong y seguimientos más precisos** — JobsDB Hong Kong se suma a Jobstreet/SEEK (ahora en la API v5), un filtro de solo pendientes en el tablero de cadencia y los empleadores confidenciales muestran la agencia que los presentó — paridad con la 1.30.0 del proyecto padre. **2837 pruebas.**
