...
> **🆕 Última versión — v1.183.0** — **Detección de duplicados más inteligente** — el escáner ahora identifica cada empleo por una URL canónica, así que el mismo puesto re-publicado con un enlace de seguimiento (`?utm_…`), por `http`/`https`, o con barra final ya no aparece dos veces. **2477 pruebas.**
>
