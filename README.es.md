...
> **🆕 Última versión — v1.200.0** — **Comprobación "¿sigue activa?" para empleos en ATS** — en #/tracker, un clic consulta el JSON público de una publicación de Greenhouse/Lever/Ashby/Workday/SmartRecruiters (cero tokens, sin navegador) y muestra **Activa / Expirada / Desconocida**. **2557 pruebas.**
>
