...
> **🆕 Última versión — v1.208.0** — **La app cabe en tu móvil** — ninguna página se desplaza de lado: la barra superior se ajusta, las tablas/código anchos se desplazan dentro de su caja, la ayuda se apila y las rutas largas se parten en vez de estirar el diseño. **2621 pruebas.**
>
