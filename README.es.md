...
> **🆕 Última versión — v1.215.0** — **Ejecútalo desde OpenWorker** — un nuevo coworker de IA sin código ejecuta toda tu búsqueda de empleo (y abre este panel) desde la app OpenWorker de Andrew Ng; la ayuda en la app y el asistente Pregúntale a los docs ahora lo cubren, en los 17 idiomas. **2742 pruebas.**
>
