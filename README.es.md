...
> **🆕 Última versión — v1.176.0** — **Análisis de puntuación (FIND-5)** — una puntuación bajo una etiqueta en negrita que la tabla RU no lista (`**Итоговый балл:**`, `**Скор:**`) ahora se detecta por su forma de valor `X.X / 5` — independiente del idioma, a salvo de encabezados y fechas. **2453 pruebas.**
>
