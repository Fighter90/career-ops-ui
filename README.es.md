...
> **🆕 Última versión — v1.194.0** — **Arregladas las URLs de un solo segmento de Workday** — páginas como `https://parsons.wd5.myworkdayjobs.com/Search` (un solo segmento) ahora apuntan al feed de empleos correcto en vez de caer a `External`. Reportado en #255. **2517 pruebas.**
>
