...
> **🆕 Última versión — v1.197.0** — **Sigue un tablero Getro solo con su URL** — dale a un tablero Getro seguido su propio `careers_url` y el id numérico de la colección ahora **se resuelve solo** desde la página del tablero (una descarga segura contra SSRF), sin búsqueda manual. **2527 pruebas.**
>
