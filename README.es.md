...
> **🆕 Última versión — v1.177.0** — **Reenvío de cookies csod (parent #2769)** — los inquilinos de Cornerstone que protegen la API de búsqueda con cookies de sesión (401 → 0 empleos) ahora funcionan: el `Set-Cookie` del bootstrap se reenvía como cabecera `Cookie` en el POST de búsqueda, solo mismo origen. **2454 pruebas.**
>
