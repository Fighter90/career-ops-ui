...
> **🆕 Última versión — v1.182.0** — **Rangos salariales neutrales** — las cifras de un solo lado en escaneo y seguimiento ahora se muestran como `≥` / `≤` (p. ej. `≥ 120000 EUR`) en lugar de "from" / "up to" en inglés, para que se lean igual en todos los idiomas. **2470 pruebas.**
>
