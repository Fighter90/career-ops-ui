...
> **🆕 Última versión — v1.94.0**
>
> **Estadísticas, rediseñadas (Epic 25):** la página **`#/stats`** es ahora una sección de **Estadísticas** con tres pestañas, con gráficas reales y muchos más datos. Una nueva pestaña de **Informe de mercado** genera un análisis con IA de salarios y del mercado laboral de tus roles objetivo — por nivel con percentiles P10–P90, principales empleadores, competencias demandadas, beneficios, reparto de remoto, tendencias y orientación de negociación, en la región y la **moneda** que elijas (cifras etiquetadas como estimaciones orientativas del modelo, nunca extraídas). Una nueva pestaña de **Mi pipeline** grafica tu propio tracker (puntuaciones, embudo, principales empresas/roles, línea de tiempo, tasas de conversión). Cada informe se exporta a **Markdown o PDF**. Se basa en la v1.93.0 (capa de memoria) y la v1.92.0 (CV Studio).
>
> _rediseño de estadísticas · 16 locales · 6 proveedores LLM · 45 adaptadores de escáner · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · detector de reposteos · paridad con el career-ops v1.16.0._
