...
> **🆕 Última versión — v1.85.0**
>
> **Locales alemán, italiano y turco** (paridad de locales con el career-ops v1.16.0): la interfaz ahora está disponible en **16 idiomas** — Deutsch 🇩🇪, Italiano 🇮🇹 y Türkçe 🇹🇷 se suman a los 13 existentes, con traducción completa de la Ayuda integrada, el README y el CHANGELOG, además de scaffolding localizado de prompts LLM. Se basa en la v1.84.0 (cooldown de repostulación + compensación), la v1.83.0 (detector de reposteos) y la v1.82.0 (NoDesk).
>
> _16 locales · 6 proveedores LLM · 41 adaptadores de escáner · detector de reposteos · cooldown de repostulación · paridad con el career-ops v1.16.0._
