...
> **🆕 Última versión — v1.163.0** — **La ayuda cubre informe → PDF (corrección)** — el asistente "Pregunta a los docs" decía que la guía no cubría exportar un informe a PDF, pese al botón 📄 Generate PDF en `#/reports/:slug`. Se añadió una sección "Exportar un informe a PDF" a los 17 paquetes de ayuda. **2420 pruebas.**
>
