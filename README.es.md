...
> **🆕 Última versión — v1.178.0** — **Actualización de constantes (paridad con el padre)** — el User-Agent del navegador sube a Chrome 151 (paridad de filtros WAF/bot) y el fallback de estados del tracker gana los alias de estado en turco del padre. **2456 pruebas.**
>
