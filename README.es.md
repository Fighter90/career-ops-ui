...
> **🆕 Última versión — v1.104.0**
>
> **Logos de empresa en la tabla de escaneo (privacidad).** Un nuevo interruptor de Apariencia dibuja el logo de cada empresa junto a su nombre en `#/scan`. El logo es el **favicon de la empresa desde su propio dominio**, con proxy en el servidor (`GET /api/logo`) a través del fetcher seguro contra SSRF, de modo que ningún servicio de logos de terceros sabe qué empleadores ves. Los portales compartidos muestran una insignia con una letra; desactivado por defecto.
>
> _logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
