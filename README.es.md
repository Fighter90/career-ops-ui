...
> **🆕 Última versión — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** una nueva página **`#/mock-interview`** ejecuta un ensayo de entrevista turno por turno frente a un puesto real. Cada respuesta recibe **feedback STAR+R**, una **puntuación** y una **pregunta de seguimiento** — fundamentados en tu CV, el two-pager y tu banco de historias. Funciona en vivo con cualquier clave LLM o te devuelve un prompt para copiar y pegar, y puedes **guardar transcripciones** por empresa/puesto. Se basa en la v1.89.0 (encaje candidato-mercado con el two-pager), la v1.88.0 (i18n de Scan + higiene de la API) y la v1.87.0 (4 nuevos proveedores de escaneo).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · mock interview · encaje de mercado con el two-pager · estadísticas de mercado por rol objetivo · detector de reposteos · paridad con el career-ops v1.16.0._
