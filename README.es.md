...
> **🆕 Última versión — v1.92.0**
>
> **CV Studio (Epic 21):** una nueva página **`#/cv-studio`** dota a tu CV de tres herramientas honestas — **diagnóstico de currículum** (una puntuación determinista de 0–100 con explicaciones por comprobación), una **máscara de privacidad** (redacta email/teléfono/enlaces/dirección/nombre enteramente en el navegador) y **hazlo humano** (reescribe líneas rígidas con _tu_ voz, anclado en tu voice-dna y tus muestras de escritura, sin inventar hechos). Se basa en la v1.91.0 (planificador de networking), la v1.90.0 (mock interview) y la v1.89.0 (encaje de mercado con el two-pager).
>
> _16 locales · 6 proveedores LLM · 45 adaptadores de escáner · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · estadísticas de mercado por rol objetivo · detector de reposteos · paridad con el career-ops v1.16.0._
