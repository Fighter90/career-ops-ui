...
> **🆕 Última versión — v1.227.4** — **Corrección de prefijos, parte 2** — `word:` / `stem:` seguían ignorándose en `content_filter`; la v1.227.3 solo conectó el filtro de títulos. Detectado en revisión por IA. **2858 pruebas.**
