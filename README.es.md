...
> **🆕 Última versión — v1.106.0**
>
> **Refuerzo de seguridad (triaje de CodeQL).** La ruta de error de renderizado ahora escapa el mensaje de error antes de llegar al DOM (un error del servidor puede reflejar entrada del usuario — límite XSS), y las escrituras de propiedades de perfil/config rechazan las claves `__proto__` / `constructor` / `prototype` (protecciones anti-contaminación de prototipos). La mayoría de las alertas restantes son falsos positivos sobre la E/S legítima del escáner en `data/*` y se descartaron con justificación.
>
> _refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
