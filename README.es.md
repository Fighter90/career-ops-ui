...
> **🆕 Última versión — v1.214.2** — **Arreglo de limpieza HTML** — una descripción con `>` dentro de un atributo HTML (p. ej. `title="salary > 100k"`) ya no filtra el texto de atributo final en la descripción de Greenhouse / Recruitee que lee un filtro de contenido. **2742 pruebas.**
>
