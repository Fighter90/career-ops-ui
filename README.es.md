...
> **🆕 Última versión — v1.102.0**
>
> **Preguntar a la guía — un chat de ayuda fundamentado.** Una nueva página **Preguntar a la guía 💬** responde preguntas usando **solo** la guía de ayuda de la app en tu idioma (muestra las secciones usadas y nunca lee tu CV ni tu búsqueda de empleo). Recuperación por palabras clave sin dependencias sobre las secciones `##` de la guía; el modelo responde desde ellas o admite que la guía no lo cubre. En vivo con clave LLM, o un prompt para copiar sin ella.
>
> _preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
