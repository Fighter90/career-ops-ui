...
> **🆕 Última versión — v1.100.0**
>
> **Autorrelleno con IA del two-pager + exportación.** El two-pager (`#/two-pager`) ahora se rellena solo desde tu CV + perfil con tu proveedor configurado (sin inventar nada; con respaldo de copiar-el-prompt si no hay clave), añade una vista **Vista previa y exportar** y gana exportación a **PDF / DOCX / Markdown** — DOCX mediante un nuevo generador `.docx` sin dependencias, también integrado en los informes de mercado, plan de carrera y orientación.
>
> _autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
