...
> **🆕 Última versión — v1.214.1** — **Límite de descripción de Ashby** — las descripciones de Ashby ahora se limitan a 4000 caracteres como Greenhouse y Recruitee, así que un filtro de contenido se comporta igual en cada bolsa y ninguna infla la caché de escaneo. **2738 pruebas.**
>
