...
> **🆕 Última versión — v1.179.0** — **Consolidación de decodificadores** — 20 decodificadores de entidades HTML duplicados en las fuentes de escaneo ahora pasan por un único módulo compartido (−237 líneas), con una guardia contra la reduplicación. Preserva el comportamiento. **2458 pruebas.**
>
