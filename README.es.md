...
> **🆕 Última versión — v1.110.0**
>
> **Actualización de docs y QA (16 idiomas).** El prompt de regresión de todo el proyecto se actualiza a v1.109.0 y los párrafos de ayuda recientes están ahora traducidos a los 16 idiomas. Sin cambios de código.
>
> _docs y QA ×16 · Excluir en Scan · resumen pipeline · refuerzo de seguridad 2 · refuerzo del saneador · refuerzo de seguridad · uso y coste de IA · logos de empresa · herramientas CLI de IA · preguntar a la guía · adaptar CV + carta · autorrelleno del two-pager · exportación DOCX · estado de portales · reportador de errores integrado · 16 locales · 6 proveedores LLM · 46 adaptadores de escáner · orientación profesional · plan de carrera · rediseño de estadísticas · capa de memoria · CV Studio · planificador de networking · mock interview · encaje de mercado con el two-pager · paridad con el career-ops v1.16.0._
