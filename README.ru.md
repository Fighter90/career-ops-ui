...
[![tests](https://img.shields.io/badge/tests-2557%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.200.0** — **Проверка «ещё активна?» для вакансий на ATS** — на #/tracker один клик спрашивает публичный JSON вакансии Greenhouse/Lever/Ashby/Workday/SmartRecruiters (без токенов, без браузера) и показывает **Активна / Закрыта / Неизвестно**. **2557 тестов.**
>
