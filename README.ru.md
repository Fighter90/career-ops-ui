...
[![tests](https://img.shields.io/badge/tests-2852%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.227.3** — **Префиксы фильтра заголовков заработали** — `word:` / `stem:` сопоставлялись как буквальный текст, из-за чего эти строки фильтра были пустышкой (правило `word:intern` работало в CLI и не фильтровало здесь ничего). Портировано из родителя вместе с Unicode-границами. **2852 теста.**
