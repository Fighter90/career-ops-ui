...
> **🆕 Последний релиз — v1.111.0**
>
> **Безопасность — закрытие бэклога CodeQL.** Три усиления эшелонированной защиты закрывают оставшиеся замечания статического анализа в первопричине: санитайзер markdown CV теперь экранирует любое усечённое открытие опасного тега, так что в выводе никогда не окажется живого `<script`/`<iframe`; импорт CV читает размер буфера через явное числовое приведение; а строки роли режимов — это шаблонные строки, интерполируемые через `String.replace`, а не хранимые функции, что убирает последний вызов динамической диспетчеризации. Видимых изменений нет.
>
> _закрытие бэклога безопасности · докум. и QA ×16 · Исключить в Scan · обзор пайплайна · усиление безопасности 2 · усиление санитайзера · усиление безопасности · расход ИИ · логотипы компаний · инструменты CLI для ИИ · спросить справку · адаптация CV + письмо · автозаполнение two-pager · экспорт в DOCX · здоровье порталов · встроенный репортёр багов · 16 locales · 6 LLM-провайдеров · 46 адаптеров сканера · карьерная ориентация · план карьеры · переработка статистики · слой памяти · CV Studio · планировщик нетворкинга · mock interview · рыночное соответствие через two-pager · паритет с родительским career-ops v1.16.0._
