...
[![tests](https://img.shields.io/badge/tests-2378%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.147.0** — **Hermes & Telegram в справке** — инструкция по облачному развёртыванию Hermes + мосту с Telegram теперь стала встроенным разделом справки (§30) во всех 17 языках, и ассистент документации отвечает на основе неё. Всё ещё только документация — провайдер остаётся **запланированным / пока не подключённым**. **2378 тестов.**
>
