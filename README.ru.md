...
[![tests](https://img.shields.io/badge/tests-2594%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.203.0** — **Подсказка «переиспользовать прошлое резюме?» в CV Studio** — сохранённая вакансия сравнивается с другими вашими (детерминированно, без токенов), чтобы подсказать: переиспользовать адаптированное резюме, с правками или готовить новое. **2594 тестов.**
>
