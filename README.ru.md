...
> **🆕 Последний релиз — v1.225.1** — **Исправление баннера провайдеров** — баннер логотипов теперь корректно отображается в README и руководстве (отрендеренный PNG по абсолютному URL; SVG с невалидным XML исправлен). **2784 тестов.**
