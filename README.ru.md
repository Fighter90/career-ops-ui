...
> **🆕 Последний релиз — v1.92.0**
>
> **CV Studio (Epic 21):** новая страница **`#/cv-studio`** даёт вашему резюме три честных инструмента — **диагностику резюме** (детерминированная оценка 0–100 с пояснениями по каждой проверке), **маску приватности** (скрытие email/телефона/ссылок/адреса/имени целиком в браузере) и **make it human** (переписывание сухих строк _вашим_ голосом, обоснованно через ваш voice-dna и образцы текстов, никогда не выдумывая факты). Основан на v1.91.0 (планировщик нетворкинга), v1.90.0 (mock interview) и v1.89.0 (рыночное соответствие через two-pager).
>
> _16 locales · 6 LLM-провайдеров · 45 адаптеров сканера · CV Studio · планировщик нетворкинга · mock interview · рыночное соответствие через two-pager · рыночная статистика по целевым ролям · детектор повторных публикаций · паритет с родительским career-ops v1.16.0._
