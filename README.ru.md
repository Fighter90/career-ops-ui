...
[![tests](https://img.shields.io/badge/tests-2521%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.195.0** — **Быстрее обнаружение переоткрытий** — обнаружение дублей больше не O(N²) на больших историях сканов; группировка заголовков по компании теперь инвертированный индекс. Вывод идентичен (доказано диф-тестом), просто гораздо быстрее. **2521 тестов.**
>
