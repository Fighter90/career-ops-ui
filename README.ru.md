...
[![tests](https://img.shields.io/badge/tests-2144%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.133.1** — исправление: **Профинансированные компании** (`#/funded`) теперь отображает результаты — вывод обнаружения родителя читается по правильному ключу `companies`, а таблица результатов строит все четыре столбца (исправление `UI.el` — дочерние элементы как массив). Проверено вживую в браузере. **2144 тестов.**
>
