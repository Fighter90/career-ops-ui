...
[![tests](https://img.shields.io/badge/tests-2771%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.220.0** — **Get on Board, несколько категорий** — одна запись теперь сканирует `programming`, `operations-management`, `machine-learning-ai` … (дедуп по URL, лимит 12), чтобы поиски EM/данных не теряли роли, которые доска выделяет отдельно. **2771 тестов.**
>
