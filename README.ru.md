...
[![tests](https://img.shields.io/badge/tests-2381%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.148.0** — **Аккуратные фильтры сканирования** — панель фильтров `#/scan` теперь опрятная адаптивная сетка (была рваная flex-обёртка), а «Применить / Сбросить» вынесены в отдельную строку с выравниванием вправо. Фильтры те же, читать удобнее. **2381 тестов.**
>
