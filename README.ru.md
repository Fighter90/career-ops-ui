...
[![tests](https://img.shields.io/badge/tests-2508%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.192.0** — **Проверка фактов в CV** — новый гейт в `#/cv-studio` сверяет адаптированное CV или письмо с вашими реальными CV/профилем/two-pager и помечает каждую придуманную метрику или необоснованное утверждение (pass/warn/block). **2508 тестов.**
>
