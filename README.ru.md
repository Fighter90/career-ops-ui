...
[![tests](https://img.shields.io/badge/tests-2465%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.180.0** — **Отчёты таблицей** — `#/reports` теперь таблица (Отчёт · Дата · Легитимность · Оценка); длинный чип «Оценка не найдена» больше не рвёт имя по символам, и восстановлена реальная оценка, которую скрывал плейсхолдер Machine Summary. **2465 тестов.**
>
