...
[![tests](https://img.shields.io/badge/tests-2519%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.194.0** — **Исправлены односегментные URL Workday** — страницы вроде `https://parsons.wd5.myworkdayjobs.com/Search` (один сегмент пути) теперь ведут на правильный фид вакансий, а не сваливаются в `External`. Сообщено в #255. **2517 тестов.**
>
