...
>
> **Слой памяти (Epic 24):** новая страница **`#/memory`** хранит короткую редактируемую заметку «запомни это обо мне». Поскольку она встраивается в общий контекст проекта, она направляет **каждый** AI-запрос — оценка, mock interview, нетворкинг, CV Studio — по **всем** провайдерам. Она фиксирует ваши предпочтения и стиль работы (никогда не новые факты о вас), а помощник **предложить из ваших данных** набрасывает поведенческие пункты из вашего трекера для просмотра. Основан на v1.92.0 (CV Studio), v1.91.0 (планировщик нетворкинга) и v1.90.0 (mock interview).
>
