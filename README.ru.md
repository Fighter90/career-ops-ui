...
[![tests](https://img.shields.io/badge/tests-2448%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.174.0** — **Оценки в локализованных отчётах + SEO-фикс** — не-английские отчёты больше не показывают «Score not detected» (H1 со словом-меткой принимался за оценку); чипы легитимности убирают лишние `**`, длинные оценки не вылезают за карточку, а описание cvstart.org считает реальный реестр (~75). **2448 тестов.**
>
