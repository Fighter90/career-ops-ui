...
> **🆕 Последний релиз — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** новая страница **`#/mock-interview`** проводит пошаговую репетицию собеседования на реальную роль. Каждый ответ получает **обратную связь STAR+R**, **оценку** и **уточняющий вопрос** — на основе вашего CV, two-pager и банка историй. Работает вживую с любым LLM-ключом или возвращает готовый для копирования промпт, и вы можете **сохранять транскрипты** по компании/роли. Основан на v1.89.0 (соответствие кандидата рынку через two-pager), v1.88.0 (i18n для Scan + гигиена API) и v1.87.0 (4 новых провайдера сканирования).
>
> _16 locales · 6 LLM-провайдеров · 45 адаптеров сканера · mock interview · рыночное соответствие через two-pager · рыночная статистика по целевым ролям · детектор повторных публикаций · паритет с родительским career-ops v1.16.0._
