...
> **🆕 Последний релиз — v1.207.2** — **AI-планы снова отображаются нормально** — план развития и профиль ориентации больше не выглядят как моноширинный дамп кода, когда модель заворачивает весь ответ в ограду ```markdown. **2621 тестов.**
>
