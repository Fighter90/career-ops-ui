...
[![tests](https://img.shields.io/badge/tests-2451%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.175.0** — **Регресс-гард SEO-описания** — CI-тест теперь падает, если любая из 17 локалей сайта теряет плейсхолдер `{adapters}` или снова зашивает число (причина бага «~55»), плюс null-безопасная очистка легитимности. **2451 тестов.**
>
