...
> **🆕 Последний релиз — v1.207.1** — **Лендинг помещается на любом экране** — на маленьких телефонах заголовок, вступление и терминал установки больше не обрезаются по правому краю; длинная команда установки прокручивается внутри терминала. **2618 тестов.**
>
