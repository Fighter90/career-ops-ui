...
[![tests](https://img.shields.io/badge/tests-2540%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.199.0** — **Широкие таблицы прокручиваются вбок** — таблицы шире окна (Scan, Трекер, Статистика…) обрезались без полосы прокрутки; теперь показывают **горизонтальную полосу** по мере необходимости, и любая колонка доступна. **2540 тестов.**
>
