...
[![tests](https://img.shields.io/badge/tests-2454%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.177.0** — **Повтор кук csod (parent #2769)** — арендаторы Cornerstone, закрывающие search-API сессионными куками (401 → 0 вакансий), теперь работают: `Set-Cookie` bootstrap-страницы повторяется как заголовок `Cookie` в POST поиска, только тот же origin. **2454 тестов.**
>
