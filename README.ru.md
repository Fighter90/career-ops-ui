...
[![tests](https://img.shields.io/badge/tests-2768%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.219.0** — **Torre в сканере** — латиноамериканский маркетплейс талантов (torre.ai) стал новым источником сканирования (всего **83**), плюс исправление пагинации a16z и корректные метки + монограммы провайдеров везде. **2768 тестов.**
>
