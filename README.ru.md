...
[![tests](https://img.shields.io/badge/tests-2492%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.187.0** — **`skip_tiers` снова работает** — список `skip_tiers: [intern, entry]` в `portals.yml` теперь отбрасывает вакансии по грейду при скане (раньше молча игнорировался). **2492 тестов.**
>
