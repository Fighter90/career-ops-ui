...
[![tests](https://img.shields.io/badge/tests-2610%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.207.0** — **Запись итога из трекера** — в каждой строке действие **Итог**: выберите, что произошло (отказ / оффер / нанят / отклонён / нет ответа / собеседование), предпросмотрите итоговый статус и запишите. Архивирует отправленные артефакты и синхронизирует состояние трекера. **2618 тестов.**
>
