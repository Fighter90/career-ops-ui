...
> **🆕 Последний релиз — v1.208.2** — **Фикс верхней панели на мобиле** — кнопки уведомлений и темы больше не накрывают поле поиска на телефоне; кнопки действий теперь занимают свою вторую строку, и поиск виден целиком. **2621 тестов.**
>
