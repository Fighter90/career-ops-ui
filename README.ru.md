...
[![tests](https://img.shields.io/badge/tests-2485%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.186.0** — **Панель «Разрыв навыков» в CV-студии** — выберите сохранённую вакансию и посмотрите, какие требуемые навыки ваше CV называет, лишь подразумевает или не имеет — без LLM, ничего не записывается. **2485 тестов.**
>
