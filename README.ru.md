...
[![tests](https://img.shields.io/badge/tests-2758%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.218.0** — **Значки провайдеров повсюду** — чип на дашборде, сводка «Активен» в настройках и результат ⚡ оценки теперь показывают монограмму каждого провайдера и его правильное имя среди всех 18 (исправлены три устаревшие метки на 5 провайдеров). **2758 тестов.**
>
