...
[![tests](https://img.shields.io/badge/tests-2643%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.210.0** — **Senjob — сканер добрался до Африки** — новый источник без токенов для Сенегала (senjob.com), и ещё пять досок теперь распознают заголовки с «&». **2643 тестов.**
>
