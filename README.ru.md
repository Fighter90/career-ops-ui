...
[![tests](https://img.shields.io/badge/tests-2402%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.158.0** — **Косметические исправления отображения** — «?» из HelpHint больше не протекает в заголовок вкладки браузера, а лендинг cvstart.org теперь показывает «7 AI providers» (а не 17), совпадая с баннером статистики. **2402 теста.**
>
