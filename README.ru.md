...
[![tests](https://img.shields.io/badge/tests-2481%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.185.0** — **Вкладка «Воронка и скорость»** — доля ответов и интервью рядом с рыночными ориентирами, список ожидания застрявших откликов и медианные дни по стадиям — всё из вашего трекера, только чтение. **2481 тестов.**
>
