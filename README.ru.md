...
[![tests](https://img.shields.io/badge/tests-2667%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.211.0** — **Yourator + точнее декодирование** — новая тайваньская tech-доска, плюс акцентированные сущности в заголовках/названиях (`D&eacute;veloppeur`) теперь декодируются везде, а компании с акцентом совпадают со своим доменом. **2667 тестов.**
>
