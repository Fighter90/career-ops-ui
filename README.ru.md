...
> **🆕 Последний релиз — v1.91.0**
>
> **Нетворкинг и глубокое исследование компаний (Epic 16):** новая страница **`#/networking`** превращает компанию в действенный план — **досье компании**, **с кем связаться** (персоны + поисковые строки LinkedIn), **самый тёплый путь для представления** и адаптированные **черновики для контакта** — всё на основе вашего CV и two-pager. Работает вживую с любым LLM-ключом или возвращает готовый для копирования промпт, и вы можете **сохранять планы** по компаниям. Основан на v1.90.0 (mock interview), v1.89.0 (соответствие кандидата рынку через two-pager) и v1.88.0 (i18n для Scan + гигиена API).
>
> _16 locales · 6 LLM-провайдеров · 45 адаптеров сканера · планировщик нетворкинга · mock interview · рыночное соответствие через two-pager · рыночная статистика по целевым ролям · детектор повторных публикаций · паритет с родительским career-ops v1.16.0._
