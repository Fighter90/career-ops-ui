...
[![tests](https://img.shields.io/badge/tests-2736%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.214.0** — **Описания попадают в контент-фильтр + умнее определение уровня** — вакансии Greenhouse / Ashby / Recruitee теперь можно фильтровать по контенту, а "Associate <старший титул>" (включая академические звания) относят к senior, а не entry-level. **2736 тестов.**
>
