...
> **🆕 Последний релиз — v1.155.0** — **Чище вид config (рефакторинг)** — `config.js` (1030 строк) разбит под лимит 800 на два модуля, сохраняющих поведение — данные полей + фабрика панели вкладок. Чистый рефакторинг, без изменения поведения. **2396 тестов.**
>
