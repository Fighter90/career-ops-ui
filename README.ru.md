...
[![tests](https://img.shields.io/badge/tests-2497%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.188.0** — **Кнопки снова «дышат»** — основная кнопка действия на страницах действий (дайджест интервью, профинансированные компании, порталы, карьерный план, карьерная ориентация) больше не прижата к подзаголовку; теперь у неё правильный верхний отступ. **2497 тестов.**
>
