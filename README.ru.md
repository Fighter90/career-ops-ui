...
[![tests](https://img.shields.io/badge/tests-2644%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.210.1** — **Заголовки Habr исправлены** — заголовки вакансий и названия компаний с «&» или кавычками теперь декодируются и больше не выпадают из фильтра и не попадают в трекер искажёнными. **2644 тестов.**
>
