...
[![tests](https://img.shields.io/badge/tests-2818%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.226.0** — **Два вьетнамских источника вакансий** — ITviec + CareerViet подключены к сканеру (85 источников · 80 адаптеров) — паритет с родителем 1.30.0. **2818 тестов.**
