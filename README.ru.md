...
[![tests](https://img.shields.io/badge/tests-2471%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.182.0** — **Локале-нейтральные диапазоны зарплат** — односторонние суммы в скане и трекере показываются как `≥` / `≤` (напр. `≥ 120000 EUR`) вместо английских "from" / "up to" — одинаково на всех языках. **2471 тестов.**
>
