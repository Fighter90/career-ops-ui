...
[![tests](https://img.shields.io/badge/tests-2453%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.176.0** — **Разбор балла (FIND-5)** — балл под жирной меткой, которой нет в RU-таблице (`**Итоговый балл:**`, `**Скор:**`), теперь ловится по форме значения `X.X / 5` — язык-независимо, безопасно к заголовкам и датам. **2453 тестов.**
>
