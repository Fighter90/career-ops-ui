...
[![tests](https://img.shields.io/badge/tests-2510%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.193.0** — **Тишина после интервью** — новая вкладка `#/stats` показывает интервью, замолчавшие после «вежливого» окна (по умолчанию 30 дней) — с длительностью тишины и датой последнего интервью — чтобы не упустить то, чему стоит напомнить. **2510 тестов.**
>
