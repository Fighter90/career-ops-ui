...
> **🆕 Последний релиз — v1.209.0** — **Справка описывает запись итога** — руководство Трекера теперь документирует кнопку «Итог» на 17 языках, а «Спросить справку» ведёт к ней. **2625 тестов.**
>
