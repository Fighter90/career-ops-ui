...
[![tests](https://img.shields.io/badge/tests-2498%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.189.0** — **`skip_tiers` теперь понимает любой язык** — классификатор грейда читает римские цифры уровня (I/II/III/IV/V) после слова должности в любой письменности («Инженер III», «エンジニア I», «Ingénieur IV»), а не только после ASCII-слов; раньше они падали в «mid» и проскакивали мимо `skip_tiers`. **2498 тестов.**
>
