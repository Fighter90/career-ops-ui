...
[![tests](https://img.shields.io/badge/tests-2685%20passed-brightgreen)](#тесты)
...
> **🆕 Последний релиз — v1.212.0** — **Job Bank (Канада) + фиксы** — федеральная доска Канады теперь сканируется, доски на Consider снова отдают результаты, а мульти-локационные вакансии Lever показывают все локации. (EchoJobs выведен — его фид за бот-защитой.) **2685 тестов.**
>
