...
> **🆕 أحدث إصدار — v1.95.0**
>
> **خطة المسار المهني (Epic 26):** صفحة **`#/career-plan`** جديدة تحوّل سيرتك الذاتية وملفك الشخصي إلى خطة تطوّر ملموسة ومخصّصة. اختر **أفقاً** (6/12/24 شهراً) وتركيزاً اختيارياً، ويكتب النموذج لقطة لنقطة الانطلاق، وتحليل SWOT لنقاط القوة/النمو، وأهدافاً بصيغة **SMART / OKR / WOOP**، ومسارات بديلة، وخطة للمهارات الصلبة/الناعمة، و**خريطة طريق شهراً بشهر**، وتتبّعاً للتقدّم، والمزالق، وخطوات الدعم — كلّها مبنية على موادّك أنت، دون اختلاق تاريخك. حرّرها داخلياً، و**احفظها** في طبقة المستخدم، وصدّرها إلى **Markdown أو PDF**. يُبنى على v1.94.0 (إعادة تصميم الإحصاءات) وv1.93.0 (طبقة الذاكرة).
>
> _الإحصاءات، مُعاد تصميمها · 16 locales · 6 مزوّدات LLM · 45 محوّل ماسح · خطة المسار المهني · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · كاشف إعادة النشر · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
