...
[![tests](https://img.shields.io/badge/tests-2586%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.202.0** — **اكتشف لوحات ATS من #/portals** — اكتب اسم شركة فيفحص التطبيق Greenhouse/Ashby/Lever بحثًا عن لوحتها العامة (بلا LLM، بلا متصفح، آمن ضد SSRF)، ونقرة واحدة تضيفها إلى شركاتك المتتبَّعة. **2586 اختبارًا.**
>
