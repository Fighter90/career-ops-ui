...
[![tests](https://img.shields.io/badge/tests-2519%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.194.0** — **إصلاح روابط Workday ذات المقطع الواحد** — صفحات مثل `https://parsons.wd5.myworkdayjobs.com/Search` (مسار من مقطع واحد) تشير الآن إلى موجز الوظائف الصحيح بدل العودة إلى `External`. أُبلغ عنه في #255. **2517 اختبار.**
>
