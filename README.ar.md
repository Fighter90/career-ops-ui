...
> **🆕 أحدث إصدار — v1.214.2** — **إصلاح تنظيف HTML** — وصفٌ به `>` داخل سمة HTML (مثل `title="salary > 100k"`) لم يعد يُسرّب نص السمة اللاحق إلى وصف Greenhouse / Recruitee الذي يقرأه مُرشِّح المحتوى. **2742 اختبارًا.**
>
