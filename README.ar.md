...
[![tests](https://img.shields.io/badge/tests-2752%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.216.0** — **تسعة مزوّدي LLM إضافيون** — DeepSeek وGLM (Z.ai) وKimi وMiniMax وMistral وGrok (xAI) وTogether وFireworks وOllama المحلي ينضمّون إلى التقييم ⚡ الحيّ (الآن **16 مزوّدًا**)، لكلٍّ منها شارة علامة في الإعدادات. **2752 اختبارًا.**
>
