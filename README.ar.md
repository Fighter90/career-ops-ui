...
[![tests](https://img.shields.io/badge/tests-2497%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.188.0** — **الأزرار تتنفس من جديد** — لم يعد زر الإجراء الرئيسي في صفحات الإجراءات (ملخص المقابلات، الشركات الممولة، البوابات، الخطة المهنية، التوجيه المهني) ملتصقًا بالعنوان الفرعي؛ أصبح له الآن هامش علوي مناسب. **2497 اختبار.**
>
