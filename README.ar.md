...
[![tests](https://img.shields.io/badge/tests-2865%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.227.5** — **لم يعد المسح الإقليمي يستنزف ذاكرة الخادم** — إذ كان يحتفظ بكل النتائج الخام من 21 استعلاماً حتى النهاية (742 ميغابايت مقابل سقف الجهاز البالغ 490)، فأسقط الخدمة أربع مرات في يوم؛ وصارت إزالة التكرار والترشيح لكل استعلام ← **177 ميغابايت**. مع إصلاح تذبذب في Playwright. **2865 اختبارًا.**
