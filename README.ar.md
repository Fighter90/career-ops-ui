...
[![tests](https://img.shields.io/badge/tests-2858%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.227.4** — **إصلاح البادئات، الجزء الثاني** — كان `content_filter` لا يزال يتجاهل `word:` و`stem:`؛ ولم توصّل v1.227.3 سوى مرشّح العناوين. اكتُشف في المراجعة الآلية. **2858 اختبارًا.**
