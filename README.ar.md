...
[![tests](https://img.shields.io/badge/tests-2368%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.144.0** — **الإعدادات والمرشحات (المرحلة 4): تفعيل/تعطيل البوابات المتتبَّعة** — شغّل أو أوقف شركة مراقَبة من `#/portals` (`POST /api/portals/toggle`، كتابة جراحية لـ portals.yml)؛ الماسح يتخطى بالفعل الشركات `enabled: false`. **2368 اختبارًا.**
>
