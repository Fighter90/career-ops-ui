...
[![tests](https://img.shields.io/badge/tests-2454%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.177.0** — **إعادة إرسال كوكيز csod (parent #2769)** — مستأجرو Cornerstone الذين يحمون واجهة البحث بكوكيز الجلسة (401 → 0 وظيفة) يعملون الآن: تُعاد قيمة `Set-Cookie` لصفحة البداية كترويسة `Cookie` في POST البحث، نفس الأصل فقط. **2454 اختبار.**
>
