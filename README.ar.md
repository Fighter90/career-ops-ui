...
[![tests](https://img.shields.io/badge/tests-2557%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.200.0** — **فحص «هل ما زالت متاحة؟» لوظائف ATS** — في #/tracker، نقرة واحدة تسأل JSON العام لإعلان Greenhouse/Lever/Ashby/Workday/SmartRecruiters (بدون توكنات، بدون متصفح) وتعرض **متاحة / منتهية / غير معروفة**. **2557 اختبارًا.**
>
