...
[![tests](https://img.shields.io/badge/tests-2501%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.190.0** — **أي الشركات ترد عليك فعلاً؟** — لوحة **سجل الشركة** الجديدة في `#/tracker`: اختر شركة وشاهد ما إذا كانت صامتة تجاهك أو مختلطة أو استجابت سابقًا — وما إذا كانت الوظيفة نفسها تُعاد نشرها — بدمج المتتبع والمتابعات وسجل المسح. **2501 اختبار.**
>
