...
> **🆕 أحدث إصدار — v1.100.0**
>
> **تعبئة تلقائية بالذكاء الاصطناعي للوثيقة + تصدير.** تملأ الوثيقة (`#/two-pager`) نفسها الآن من سيرتك الذاتية + ملفك الشخصي عبر مزوّدك المُهيّأ (دون اختلاق؛ مع العودة إلى نسخ الموجّه عند غياب المفتاح)، وتضيف عرض **معاينة وتصدير**، وتحصل على تصدير إلى **PDF / DOCX / Markdown** — DOCX عبر مولّد `.docx` جديد بلا تبعيات، مدمج أيضاً في تقارير السوق وخطة المسار المهني والتوجيه.
>
> _تعبئة تلقائية للوثيقة · تصدير DOCX · صحة البوابات · مُبلّغ الأخطاء المدمج · الإحصاءات، مُعاد تصميمها · 16 locales · 6 مزوّدات LLM · 46 محوّل ماسح · التوجيه المهني · خطة المسار المهني · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
