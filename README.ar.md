...
[![tests](https://img.shields.io/badge/tests-2602%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.204.0** — **«طبيب الإعداد» في الإعدادات** — فحص بلا توكنات لِـ `cv.md` + `config/profile.yml` يُدرج المشاكل المانعة والتحذيرات (بيانات أمثلة، أرقام مثبّتة)، لتُصلح إعدادًا ناقصًا قبل أن يُضعف المسح والتخصيص. **2602 اختبارًا.**
>
