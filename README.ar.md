...
> **🆕 أحدث إصدار — v1.93.0**
>
> **طبقة الذاكرة (Epic 24):** صفحة **`#/memory`** جديدة تحتفظ بملاحظة قصيرة قابلة للتحرير «تذكّر هذا عنّي». ولأنها مُضمَّنة في سياق المشروع المشترك، فهي توجّه **every** طلب ذكاء اصطناعي — التقييم، المقابلة التجريبية، التواصل المهني، CV Studio — عبر **all** المزودين. تلتقط تفضيلاتك وأسلوب عملك (لا حقائق جديدة عنك أبداً)، ويصوغ مساعد **الاقتراح من بياناتك** نقاطاً سلوكية من متتبّعك لتراجعها. يُبنى على v1.92.0 (CV Studio)، وv1.91.0 (مخطّط التواصل المهني)، وv1.90.0 (المقابلة التجريبية).
>
> _16 locales · 6 مزوّدات LLM · 45 محوّل ماسح · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · إحصاءات السوق حسب الدور المستهدف · كاشف إعادة النشر · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
