...
[![tests](https://img.shields.io/badge/tests-2779%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.222.0** — **تلميحات مزوّدين مترجمة** — تلميحات المفتاح والنموذج وعنوان URL الأساسي للمزوّدين الموسّعين (DeepSeek … Volcengine Ark) ضمن الإعدادات ← مفاتيح API صارت مترجمة إلى الـ 17 لغة، لا الإنجليزية فقط. **2779 اختبارًا.**
>
