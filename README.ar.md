...
> **🆕 أحدث إصدار — v1.102.0**
>
> **اسأل الدليل — محادثة مساعدة مستندة إلى مصادر.** صفحة جديدة **اسأل الدليل 💬** تجيب عن أسئلة الاستخدام مستخدمةً **فقط** دليل مساعدة التطبيق بلغتك (تعرض الأقسام المستخدمة ولا تقرأ أبداً سيرتك الذاتية أو بحثك عن عمل). استرجاع بالكلمات المفتاحية بلا تبعيات على أقسام `##` من الدليل؛ يجيب النموذج منها أو يقرّ بأن الدليل لا يغطيه. مباشر بمفتاح LLM، أو موجّه للنسخ دونه.
>
> _اسأل الدليل · تكييف السيرة + خطاب · تعبئة تلقائية للوثيقة · تصدير DOCX · صحة البوابات · مُبلّغ الأخطاء المدمج · الإحصاءات، مُعاد تصميمها · 16 locales · 6 مزوّدات LLM · 46 محوّل ماسح · التوجيه المهني · خطة المسار المهني · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
