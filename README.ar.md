...
[![tests](https://img.shields.io/badge/tests-2477%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.183.0** — **كشف تكرارات أذكى** — يفهرس الماسح الآن كل وظيفة عبر URL أساسي، فالوظيفة نفسها المعاد نشرها برابط تتبّع (`?utm_…`) أو عبر `http`/`https` أو بشرطة نهائية لم تعُد تظهر مرتين. **2477 اختبار.**
>
