...
[![tests](https://img.shields.io/badge/tests-2644%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.210.1** — **إصلاح عناوين Habr** — عناوين الوظائف وأسماء الشركات التي تحوي «&» أو علامات اقتباس تُفكّ ترميزها الآن، فلا تسقط من مُرشِّحك ولا تصل مشوَّهة إلى المتعقِّب. **2644 اختبارًا.**
>
