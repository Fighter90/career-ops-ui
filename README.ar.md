...
[![tests](https://img.shields.io/badge/tests-2429%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.168.0** — **أهداف لمس أكبر لمربّعات الاختيار (إصلاح وصول)** — كانت صفوف مربّع الاختيار/الراديو في `#/scan` و`#/config` و`#/evaluate` و`#/cv-studio` بحجم ~22 بكسل، دون حد 24 بكسل في WCAG 2.5.8. قاعدة `:has()` تضمن ≥24 بكسل. **2429 اختبار.**
>
