...
> **🆕 أحدث إصدار — v1.224.0** — **شعارات المزوّدين الحقيقية** — بطاقات مزوّدي LLM تعرض الآن الشعار الحقيقي للعلامة (Anthropic، OpenAI، Gemini، DeepSeek، Mistral، Ollama، …) حيث ينشر المزوّد أيقونة مفتوحة المصدر — ولا يزال آمنًا تمامًا مع CSP (SVG مضمّن، بلا موارد بعيدة). **2784 اختبارًا.**
>
