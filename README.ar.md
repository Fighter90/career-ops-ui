...
[![tests](https://img.shields.io/badge/tests-2685%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.212.0** — **Job Bank (كندا) + إصلاحات** — لوحة كندا الفيدرالية صارت قابلة للمسح، ولوحات Consider تُعيد النتائج مجددًا، ووظائف Lever متعددة المواقع تُظهر كل مواقعها. (EchoJobs أُحيل — موجزه محجوب بمكافحة الروبوتات.) **2685 اختبارًا.**
>
