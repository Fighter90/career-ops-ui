...
[![tests](https://img.shields.io/badge/tests-2479%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.184.0** — **شبكة لوحة قيادة متساوية** — تستخدم بلاطات الإجراءات السريعة الآن أعمدة متساوية العرض، فلم تعُد مجموعة من 3 أعرض من مجموعة من 4 ويصطف كل قسم إلى اليمين. **2479 اختبار.**
>
