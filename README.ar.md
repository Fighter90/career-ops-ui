...
> **🆕 أحدث إصدار — v1.94.0**
>
> **الإحصاءات، مُعاد تصميمها (Epic 25):** صفحة **`#/stats`** أصبحت الآن قسم **الإحصاءات** بثلاث علامات تبويب، برسوم بيانية حقيقية وبيانات أكثر بكثير. علامة تبويب جديدة **تقرير السوق** تولّد تحليلاً بالذكاء الاصطناعي للرواتب وسوق العمل لأدوارك المستهدفة — حسب المستوى مع مئينات P10–P90، أبرز أصحاب العمل، المهارات المطلوبة، المزايا، توزيع العمل عن بُعد، الاتجاهات، وإرشادات التفاوض، في المنطقة والـ**عملة** التي تختارها (الأرقام موسومة كتقديرات توجيهية من النموذج، وليست مُستخرَجة أبداً). علامة تبويب جديدة **خط الأنابيب الخاص بي** ترسم متتبّعك (الدرجات، القمع، أبرز الشركات/الأدوار، الخط الزمني، معدلات التحويل). كل تقرير يُصدَّر إلى **Markdown أو PDF**. يُبنى على v1.93.0 (طبقة الذاكرة) وv1.92.0 (CV Studio).
>
> _الإحصاءات، مُعاد تصميمها · 16 locales · 6 مزوّدات LLM · 45 محوّل ماسح · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · كاشف إعادة النشر · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
