...
[![tests](https://img.shields.io/badge/tests-2594%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.203.0** — **تلميح «إعادة استخدام سيرة سابقة؟» في CV Studio** — تُقارَن وظيفة محفوظة بوظائفك الأخرى (حتمي، بلا توكنات) لتخبرك إن كان يُعاد استخدام سيرة مُخصَّصة، أو مع تعديلات، أو تخصيص جديدة. **2594 اختبارًا.**
>
