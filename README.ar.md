...
[![tests](https://img.shields.io/badge/tests-2364%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.142.0** — **تصحيح: لا مزيد من النمط "Unknown"** — أصبحت `#/orientation` تُصنّف دائمًا من بين ثمانية متجهات مهنية مُسمّاة بدلاً من الإجابة أحيانًا بـ"Unknown" والتوصية بـ«مضاعفة التركيز» (قيد على موجّه الذكاء الاصطناعي). **2364 اختبارًا.**
>
