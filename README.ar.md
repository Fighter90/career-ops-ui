...
[![tests](https://img.shields.io/badge/tests-2498%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.189.0** — **`skip_tiers` يفهم الآن كل لغة** — مصنّف المستوى يقرأ الأرقام الرومانية (I/II/III/IV/V) بعد كلمة الوظيفة في أي نظام كتابة ("Инженер III"، "エンジニア I"، "Ingénieur IV")، وليس فقط بعد الكلمات اللاتينية؛ سابقًا كانت تقع في "mid" وتفلت من `skip_tiers`. **2498 اختبار.**
>
