...
> **🆕 أحدث إصدار — v1.228.1** — **رابط رمزي معطّل في المستودع كان يبتر عمليات النشر بصمت.** إذ كان `.claude/skills/refero-design` يشير إلى مسار لم يوجد هنا قط، وrsync يتوقف عنده في منتصف النقل، فأبلغ نشرٌ عن نجاحه بينما ظل الخادم على الإصدار السابق. حُذف. أما مصدر قنوات تيليجرام ففي v1.228.0.
