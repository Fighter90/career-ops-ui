...
> **🆕 أحدث إصدار — v1.92.0**
>
> **CV Studio (Epic 21):** صفحة **`#/cv-studio`** جديدة تمنح سيرتك الذاتية ثلاث أدوات أمينة — **تشخيص السيرة الذاتية** (درجة حتمية من 0 إلى 100 مع شرح لكل فحص)، و**قناع الخصوصية** (إخفاء البريد الإلكتروني/الهاتف/الروابط/العنوان/الاسم بالكامل في المتصفّح)، و**make it human** (إعادة كتابة السطور الجامدة بنبرتك _أنت_، مبنيةً على voice-dna وعيّنات كتابتك، دون اختلاق حقائق). يُبنى على v1.91.0 (مخطّط التواصل المهني)، وv1.90.0 (المقابلة التجريبية)، وv1.89.0 (ملاءمة السوق عبر two-pager).
>
> _16 locales · 6 مزوّدات LLM · 45 محوّل ماسح · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · إحصاءات السوق حسب الدور المستهدف · كاشف إعادة النشر · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
