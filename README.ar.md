...
[![tests](https://img.shields.io/badge/tests-2492%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.187.0** — **`skip_tiers` يعمل من جديد** — قائمة `skip_tiers: [intern, entry]` في `portals.yml` تستبعد الآن الوظائف حسب المستوى أثناء المسح (كانت تُتجاهل بصمت سابقًا). **2492 اختبار.**
>
