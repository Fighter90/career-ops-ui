...
[![tests](https://img.shields.io/badge/tests-2504%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.191.0** — **ماذا تتعلم بعد ذلك** — تبويب جديد في `#/stats` يرتّب المهارات الناقصة التي تُغرق غالبًا تطابقاتك المنخفضة (موزونة، مستويات Critical/High/Medium) — لتعرف ماذا تدرس أولًا. **2504 اختبار.**
>
