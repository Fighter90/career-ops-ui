...
[![tests](https://img.shields.io/badge/tests-2783%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.223.0** — **إصلاح شارة التقييم + تثبيت coworker** — تقييم ⚡ مباشر ناجح لم يعد يُلوَّن بالأحمر، وcoworker الخاص بـ OpenWorker يُثبَّت مباشرةً من رابط GitHub / .zip / أمر واحد. **2783 اختبارًا.**
>
