...
> **🆕 أحدث إصدار — v1.101.0**
>
> **CV Studio: التكييف مع وظيفة + خطاب.** بطاقة جديدة **التكييف مع وظيفة** في `#/cv-studio` تحوّل وصف وظيفة إلى سيرة ذاتية مكيّفة وخطاب تقديم مطابق، ثم تمرّرهما عبر **بوابة قائمة تحقق** بمستوى مسؤول التوظيف (الأخطاء تحجب، والتحذيرات تنصح). مستخلص من ممارسة التوجيه المهني إلى قواعد عامة — يستند فقط إلى سيرتك الذاتية وملفك ووثيقتك المكوّنة من صفحتين؛ ولا يختلق أبداً. صدّر النتيجة إلى Markdown / PDF / DOCX.
>
> _تكييف السيرة + خطاب · تعبئة تلقائية للوثيقة · تصدير DOCX · صحة البوابات · مُبلّغ الأخطاء المدمج · الإحصاءات، مُعاد تصميمها · 16 locales · 6 مزوّدات LLM · 46 محوّل ماسح · التوجيه المهني · خطة المسار المهني · طبقة الذاكرة · CV Studio · مخطّط تواصل مهني · مقابلة تجريبية · ملاءمة السوق عبر two-pager · تكافؤ مع المشروع الأصلي career-ops v1.16.0._
