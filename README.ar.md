...
[![tests](https://img.shields.io/badge/tests-2521%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.195.0** — **كشف أسرع لإعادة النشر** — لم يعد كشف المكرّرات O(N²) على السجلات الكبيرة؛ تجميع العناوين لكل شركة أصبح الآن فهرسًا معكوسًا. المخرجات متطابقة (أُثبت باختبار تفاضلي)، لكن أسرع بكثير. **2521 اختبار.**
>
