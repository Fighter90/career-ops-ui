...
> **🆕 أحدث إصدار — v1.225.0** — **لافتة شعارات المزوّدين** — لافتة لجميع مزوّدي LLM الـ 18 — شعارات حقيقية لأحد عشر ومونوغرام لسبعة — تتصدّر الآن README ودليل المساعدة. **2784 اختبارًا.**
