...
> **🆕 أحدث إصدار — v1.93.0**
>
> **طبقة الذاكرة (Epic 24):** صفحة **`#/memory`** جديدة تحتفظ بملاحظة قصيرة قابلة للتحرير «تذكّر هذا عنّي». ولأنها مُضمَّنة في سياق المشروع المشترك، فهي توجّه **كل** طلب ذكاء اصطناعي — التقييم، المقابلة التجريبية، التواصل المهني، CV Studio — عبر **كل** المزودين. تلتقط تفضيلاتك وأسلوب عملك (لا حقائق جديدة عنك أبداً)، ويصوغ مساعد **الاقتراح من بياناتك** نقاطاً سلوكية من متتبّعك لتراجعها. يُبنى على v1.92.0 (CV Studio)، وv1.91.0 (مخطّط التواصل المهني)، وv1.90.0 (المقابلة التجريبية).
>
