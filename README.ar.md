...
[![tests](https://img.shields.io/badge/tests-2510%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.193.0** — **صمت بعد المقابلة** — تبويب جديد في `#/stats` يسرد المقابلات التي صمتت بعد نافذة مجاملة (30 يومًا افتراضيًا) — مع مدة صمت كلٍّ منها وتاريخ آخر مقابلة. **2510 اختبار.**
>
