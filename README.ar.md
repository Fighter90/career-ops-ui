...
[![tests](https://img.shields.io/badge/tests-2736%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.214.0** — **الأوصاف تُغذّي مُرشِّح المحتوى + تصنيف أقدمية أذكى** — صار بالإمكان تصفية وظائف Greenhouse / Ashby / Recruitee بالمحتوى، ويُصنَّف "Associate <لقب رفيع>" (بما فيها الرتب الأكاديمية) كرفيع بدل المبتدئ. **2736 اختبارًا.**
>
