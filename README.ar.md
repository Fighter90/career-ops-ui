...
[![tests](https://img.shields.io/badge/tests-2738%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.214.1** — **حدّ وصف Ashby** — صارت أوصاف Ashby تُقتطَع عند 4000 حرف مثل Greenhouse وRecruitee، فيتصرّف مُرشِّح المحتوى بالطريقة نفسها على كل لوحة ولا تُضخّم أيّ لوحة ذاكرة المسح. **2738 اختبارًا.**
>
