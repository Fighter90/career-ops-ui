...
[![tests](https://img.shields.io/badge/tests-2385%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.150.0** — **حالات فارغة متسقة** — أصبح كل لوح "لا شيء بعد" يُعرَض الآن عبر نمط `.empty` المشترك؛ أزال `#/activity` و`#/cv-studio` و`#/stats` و`#/usage` تجاوزًا مضمّنًا زائدًا ليطابق البقية (حشوة 48px مرمَّزة + حدّ متقطّع). **2385 اختبارًا.**
>
