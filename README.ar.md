...
[![tests](https://img.shields.io/badge/tests-2643%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.210.0** — **Senjob — الماسح يصل إلى أفريقيا** — مصدر جديد بلا رموز للسنغال (senjob.com)، وخمس لوحات إضافية تتعرّف الآن على العناوين التي تحوي «&». **2643 اختبارًا.**
>
