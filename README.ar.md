...
[![tests](https://img.shields.io/badge/tests-2448%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.174.0** — **درجات التقارير المُترجَمة + إصلاح SEO** — لم تعد التقارير غير الإنجليزية تُظهر "Score not detected" (عنوان H1 يحتوي كلمة التسمية كان يُخلط مع الدرجة)؛ وتُزيل شارات المشروعية `**` الزائدة، ولا تتجاوز الدرجات الطويلة البطاقة، ويَعُدّ وصف cvstart.org السجل الحقيقي (~75). **2448 اختبار.**
>
