...
[![tests](https://img.shields.io/badge/tests-2402%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.158.0** — **إصلاحات تجميلية للعرض** — لم تعُد «?» الخاصة بـ HelpHint تتسرّب إلى عنوان تبويب المتصفح، وتُظهر صفحة هبوط cvstart.org الآن «7 AI providers» (وليس 17) بما يطابق شريط الإحصاءات. **2402 اختبار.**
>
