...
[![tests](https://img.shields.io/badge/tests-2508%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.192.0** — **تحقّق من حقائق سيرتك** — بوابة جديدة في `#/cv-studio` تتحقق من سيرة أو خطاب معدّل مقابل سيرتك/ملفك/صفحتيك الحقيقية وتُعلّم كل مقياس مختلق أو ادعاء غير مدعوم (pass/warn/block). **2508 اختبار.**
>
