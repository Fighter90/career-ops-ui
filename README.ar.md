...
[![tests](https://img.shields.io/badge/tests-2522%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.196.0** — **تعزيز نقطة Workday** — يُتحقق الآن من `api:` الخاص بـ Workday في `portals.yml` عبر **اسم المضيف** لا عبر سلسلة فرعية، فلا يمر رابط ملفّق مثل `https://evil.com/?x=myworkdayjobs.com` كهدف للجلب. أبلغ عنه CodeQL (#443). **2522 اختبار.**
>
