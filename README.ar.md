...
[![tests](https://img.shields.io/badge/tests-2390%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.151.0** — **أصبح Hermes الآن مزوّد LLM موصولًا (Phase 5)** — يعرض Hermes من Nous Research خادم API Server متوافقًا مع OpenAI، فاضبط `HERMES_API_KEY` في **إعدادات التطبيق** ليُشغّل career-ops-ui التقييمات المباشرة عبر `hermes gateway` المحلي لديك (الأخير في ترتيب auto). يُغلق آخر بند مفتوح في خارطة الطريق. **2390 اختبارًا.**
>
