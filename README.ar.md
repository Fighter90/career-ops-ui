...
[![tests](https://img.shields.io/badge/tests-2687%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.212.1** — **إصلاح عدّاد مصادر صفحة الهبوط** — كان cvstart.org يسرد 80 مصدرًا ويُسقط Job Bank (كندا) بعد v1.212.0؛ عاد إلى 81 متزامنًا مع التطبيق، وبناء الموقع يفشل الآن بحزم عند أي اختلاف في العدّاد. **2687 اختبارًا.**
>
