...
> **🆕 أحدث إصدار — v1.132.0** — تم فصل نظام عرض نتائج `#/scan` الفرعي إلى وحدة مستقلة (`public/js/lib/scan-results.js`) للوفاء بعقد حجم الملف؛ السلوك مطابق بايتًا ببايت وتم التحقق منه في متصفح حقيقي. **2138 اختبارًا.**
>
