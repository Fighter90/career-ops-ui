...
[![tests](https://img.shields.io/badge/tests-2456%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.178.0** — **تحديث ثوابت (تكافؤ مع الأصل)** — يُرفَع User-Agent للمتصفح إلى Chrome 151 (تكافؤ بوابات WAF/الروبوتات) ويكتسب احتياطي حالات المتتبِّع أسماء الحالات التركية من الأصل. **2456 اختبار.**
>
