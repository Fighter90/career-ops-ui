...
[![tests](https://img.shields.io/badge/tests-2365%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.143.0** — **سهولة الفهم (تابع): تلميحات `?` على شاشات العمل** — يغطّي `?` المساعدة الآن 9 صفحات إضافية (scan, evaluate, cv-studio, tracker, config, deep, batch, auto, apply)، بكل اللغات. **2365 اختبارًا.**
>
