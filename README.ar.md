...
[![tests](https://img.shields.io/badge/tests-2540%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.199.0** — **الجداول العريضة تُمرَّر أفقيًا** — الجداول الأعرض من النافذة (Scan، المتتبِّع، الإحصاءات…) كانت تُقتطع دون شريط تمرير؛ وتُظهر الآن **شريط تمرير أفقيًا** عند الحاجة فيبقى كل عمود قابلاً للوصول. **2540 اختبارًا.**
>
