...
[![tests](https://img.shields.io/badge/tests-2667%20passed-brightgreen)](#الاختبارات)
...
> **🆕 أحدث إصدار — v1.211.0** — **Yourator + فكّ ترميز أدقّ** — لوحة وظائف تقنية تايوانية جديدة، والكيانات المُشكَّلة في العناوين/أسماء الشركات (`D&eacute;veloppeur`) تُفكّ الآن في كل مكان وتطابق أسماء الشركات المُشكَّلة نطاقها الخاص. **2667 اختبارًا.**
>
