...
> **🆕 최신 릴리스 — v1.215.0** — **OpenWorker에서 실행** — 새 코드 없는 AI coworker가 Andrew Ng의 OpenWorker 앱에서 구직 전체를 실행(하고 이 대시보드를 실행)합니다. 인앱 도움말과 문서에 묻기 어시스턴트가 이제 17개 언어로 이를 다룹니다. **2742 개 테스트.**
>
