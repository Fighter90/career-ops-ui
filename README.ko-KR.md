...
> **🆕 최신 릴리스 — v1.212.1** — **랜딩 소스 수 수정** — v1.212.0 이후 cvstart.org가 채용 소스를 80개로 나열하며 Job Bank (캐나다)를 누락했습니다. 앱과 동기화된 81로 돌아왔고, 사이트 빌드가 이제 소스 수 어긋남에 대해 강하게 실패합니다. **2687 개 테스트.**
>
