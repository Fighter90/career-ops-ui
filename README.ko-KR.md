...
> **🆕 최신 릴리스 — v1.216.0** — **LLM 제공자 9개 추가** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks, 로컬 Ollama가 ⚡ 라이브 평가에 합류합니다(이제 **16개 제공자**). 각 제공자는 설정에서 브랜드 모노그램으로 표시됩니다. **2752 개 테스트.**
>
