...
> **🆕 최신 릴리스 — v1.112.0**
>
> **문서 및 QA 통합.** SDD 규약 문서를 현재 30개 라우트 모듈로 갱신하고, 전체 프로젝트 확정 QA 프롬프트를 모든 기능을 위한 단일 독립 회귀 프롬프트로 통합했습니다. 사용자 표시 코드 변경 없음.
>
> _문서 및 QA 통합 · 보안 백로그 정리 · 문서 및 QA ×16 · Scan 제외 · 파이프라인 개요 · 보안 강화 2 · 새니타이저 강화 · 보안 강화 · AI 사용량 · 회사 로고 · AI CLI 도구 · 문서에 질문 · CV 맞춤 + 커버레터 · 투페이저 자동 채우기 · DOCX 내보내기 · 포털 상태 · 인앱 버그 리포터 · 통계 재구성 · 16 locales · 6개 LLM 프로바이더 · 46개 스캐너 어댑터 · 커리어 방향성 · 커리어 플랜 · 메모리 레이어 · CV Studio · 네트워킹 플래너 · mock interview · 투페이저 시장 적합성 · 상위 career-ops v1.16.0 패리티._
