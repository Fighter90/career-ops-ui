...
> **🆕 최신 릴리스 — v1.85.0**
>
> **독일어, 이탈리아어, 터키어 로케일**(상위 career-ops v1.16.0 로케일 패리티): 이제 UI가 **16개 언어**로 제공됩니다 — Deutsch 🇩🇪, Italiano 🇮🇹, Türkçe 🇹🇷가 기존 13개 언어에 합류하며, 인앱 도움말, README, CHANGELOG 전체 번역과 현지화된 LLM 프롬프트 스캐폴딩을 포함합니다. v1.84.0(재적용 쿨다운 + 보상), v1.83.0(재게시 감지기), v1.82.0(NoDesk)을 기반으로 합니다.
>
> _16 locales · 6개 LLM 프로바이더 · 41개 스캐너 어댑터 · 재게시 감지기 · 재적용 쿨다운 · 상위 career-ops v1.16.0 패리티._
