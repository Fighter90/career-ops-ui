...
> **🆕 최신 릴리스 — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** 새로운 **`#/mock-interview`** 페이지는 실제 직무를 대상으로 턴 단위 면접 리허설을 진행합니다. 각 답변에는 **STAR+R 피드백**, **점수**, **후속 질문**이 주어지며 — 당신의 CV, 투페이저, 스토리 뱅크에 근거합니다. 어떤 LLM 키로든 실시간으로 작동하거나 복사·붙여넣기용 프롬프트를 돌려주며, 회사/직무별로 **대화록을 저장**할 수 있습니다. v1.89.0(투페이저 후보자-시장 적합성), v1.88.0(Scan i18n + API 위생), v1.87.0(새로운 스캔 프로바이더 4개)을 기반으로 합니다.
>
> _16 locales · 6개 LLM 프로바이더 · 45개 스캐너 어댑터 · mock interview · 투페이저 시장 적합성 · 타깃 직무 시장 통계 · 재게시 감지기 · 상위 career-ops v1.16.0 패리티._
