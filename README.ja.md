...
│  └─ reviews/REVIEW-*.md
└─ tests/                    # 1874 unit + 90 Playwright + e2e:full + e2e:smoke
...
```bash
npm test                       # 1874 unit/integration テスト
