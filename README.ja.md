...
> **🆕 最新リリース — v1.215.0** — **OpenWorker から実行** — 新しいコード不要の AI coworker が Andrew Ng の OpenWorker アプリから求職活動のすべてを実行（しこのダッシュボードを起動）します。アプリ内ヘルプと Ask-the-docs アシスタントが 17 言語でこれをカバーするようになりました。 **2742 テスト.**
>
