...
> **🆕 最新リリース — v1.224.0** — **実際のプロバイダーロゴ** — LLM プロバイダーのタイルが、プロバイダーがオープンソースのアイコンを公開している場合に実際のブランドロゴ（Anthropic、OpenAI、Gemini、DeepSeek、Mistral、Ollama、…）を表示します —— 依然として完全に CSP 安全（インライン SVG、リモートアセットなし）。 **2784 テスト.**
>
