...
> **🆕 最新リリース — v1.216.0** — **LLM プロバイダーを 9 つ追加** — DeepSeek、GLM (Z.ai)、Kimi、MiniMax、Mistral、Grok (xAI)、Together、Fireworks、ローカルの Ollama が ⚡ ライブ評価に加わりました（**16 プロバイダー**に）。各プロバイダーは設定でブランドのモノグラムで表示されます。 **2752 テスト.**
>
