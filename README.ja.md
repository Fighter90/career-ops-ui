...
> **🆕 最新リリース — v1.200.0** — **ATS 求人の「まだ募集中？」確認** — #/tracker で 1 クリックすると Greenhouse/Lever/Ashby/Workday/SmartRecruiters 掲載の公開 JSON を照会し（トークン 0・ブラウザなし）**募集中 / 終了 / 不明** を表示します。 **2557 テスト。**
>
