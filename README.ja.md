...
> **🆕 最新リリース — v1.220.0** — **Get on Board、複数カテゴリー** — 1 つのエントリーで `programming`・`operations-management`・`machine-learning-ai` … をスキャン（URL で重複排除、最大 12）。EM/データ検索がボードの分割ロールを取りこぼしません。 **2771 テスト.**
>
