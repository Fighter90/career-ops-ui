...
> **🆕 最新リリース — v1.227.0** — **香港とより鋭いフォローアップ** — JobsDB 香港が Jobstreet/SEEK に加わり（v5 API へ移行）、ケイデンスボードに要対応のみの絞り込みが付き、非公開の雇用主は仲介したエージェンシーを表示します — 親プロジェクト 1.30.0 同等。**テスト 2837 件。**
