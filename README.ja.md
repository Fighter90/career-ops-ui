...
> **🆕 最新リリース — v1.196.0** — **Workday エンドポイントの強化** — `portals.yml` の Workday `api:` が部分文字列ではなく**ホスト名**で検証されるようになり、`https://evil.com/?x=myworkdayjobs.com` のような細工した URL は fetch 先として通らなくなりました。CodeQL 報告 (#443)。 **2522 テスト。**
>
