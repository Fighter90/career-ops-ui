...
> **🆕 最新リリース — v1.121.0**
>
> **CareerOps マニフェスト + cvstart.org セクション。** v1.120.0(親 v1.20.0 パリティ)は、[CareerOps マニフェスト](https://career-ops.org/manifesto)をアプリ全体に反映しました — サイドバーフッターのリンク、16 言語対応のヘルプ §29、README セクション。v1.121.0 では [cvstart.org](https://cvstart.org) に 4 つのセクションを追加します: **メソドロジー**([career-ops.org/methodology](https://career-ops.org/methodology) による 6 次元のスコアリングルーブリック)、**比較**、**ライセンス**、**変更履歴**(全 16 言語対応)。さらに、ドキュメントとヘルプガイド全体にメソドロジーへのリンクを追加しました。
>
> _マニフェスト · cvstart.org メソドロジー/ライセンス/変更履歴ページ · 親 v1.19 パリティ · 61 アダプタ · ランディングのライブスター + コントリビューター · 親 v1.18 パリティ · 54 アダプター · Hired ステータス · 累計統計 · 親パリティパック · アダプタ50 · 使用量メーター再作 · デザインの磨き込み · 使用量メーター · 浮かぶヘルプアシスタント · ドキュメントとQAの統合 · セキュリティ backlog 解消 · ドキュメント & QA ×16 · Scan除外 · パイプライン概要 · セキュリティ強化2 · サニタイザー強化 · セキュリティ強化 · AI使用量 · 会社ロゴ · AI CLIツール · ガイドに質問 · CV最適化＋カバーレター · ツーページャー自動入力 · DOCXエクスポート · ポータルの状態 · アプリ内バグレポーター · 統計の刷新 · 16 ロケール · 6 LLM プロバイダ · 46 スキャナアダプタ · キャリアの方向性 · キャリアプラン · メモリレイヤー · CV Studio · ネットワーキングプランナー · mock interview · two-pager による市場フィット · 親 career-ops v1.16.0 パリティ。_
...
│  └─ reviews/REVIEW-*.md
└─ tests/                    # 1856 unit + 90 Playwright + e2e:full + e2e:smoke
...
```bash
npm test                       # 1856 unit/integration テスト
