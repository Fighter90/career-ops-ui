...
> **🆕 最新リリース — v1.113.0**
>
> **すべてのページに浮かぶ「ヘルプに質問」アシスタント。** グラデーションのロボットチャットボタンが各ページの右下(RTLでは左下)に浮かびます — クリックすると、あなたの言語のアプリ内ヘルプガイドのみに基づいて使い方の質問に答えるコンパクトなチャットが開きます(CVや求職内容は読みません)。LLMキーでライブ、なければすぐ実行できるプロンプト。
>
> _浮かぶヘルプアシスタント · ドキュメントとQAの統合 · セキュリティ backlog 解消 · ドキュメント & QA ×16 · Scan除外 · パイプライン概要 · セキュリティ強化2 · サニタイザー強化 · セキュリティ強化 · AI使用量 · 会社ロゴ · AI CLIツール · ガイドに質問 · CV最適化＋カバーレター · ツーページャー自動入力 · DOCXエクスポート · ポータルの状態 · アプリ内バグレポーター · 統計の刷新 · 16 ロケール · 6 LLM プロバイダ · 46 スキャナアダプタ · キャリアの方向性 · キャリアプラン · メモリレイヤー · CV Studio · ネットワーキングプランナー · mock interview · two-pager による市場フィット · 親 career-ops v1.16.0 パリティ。_
