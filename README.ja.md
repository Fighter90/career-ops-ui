...
> **🆕 最新リリース — v1.227.2** — **狭い画面の修正** — 352 px 以下で `#/config` が横にはみ出さなくなりました。18 個の select に縮まないインライン `min-width: 300px` がありました。320 px の Playwright 走査でゲート化。**テスト 2846 件 · Playwright 101 件。**
