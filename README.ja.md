...
> **🆕 最新リリース — v1.194.0** — **Workday の単一セグメント URL を修正** — `https://parsons.wd5.myworkdayjobs.com/Search` のような単一セグメントのページが、`External` に落ちずに正しい求人フィードへ解決されるようになりました。#255 で報告。 **2517 テスト。**
>
