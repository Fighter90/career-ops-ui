...
> **🆕 最新リリース — v1.189.0** — **`skip_tiers` があらゆる言語に対応** — ティア分類器が、どの文字体系でも職種語の後のローマ数字レベル（I/II/III/IV/V）を読みます（「Инженер III」「エンジニア I」「Ingénieur IV」）。以前は「mid」に落ちて `skip_tiers` をすり抜けていました。 **2498 テスト。**
>
