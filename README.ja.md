...
> **🆕 最新リリース — v1.85.0**
>
> **ドイツ語・イタリア語・トルコ語ロケール**（親 career-ops v1.16.0 ロケールパリティ）: UI が **16 言語**で提供されるようになりました — Deutsch 🇩🇪、Italiano 🇮🇹、Türkçe 🇹🇷 が既存の 13 言語に加わり、アプリ内ヘルプ・README・CHANGELOG の全翻訳に加え、ローカライズされた LLM プロンプトのスキャフォルディングを備えています。v1.84.0（再応募クールダウン + 報酬）、v1.83.0（再掲載検出器）、v1.82.0（NoDesk）をベースにしています。
>
> _16 ロケール · 6 LLM プロバイダ · 41 スキャナアダプタ · 再掲載検出器 · 再応募クールダウン · 親 career-ops v1.16.0 パリティ。_
