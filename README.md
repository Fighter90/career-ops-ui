...
> **🆕 Latest release — v1.189.0** — **`skip_tiers` now speaks every language** — the seniority-tier classifier reads roman-numeral levels (I/II/III/IV/V) after a role word in any script ("Инженер III", "エンジニア I", "Ingénieur IV"), not just after ASCII words; before, those fell back to "mid" and slipped past `skip_tiers`. **2498 tests.**
>
