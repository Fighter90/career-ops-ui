...
> **🆕 Latest release — v1.173.0** — **Hermes joins the AI-CLI detector** — the `#/config` "AI CLI tools" tab now probes for Hermes (Nous Research), the parent's newly supported agent runtime; read-only PATH scan, 11 tools. **2444 tests.**
>
