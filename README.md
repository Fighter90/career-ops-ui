...
> **🆕 Latest release — v1.209.0** — **Help covers recording an outcome** — the Tracker guide now documents the Outcome button in all 17 languages, and "Ask the docs" points you to it. **2625 tests.**
>
