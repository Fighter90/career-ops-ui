...
> **🆕 Latest release — v1.185.0** — **"Funnel & velocity" stats tab** — see your response & interview rates next to market benchmarks, a waiting list of stalled applications, and median days per stage — all from your own tracker, read-only. **2481 tests.**
>
