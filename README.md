...
> **🆕 Latest release — v1.199.0** — **Wide tables scroll sideways** — tables too wide for the window (Scan, Tracker, Statistics…) were cut off with no scrollbar; they now show a **horizontal scrollbar** on demand so every column stays reachable. **2540 tests.**
>
