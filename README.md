...
> **🆕 Latest release — v1.225.1** — **Provider banner fix** — the provider-logo banner now renders correctly in the README and help (rendered PNG via absolute URL; the invalid-XML SVG is fixed). **2784 tests.**
