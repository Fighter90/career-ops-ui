...
> **🆕 Latest release — v1.102.0**
>
> **Ask the docs — a grounded help chat.** A new **Ask the docs 💬** page answers how-to questions using **only** the app's in-app help guide in your language (it shows which sections it used and never reads your CV or job search). Dependency-free keyword retrieval over the guide's `##` sections; the model answers from them or admits the guide doesn't cover it. Live with an LLM key, or a copy-paste prompt without one.
>
> _ask-the-docs · CV tailor + cover letter · two-pager auto-fill · DOCX export · 16 locales · 6 LLM providers · 46 scanner adapters · portals health · in-app bug reporter · career orientation · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
