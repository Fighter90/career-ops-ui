...
> **🆕 Latest release — v1.218.0** — **Provider tiles everywhere** — the dashboard chip, Settings "Active" summary, and ⚡ eval result now show each provider's brand monogram and its correct name across all 18 (fixing three stale 5-provider labels). **2758 tests.**
>
