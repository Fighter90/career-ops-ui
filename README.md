...
> **🆕 Latest release — v1.181.0** — **Getro: salary & all locations** — the Getro scanner now shows a salary figure, joins all of a role's locations, and honours `work_mode: remote` (parent #2640 parity). **2470 tests.**
>
