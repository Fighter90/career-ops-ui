...
> **🆕 Latest release — v1.95.0**
>
> **Career plan (Epic 26):** a new **`#/career-plan`** page turns your CV and profile into a concrete, personalized development plan. Choose a **horizon** (6/12/24 months) and an optional focus, and the model writes a starting-point snapshot, a strengths/growth SWOT, goals as **SMART / OKR / WOOP**, alternative trajectories, a hard/soft skill plan, a **month-by-month roadmap**, progress-tracking, pitfalls, and support moves — grounded in your own materials, never fabricating your history. Edit it inline, **Save** it to the user layer, and export it to **Markdown or PDF**. Builds on v1.94.0 (statistics rework) and v1.93.0 (memory layer).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
