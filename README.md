...
>
> **Memory layer (Epic 24):** a new **`#/memory`** page holds a short, editable "remember this about me" note. Because it's inlined into the shared project context, it steers **every** AI request — evaluate, mock interview, networking, CV Studio — across **all** providers. It captures your preferences and working style (never new facts about you), and a **suggest-from-your-data** helper drafts behavioural bullets from your tracker to review. Builds on v1.92.0 (CV Studio), v1.91.0 (networking planner), and v1.90.0 (mock interview).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · target-role market stats · repost detector · parent career-ops v1.16.0 parity._
