...
> **🆕 Latest release — v1.190.0** — **Which companies actually answer you?** — a new **Company history** panel on `#/tracker`: pick a company and see whether it has been silent on you, mixed, or responded before — and whether the same role keeps getting reposted — joined from your tracker, follow-ups, and scan history. **2501 tests.**
>
