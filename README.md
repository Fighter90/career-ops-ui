...
> **🆕 Latest release — v1.86.0**
>
> **Statistics by target roles** (`#/stats`): a new Analytics page reads your **target roles from the profile** (not hard-coded) and your latest scan to chart **vacancies and median salary by country**, with role/country filters and a **saved-snapshot trend** — aggregated client-side from the sparse data the scanners already collect (no fabricated numbers), in all 16 locales. Builds on v1.85.0 (German/Italian/Turkish locales), v1.84.0 (re-apply cooldown), and v1.83.0 (repost detector).
>
> _16 locales · 6 LLM providers · 41 scanner adapters · target-role market stats · repost detector · parent career-ops v1.16.0 parity._
