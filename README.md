...
> **🆕 Latest release — v1.200.0** — **"Still live?" check for ATS jobs** — on #/tracker, one click asks a Greenhouse/Lever/Ashby/Workday/SmartRecruiters posting's own public JSON (zero tokens, no browser) and shows **Live / Expired / Unknown** so you spot dead postings fast. **2557 tests.**
>
