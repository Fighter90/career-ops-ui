...
> **🆕 Latest release — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** a new **`#/mock-interview`** page runs a turn-by-turn interview rehearsal against a real role. Each answer gets **STAR+R feedback**, a **score**, and a **follow-up question** — grounded in your CV, two-pager, and story bank. Runs live with any LLM key or hands back a copy-paste prompt, and you can **save transcripts** per company/role. Builds on v1.89.0 (two-pager market-fit), v1.88.0 (Scan i18n + API hygiene), and v1.87.0 (4 new scan providers).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · mock interview · two-pager market-fit · target-role market stats · repost detector · parent career-ops v1.16.0 parity._
