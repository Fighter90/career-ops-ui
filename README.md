...
> **🆕 Latest release — v1.227.0** — **Hong Kong + sharper follow-ups** — JobsDB Hong Kong joins Jobstreet/SEEK (now on the v5 API), a due-only lens on the cadence board, and confidential employers show the agency that fronted them — parent 1.30.0 parity. **2837 tests.**
