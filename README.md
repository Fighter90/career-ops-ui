...
> **🆕 Latest release — v1.100.0**
>
> **Two-pager AI auto-fill + export.** The two-pager (`#/two-pager`) now fills itself from your CV + profile via your configured provider (nothing invented; a copy-the-prompt fallback with no key), adds a **Preview & export** view, and gains **PDF / DOCX / Markdown** export — DOCX via a new dependency-free `.docx` writer, also wired into the market, career-plan, and orientation reports.
>
> _two-pager auto-fill · DOCX export · 16 locales · 6 LLM providers · 46 scanner adapters · portals health · in-app bug reporter · career orientation · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
