...
> **🆕 Latest release — v1.212.1** — **Landing source-count fix** — cvstart.org listed 80 job sources and dropped Job Bank (Canada) after v1.212.0; it's back to 81 in sync with the app, and the site build now hard-fails on any source-count drift. **2687 tests.**
>
