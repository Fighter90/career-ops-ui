...
> **🆕 Latest release — v1.204.0** — **"Setup doctor" in Settings** — a zero-token check of your `cv.md` + `config/profile.yml` that lists blocking issues (missing files/fields) and warnings (leftover example data, hardcoded metrics), so you fix an incomplete setup before it weakens scans and tailoring. **2602 tests.**
>
