...
> **🆕 Latest release — v1.181.0** — **Getro: salary & all locations** — the Getro scanner now shows a salary figure on each role, lists all of a role's locations (not just the first), and tags remote roles. **2470 tests.**
>
