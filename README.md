...
> **🆕 Latest release — v1.210.1** — **Habr titles fixed** — vacancy titles and company names with "&" or quotes are now decoded, so they no longer drop from your filter or reach the tracker garbled. **2644 tests.**
>
