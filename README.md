...
> **🆕 Latest release — v1.187.0** — **`skip_tiers` works again** — a `skip_tiers: [intern, entry]` list in `portals.yml` now drops postings by seniority tier during a scan (it was silently ignored before). **2492 tests.**
>
