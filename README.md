...
> **🆕 Latest release — v1.172.0** — **HTML-entity decoder crash fix** — a malformed numeric entity (e.g. `&#99999999;`) could throw a `RangeError` and abort a scan source; a shared decoder now bounds numeric references to the XML 1.0 Char set (career-ops #2150 parity). **2444 tests.**
>
