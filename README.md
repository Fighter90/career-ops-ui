...
> **🆕 Latest release — v1.186.0** — **"Skill gap" panel in CV Studio** — pick a saved job description and see which of its required skills your CV names, only implies, or is missing — zero-LLM, nothing written. **2485 tests.**
>
