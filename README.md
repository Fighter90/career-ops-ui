...
> **🆕 Latest release — v1.210.0** — **Senjob — the scanner reaches Africa** — a new zero-token source for Senegal (senjob.com), and five more boards now match titles that contain "&". **2643 tests.**
>
