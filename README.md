...
> **🆕 Latest release — v1.91.0**
>
> **Networking & deep company research (Epic 16):** a new **`#/networking`** page turns a company into an actionable plan — a **company dossier**, **who to contact** (personas + LinkedIn search strings), the **warmest intro path**, and tailored **outreach drafts** — all grounded in your CV and two-pager. Runs live with any LLM key or hands back a copy-paste prompt, and you can **save plans** per company. Builds on v1.90.0 (mock interview), v1.89.0 (two-pager market-fit), and v1.88.0 (Scan i18n + API hygiene).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · networking planner · mock interview · two-pager market-fit · target-role market stats · repost detector · parent career-ops v1.16.0 parity._
