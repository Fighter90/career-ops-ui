...
> **🆕 Latest release — v1.184.0** — **Even Dashboard grid** — the quick-action tiles now use equal-width columns, so a 3-tile group no longer renders wider than a 4-tile group and every section lines up on the right. **2479 tests.**
>
