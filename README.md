...
> **🆕 Latest release — v1.168.0** — **Bigger checkbox tap targets (a11y fix)** — checkbox/radio label rows on `#/scan`, `#/config`, `#/evaluate`, `#/cv-studio` sat in a ~22 px band, under the WCAG 2.5.8 24 px floor. A scoped `:has()` rule guarantees a ≥24 px band. **2429 tests.**
>
