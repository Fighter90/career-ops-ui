...
> **🆕 Latest release — v1.178.0** — **Parent-parity constant refresh** — the browser User-Agent bumps to Chrome 151 (WAF/bot-gate parity) and the tracker-states fallback gains the parent's Turkish status aliases. **2456 tests.**
>
