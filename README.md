...
> **🆕 Latest release — v1.203.0** — **"Reuse a past CV?" hint in CV Studio** — a saved job description is compared against your other saved JDs (deterministic, zero tokens) to tell you whether the closest match lets you reuse a tailored CV, reuse it with edits, or tailor a fresh one. **2594 tests.**
>
