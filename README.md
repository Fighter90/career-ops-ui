...
> **🆕 Latest release — v1.176.0** — **Score parsing (FIND-5)** — a report score under a bold label the RU table doesn't list (`**Итоговый балл:**`, `**Скор:**`) is now caught by its `X.X / 5` value form — language-independent, heading- and date-safe. **2453 tests.**
>
