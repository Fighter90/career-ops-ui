...
>
> **Scan Exclude filter + pipeline overview.** The scan Search box now treats commas as OR ("roles to find") and a new Exclude field hides rows matching any comma-separated word; both persist in saved searches. The pipeline page gains a compact overview strip — N in inbox, N tracked, and Applied / Responded / Interview / Offer counts from the tracker, each linking to `#/tracker`.
>
> _scan Exclude · pipeline overview · security hardening 2 · sanitizer hardening · security hardening · AI usage & cost · company logos · AI CLI tools · ask-the-docs · CV tailor + cover letter · two-pager auto-fill · DOCX export · 16 locales · 6 LLM providers · 46 scanner adapters · portals health · in-app bug reporter · career orientation · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
