...
> **🆕 Latest release — v1.177.0** — **csod cookie replay (parent #2769)** — Cornerstone tenants that gate the search API behind session cookies (401 → 0 jobs) now work: the bootstrap page's `Set-Cookie` is replayed as a `Cookie` header on the search POST, same-origin only. **2454 tests.**
>
