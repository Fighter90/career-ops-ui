...
> **🆕 Latest release — v1.227.2** — **Narrow-phone fix** — `#/config` no longer scrolls sideways at ≤ 352 px: 18 provider selects carried an inline `min-width: 300px` that could not shrink. Now gated by a 320 px Playwright sweep. **2846 tests · 101 Playwright.**
