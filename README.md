...
> **🆕 Latest release — v1.148.0** — **Cleaner scan filters** — the `#/scan` result-filter panel is now a tidy responsive grid (was a ragged flex-wrap), with Apply / Reset on a separated, right-aligned row. Same filters, easier to read. **2381 tests.**
>
