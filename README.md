...
> **🆕 Latest release — v1.92.0**
>
> **CV Studio (Epic 21):** a new **`#/cv-studio`** page gives your CV three honest tools — **résumé diagnostics** (a deterministic 0–100 score with per-check explanations), a **privacy mask** (redact email/phone/links/address/name entirely in-browser), and **make it human** (rewrite stiff lines in _your_ voice, grounded in your voice-dna and writing samples, never inventing facts). Builds on v1.91.0 (networking planner), v1.90.0 (mock interview), and v1.89.0 (two-pager market-fit).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · CV Studio · networking planner · mock interview · two-pager market-fit · target-role market stats · repost detector · parent career-ops v1.16.0 parity._
