...
> **🆕 Latest release — v1.212.0** — **Job Bank (Canada) + fixes** — Canada's federal job board is now scannable, Consider boards return results again, and multi-location Lever roles show every location. (EchoJobs retired — its feed is bot-blocked.) **2685 tests.**
>
