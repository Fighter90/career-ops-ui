...
> **🆕 Latest release — v1.205.0** — **Skills log** — record a skills self-assessment (company, platform, skill, score %, note) in Analytics → Skills log; it appends to `data/assessments.tsv` and lists past entries. Zero-token; the write is control-char-guarded (no TSV injection). **2610 tests.**
>
