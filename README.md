...
>
> **Statistics, reworked (Epic 25):** the **`#/stats`** page is now a three-tab **Statistics** section with real graphs and far more data. A new **Market report** tab generates an AI salary & labour-market analysis of your target roles — by grade with P10–P90 percentiles, top employers, in-demand skills, benefits, remote split, trends, and negotiation guidance, in the region and **currency** you choose (figures labelled as directional model estimates, never scraped). A new **My pipeline** tab charts your own tracker (scores, funnel, top companies/roles, timeline, conversion rates). Every report exports to **Markdown or PDF**. Builds on v1.93.0 (memory layer) and v1.92.0 (CV Studio).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · repost detector · parent career-ops v1.16.0 parity._
