...
> **🆕 Latest release — v1.227.1** — **Help-guide fixes** — the §17 source breakdown now adds up (80 EN + 5 RU, was a self-contradictory 78+5=83), the stale version anchor is gone, and the GitHub banner no longer prints as raw markup atop `#/help` — all three now gated. **2846 tests.**
