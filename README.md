...
> **🆕 Latest release — v1.175.0** — **SEO-description regression guard** — a CI test now fails if any of the 17 site locales drops the `{adapters}` placeholder or re-hard-codes a count (the drift behind the "~55" bug), plus a nullish-safe legitimacy strip. **2451 tests.**
>
