...
> **🆕 Latest release — v1.207.2** — **AI plans render properly again** — the development plan and career-orientation profile no longer show up as a raw monospace code dump when the model wraps its whole answer in a ```markdown fence. **2621 tests.**
>
