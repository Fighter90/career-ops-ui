...
> **🆕 Latest release — v1.180.0** — **Reports as a table** — `#/reports` is now a table (Report · Date · Legitimacy · Score); a long "Score not detected" chip no longer breaks the report name one character per line, and a real score a Machine Summary placeholder was hiding is recovered. **2465 tests.**
>
