...
> **🆕 Latest release — v1.219.0** — **Torre joins the scanner** — the LatAm talent marketplace (torre.ai) is a new scan source (**83** total), plus an a16z pagination fix and correct provider labels + monograms everywhere. **2768 tests.**
>
