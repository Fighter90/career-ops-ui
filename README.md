...
>
> **Career orientation (Epic 27):** a new **`#/orientation`** page answers "which directions actually fit me?" — the read you'd get from a vocational test, but inferred from your own CV and profile instead of a questionnaire. Click **Generate profile** and the model returns your **best-fit career vectors** (which of the eight archetypes fit, with evidence), a career-type leaning, recommended roles, professional strengths tied to your CV, working-style tendencies, and development recommendations. It's an **AI reflection of how your CV reads — not a psychometric test**: it never invents achievements and never reports numeric scores as if measured. Export it to **Markdown or PDF**; nothing is written to disk. Builds on v1.95.0 (career plan) and v1.94.0 (statistics rework).
>
> _16 locales · 6 LLM providers · 45 scanner adapters · career orientation · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
