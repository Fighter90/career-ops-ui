...
> **🆕 Latest release — v1.208.1** — **Mobile top-bar fix** — its buttons no longer overlap the page heading when they wrap to a second row on a phone; the bar grows to fit them. **2621 tests.**
>
