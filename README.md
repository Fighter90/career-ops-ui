...
> **🆕 Latest release — v1.211.0** — **Yourator + sharper decoding** — a new Taiwan tech job board, plus accented company/title entities (`D&eacute;veloppeur`) now decode everywhere and accented company names match their own domain. **2667 tests.**
>
