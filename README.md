...
> **🆕 Latest release — v1.116.0**
>
> **Usage meter reworked + first end-to-end widget test.** The AI usage meter is now pinned to the bottom of the left sidebar (never covering the menu — it pads the sidebar so nav scrolls clear), refreshes live, and shows real tokens · estimated cost per window. A durable typeof barrier closes a recurring CodeQL false positive, and a new Playwright end-to-end test drives both persistent widgets in a real browser.
>
> _usage meter rework · design polish · usage meter · floating docs assistant · docs & QA consolidation · security backlog closeout · docs & QA refresh ×16 · scan Exclude · pipeline overview · security hardening 2 · sanitizer hardening · security hardening · AI usage & cost · company logos · AI CLI tools · ask-the-docs · CV tailor + cover letter · two-pager auto-fill · DOCX export · 16 locales · 6 LLM providers · 46 scanner adapters · portals health · in-app bug reporter · career orientation · career plan · statistics rework · memory layer · CV Studio · networking planner · mock interview · two-pager market-fit · parent career-ops v1.16.0 parity._
