...
│  └─ reviews/REVIEW-*.md
└─ tests/                    # 2909 unit + 101 Playwright + 23/23 e2e:full + 21 e2e:smoke (baseline @ v1.197.0)
...
- Run `npm test` before pushing — **2909 checks green** is the bar (plus 101 Playwright if you touch UI).
