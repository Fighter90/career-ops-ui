...
> **🆕 Latest release — v1.217.1** — **Ark joins the roster** — BytePlus Ark + Volcengine Ark (ByteDance Doubao) are now ⚡ live-eval providers (**18 total**), each with a brand monogram in Settings. **2756 tests.**
>
