...
> **🆕 Latest release — v1.220.0** — **Get on Board, multiple categories** — one entry can now scan `programming`, `operations-management`, `machine-learning-ai`, … (deduped, capped at 12) so EM/data searches don't miss roles the board splits out. **2771 tests.**
>
