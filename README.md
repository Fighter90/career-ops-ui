...
> **🆕 Latest release — v1.179.0** — **Decoder consolidation** — 20 duplicate HTML-entity decoders across scan sources now route through one shared module (−237 lines), with a guard against re-duplication. Behaviour-preserving. **2458 tests.**
>
