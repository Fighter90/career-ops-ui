...
> **🆕 Latest release — v1.194.0** — **Workday single-segment URLs fixed** — career pages like `https://parsons.wd5.myworkdayjobs.com/Search` (a one-segment path) now resolve to the right jobs feed instead of silently falling back to `External`. Reported in #255. **2517 tests.**
>
