...
> **🆕 Latest release — v1.85.0**
>
> **German, Italian & Turkish locales** (parent career-ops v1.16.0 locale parity): the UI now ships in **16 languages** — Deutsch 🇩🇪, Italiano 🇮🇹 and Türkçe 🇹🇷 join the existing 13, with full in-app Help, README and CHANGELOG translations plus localized LLM-prompt scaffolding. Builds on v1.84.0 (re-apply cooldown + compensation), v1.83.0 (repost detector), and v1.82.0 (NoDesk).
>
> _16 locales · 6 LLM providers · 41 scanner adapters · repost detector · re-apply cooldown · parent career-ops v1.16.0 parity._
