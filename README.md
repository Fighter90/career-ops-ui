...
> **🆕 Latest release — v1.193.0** — **Silent after interview** — a new `#/stats` tab lists interviews that have gone quiet past a courtesy window (default 30 days) — with how long each has been silent and the last interview date — so nothing worth a nudge slips away. **2510 tests.**
>
