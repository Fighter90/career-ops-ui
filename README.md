...
> **🆕 Latest release — v1.227.4** — **Prefix fix, part 2** — `word:` / `stem:` were still ignored by `content_filter`; v1.227.3 only wired the title filter. Caught in AI review. **2858 tests.**
