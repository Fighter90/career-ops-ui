...
test('every help-bundle keeps the 25-H2 parity contract after v1.29.1 edit', () => {
  ...
  assert.equal(baseline, 28, `expected 28 H2 sections, got ${baseline}`);
});
