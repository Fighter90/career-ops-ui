...
test('registry: ALL_ADAPTERS has the expected entries', async () => {
  ...
  assert.equal(ALL_ADAPTERS.length, 89);
  ...
  assert.deepEqual(ids, [
    ...
    'garena', 'gem', 'generalist-world', 'getonbrd', 'getro', 'glints',
    'greenhouse', 'hackernews', 'hecklerkoch', 'higheredjobs', 'himalayas', 'ibm',
    'icims', 'itviec', 'jibeapply', 'jobbankca', 'jobicy', 'jobspresso',
    'jobstreet', 'jobvite', 'join', 'joinup', 'justjoin', 'landingjobs',
    'larajobs', 'lever', 'manfred', 'meituan', 'mokahr', 'mycareersfuture',
    'nodesk', 'nofluffjobs', 'oraclecloud', 'personio', 'phenom', 'pinpoint',
    'pythonorg', 'radancy', 'recruitee', 'remoteok', 'remotive', 'remotli',
    'rheinmetall', 'rippling', 'rss', 'senjob', 'smartrecruiters', 'softgarden',
    'solidjobs', 'successfactors', 'teamtailor', 'telegram', 'telegram-channel', 'tencent',
    'thehub', 'themuse', 'tkms', 'torre', 'vdab', 'weworkremotely',
    'workable', 'workday', 'workingnomads', 'wttj', 'yourator',
  ]);
});
