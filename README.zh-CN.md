...
> **🆕 最新版本 — v1.104.0**
>
> **扫描表中的公司徽标(保护隐私)。** 新的外观开关会在 `#/scan` 的公司名称旁绘制其徽标。徽标是**公司自己域名的 favicon**,通过 SSRF 安全抓取器在服务端代理(`GET /api/logo`),因此没有第三方徽标服务能得知你查看哪些雇主。共享招聘门户主机改用字母徽章;默认关闭。
>
> _公司徽标 · AI CLI 工具 · 向文档提问 · 简历定制 + 求职信 · 两页纸自动填充 · DOCX 导出 · 门户健康 · 应用内错误报告器 · 16 locales · 6 个 LLM 提供方 · 46 个扫描器适配器 · 职业方向 · 职业规划 · 统计重构 · 记忆层 · CV Studio · 人脉拓展规划器 · mock interview · two-pager 市场契合度 · 与父级 career-ops v1.16.0 对齐。_
