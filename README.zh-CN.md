...
> **🆕 最新版本 — v1.102.0**
>
> **向文档提问——有据可依的帮助对话。** 新增**向文档提问 💬**页面，**仅**使用你所用语言的应用帮助指南回答使用问题(显示所用章节，绝不读取你的简历或求职信息)。对指南 `##` 章节进行零依赖关键词检索；模型据此作答或承认指南未涵盖。有 LLM 密钥时实时，无则给出可复制提示词。
>
> _向文档提问 · 简历定制 + 求职信 · 两页纸自动填充 · DOCX 导出 · 门户健康 · 应用内错误报告器 · 16 locales · 6 个 LLM 提供方 · 46 个扫描器适配器 · 职业方向 · 职业规划 · 统计重构 · 记忆层 · CV Studio · 人脉拓展规划器 · mock interview · two-pager 市场契合度 · 与父级 career-ops v1.16.0 对齐。_
