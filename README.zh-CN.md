...
> **🆕 最新版本 — v1.85.0**
>
> **德语、意大利语与土耳其语语言包**（与上游 career-ops v1.16.0 语言包对齐）：界面现已支持 **16 种语言** —— Deutsch 🇩🇪、Italiano 🇮🇹 与 Türkçe 🇹🇷 加入现有的 13 种语言,并提供完整的应用内帮助、README 与 CHANGELOG 翻译,以及本地化的 LLM 提示脚手架。在 v1.84.0（重复投递冷却期 + 薪资）、v1.83.0（重复发布检测器）以及 v1.82.0（NoDesk）的基础上构建。
>
> _16 locales · 6 个 LLM 提供方 · 41 个扫描器适配器 · 重复发布检测器 · 重复投递冷却期 · 与父级 career-ops v1.16.0 对齐。_
