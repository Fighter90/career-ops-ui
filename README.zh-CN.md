...
> **🆕 最新版本 — v1.196.0** — **Workday 端点加固** — `portals.yml` 中的 Workday `api:` 现在按**主机名**校验，而非子串，因此像 `https://evil.com/?x=myworkdayjobs.com` 这样的构造 URL 不再能作为 fetch 目标通过。由 CodeQL 报告（#443）。 **2522 项测试。**
>
