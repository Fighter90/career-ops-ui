...
> **🆕 最新版本 — v1.101.0**
>
> **CV Studio：针对职位定制 + 求职信。** `#/cv-studio` 新增**针对职位定制**卡片，把职位描述变成定制简历与匹配的求职信，并让两者通过招聘官级别的**检查清单门禁**(错误拦截，警告提示)。将职业辅导实践提炼为通用规则——仅基于你自己的简历、档案和两页纸，绝不杜撰。结果可导出为 Markdown / PDF / DOCX。
>
> _简历定制 + 求职信 · 两页纸自动填充 · DOCX 导出 · 门户健康 · 应用内错误报告器 · 16 locales · 6 个 LLM 提供方 · 46 个扫描器适配器 · 职业方向 · 职业规划 · 统计重构 · 记忆层 · CV Studio · 人脉拓展规划器 · mock interview · two-pager 市场契合度 · 与父级 career-ops v1.16.0 对齐。_
