...
> **🆕 最新版本 — v1.117.0**
>
> **父项目对齐包。** 父 career-ops 的六项能力进入 UI:跟进节奏板、拒绝模式统计标签页(结果、建议、各 ATS 供应商推进率)、添加到 CV 卡片(有依据的要点、仅建议)、4 个新扫描提供方(现 50 个适配器)、Apply 淘汰项预扫描、reconcile 运行器。
>
> _对齐包 · 50 适配器 · 用量计量重做 · 设计打磨 · 用量计量 · 浮动帮助助手 · 文档与 QA 整合 · 安全待办清理 · 文档与 QA ×16 · Scan 排除 · 流水线概览 · 安全加固 2 · 净化器加固 · 安全加固 · AI 用量与成本 · 公司徽标 · AI CLI 工具 · 向文档提问 · 简历定制 + 求职信 · 两页纸自动填充 · DOCX 导出 · 门户健康 · 应用内错误报告器 · 16 locales · 6 个 LLM 提供方 · 46 个扫描器适配器 · 职业方向 · 职业规划 · 统计重构 · 记忆层 · CV Studio · 人脉拓展规划器 · mock interview · two-pager 市场契合度 · 与父级 career-ops v1.16.0 对齐。_
