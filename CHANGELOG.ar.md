...
**طبقة الذاكرة (Epic 24).** صفحة `#/memory` جديدة تحتفظ بملاحظة قصيرة قابلة للتحرير «تذكّر هذا عنّي» يبقيها المساعد في ذهنه في **every** مهمة:

- **ملاحظة واحدة، في كل مكان** — لأنها مُضمَّنة داخل `bundleProjectContext`، تصل الملاحظة تلقائياً إلى كل طلب ذكاء اصطناعي (التقييم، المقابلة التجريبية، التواصل المهني، CV Studio) عبر **all** المزودين. اكتبها مرة واحدة؛ فتوجّه كل شيء.
