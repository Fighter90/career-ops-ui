...
> **🆕 Seneste udgivelse — v1.196.0** — **Workday-endpoint-hærdning** — en Workday `api:` i `portals.yml` valideres nu på sit **hostnavn**, ikke en delstreng, så en fabrikeret URL som `https://evil.com/?x=myworkdayjobs.com` ikke længere slipper igennem som fetch-mål. Rapporteret af CodeQL (#443). **2522 tests.**
>
