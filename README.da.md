...
> **🆕 Seneste udgivelse — v1.103.0**
>
> **Indstillinger: AI CLI-værktøjer.** En ny **AI CLI-værktøjer**-fane i App-indstillinger viser hvilke agent-CLI'er — Claude Code, Codex, Gemini CLI, OpenCode, GitHub Copilot CLI, Qwen, Antigravity — der er installeret på maskinen, der kører serveren, og deres stier. En skrivebeskyttet PATH-scanning: den tjekker kun, om hver binær findes, og **kører den aldrig** (ingen `--version`, ingen kørsel), skriver intet, læser ingen brugerdata.
>
> _AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
