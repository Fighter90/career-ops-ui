...
> **🆕 Seneste udgivelse — v1.225.1** — **Rettelse af udbyderbanner** — udbyderlogo-banneret vises nu korrekt i README og hjælpen (gengivet PNG via absolut URL; den ugyldige-XML SVG er rettet). **2784 tests.**
