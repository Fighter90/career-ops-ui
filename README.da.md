...
> **🆕 Seneste udgivelse — v1.108.0**
>
> **Sikkerhedshærdning (CodeQL-triage, runde 2).** Prompt-byggeren opslår rollelinjen via egen nøgle + `typeof === function`, PDF-filnavns-sluggen begrænses før dens regex (polynomiel ReDoS), og dokumentimport tvinger et array-`filename` til en streng (type-confusion). Over v1.106–v1.108 gik den statiske analyses efterslæb fra 167 til ~14, hvert reelt fund rettet og resten afvist med begrundelse.
>
> _sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
