...
> **🆕 Seneste udgivelse — v1.204.0** — **"Opsætnings-doktor" i Indstillinger** — et token-frit tjek af dit `cv.md` + `config/profile.yml`, der viser blokerende problemer og advarsler (eksempeldata, hardkodede tal), så du retter en ufuldstændig opsætning, før den svækker scanninger og tilpasninger. **2602 tests.**
>
