...
> **🆕 Seneste udgivelse — v1.176.0** — **Score-parsing (FIND-5)** — en score under en fed etiket, som RU-tabellen ikke lister (`**Итоговый балл:**`, `**Скор:**`), fanges nu via sin `X.X / 5`-værdiform — sproguafhængig, sikker over for overskrifter og datoer. **2453 tests.**
>
