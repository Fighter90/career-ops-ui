...
> **🆕 Seneste udgivelse — v1.177.0** — **csod cookie-gentagelse (parent #2769)** — Cornerstone-lejere, der beskytter søge-API'et med session-cookies (401 → 0 job), virker nu: bootstrap-sidens `Set-Cookie` gentages som `Cookie`-header på søge-POST'en, kun samme origin. **2454 tests.**
>
