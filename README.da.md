...
> **🆕 Seneste udgivelse — v1.192.0** — **Faktatjek dit CV** — en ny gate i `#/cv-studio` tjekker et tilpasset CV eller følgebrev mod dit rigtige CV/profil/two-pager og markerer hver opdigtet måling eller ubegrundet påstand (pass/warn/block). **2508 tests.**
>
