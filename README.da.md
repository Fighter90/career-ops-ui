...
> **🆕 Seneste udgivelse — v1.92.0**
>
> **CV Studio (Epic 21):** en ny **`#/cv-studio`**-side giver dit CV tre ærlige værktøjer — **CV-diagnostik** (en deterministisk 0–100-score med forklaringer pr. tjek), en **privatlivsmaske** (sløring af e-mail/telefon/links/adresse/navn helt i browseren) og **make it human** (omskriv stive linjer i _din_ stemme, forankret i din voice-dna og dine skriveprøver, uden at opdigte fakta). Bygger videre på v1.91.0 (networking-planlægger), v1.90.0 (jobsamtale-øvelse) og v1.89.0 (markedsfit via two-pager).
>
> _16 lokaliteter · 6 LLM-providere · 45 scanneradaptere · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · markedsstatistik efter målroller · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
