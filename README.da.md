...
> **🆕 Seneste udgivelse — v1.141.0** — **indsigtsfulde statistikker (fortsat): berigelse af finansierede virksomheder** — `#/funded` er nu et visuelt kortgitter: virksomheds**logoer**, et **diagram efter beløb** og kort med **runde / beløb / score / foreslået handling**. 3 nøgler ×17 sprog. **2363 tests.**
>
