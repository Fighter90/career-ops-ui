...
> **🆕 Seneste udgivelse — v1.174.0** — **Score i lokaliserede rapporter + SEO-rettelse** — ikke-engelske rapporter viser ikke længere "Score not detected" (et H1 med etiketordet blev forvekslet med scoren); legitimitets-chips fjerner løse `**`, lange scores løber ikke over kortet, og cvstart.org-beskrivelsen tæller det rigtige register (~75). **2448 tests.**
>
