...
> **🆕 Seneste udgivelse — v1.172.0** — **Rettelse af nedbrud i HTML-entitetsdekoder** — en misdannet numerisk entitet (f.eks. `&#99999999;`) kunne kaste en `RangeError` og afbryde en scanningskilde; en delt dekoder begrænser nu numeriske referencer til XML 1.0 Char-sættet (career-ops #2150-paritet). **2444 tests.**
>
