...
> **🆕 Seneste udgivelse — v1.107.0**
>
> **Sanitizer-hærdning (XSS i hviletilstand).** CV/job-markdown-sanitizeren fjerner nu farlig HTML **til et fikspunkt** (for at fange en fjernelse, der gendanner en payload), matcher script/style-slutmærker med efterfølgende skrald (`</script foo>`) og fjerner en uafsluttet eksekverbar åbner. Forsvar i dybden bag escape-ved-rendering-klienten; lukker de tilsvarende CodeQL-fund.
>
> _sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
