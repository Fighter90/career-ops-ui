...
> **🆕 Seneste udgivelse — v1.138.0** — **generering på dit interfaces sprog** — hver AI-generering (karriereplan, orientering, markedsrapport, mock-interview, networking, «spørg dokumentationen», hukommelsesnote, two-pager) svarer nu på det sprog, der er valgt i UI’et, i stedet for altid engelsk; plus review-drevne teststyrkelser (en CSS-farverolle-kanariefugl og en `UI.md()` XSS-loader-selvtest). **2356 tests.**
>
