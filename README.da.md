...
> **🆕 Seneste udgivelse — v1.233.0** — **Tre fund i gemmestien for `#/config`; CONFIG-3 kom af rettelsen i v1.232.1 selv.** Et bevidst valg lig den forudfyldte værdi blev kasseret som »ikke rørt«; nu noteres **`seededFromFile`**. Fjernelse af en nøgle meldte »· 0« — serveren svarer nu også med `removed`. En rulleliste kunne sættes, men ikke ryddes: hver begynder nu med **»Brug standardværdien (…)«**. **3018 test · 116 browser.**
