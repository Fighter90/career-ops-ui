...
> **🆕 Seneste udgivelse — v1.182.0** — **Sprogneutrale lønintervaller** — ensidede beløb i scan og tracker vises nu som `≥` / `≤` (fx `≥ 120000 EUR`) i stedet for engelsk "from" / "up to", så de læses ens på alle sprog. **2470 tests.**
>
