...
> **🆕 Seneste udgivelse — v1.198.0** — **Smartere scan-genforsøg** — når et board kortvarigt rate-limiter (HTTP 429/5xx) midt i en scanning, bruger genforsøg nu **eksponentiel backoff + jitter** og respekterer et (klemt) `Retry-After` i stedet for en fast kort forsinkelse. **2536 tests.**
>
