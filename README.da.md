...
> **🆕 Seneste udgivelse — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** en ny **`#/mock-interview`**-side kører en jobsamtale-øvelse tur for tur mod en konkret rolle. Hvert svar får **STAR+R-feedback**, en **score** og et **opfølgende spørgsmål** — forankret i dit CV, din two-pager og din historiebank. Kører live med enhver LLM-nøgle eller udleverer en kopiér-indsæt-prompt, og du kan **gemme transskriptioner** pr. virksomhed/rolle. Bygger videre på v1.89.0 (markedsfit via two-pager), v1.88.0 (Scan-i18n + API-hygiejne) og v1.87.0 (4 nye scan-udbydere).
>
> _16 lokaliteter · 6 LLM-providere · 45 scanneradaptere · jobsamtale-øvelse · markedsfit via two-pager · markedsstatistik efter målroller · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
