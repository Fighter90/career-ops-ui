...
> **🆕 Seneste udgivelse — v1.168.0** — **Større afkrydsnings-trykmål (a11y-rettelse)** — afkrydsnings-/radiorækker på `#/scan`, `#/config`, `#/evaluate`, `#/cv-studio` var ~22 px, under WCAG 2.5.8's 24 px-minimum. En `:has()`-regel garanterer ≥24 px. **2429 tests.**
>
