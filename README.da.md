...
> **🆕 Seneste udgivelse — v1.178.0** — **Opdatering af konstanter (forælder-paritet)** — browser-User-Agent hæves til Chrome 151 (WAF/bot-gate-paritet), og tracker-tilstands-fallback får forælderens tyrkiske status-aliaser. **2456 tests.**
>
