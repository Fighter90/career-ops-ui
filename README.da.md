...
> **🆕 Seneste udgivelse — v1.197.0** — **Følg et Getro-board alene ud fra dets URL** — giv et fulgt Getro-board dets egen `careers_url`, og det numeriske collection-id **løses nu automatisk** fra boardsiden (én SSRF-sikker hentning), uden manuelt opslag. **2527 tests.**
>
