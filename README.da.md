...
> **🆕 Seneste udgivelse — v1.86.0**
>
> **Statistik efter målroller** (`#/stats`): en ny Analytics-side læser dine **målroller fra profilen** (ikke hardkodet) og din seneste scanning for at tegne **stillinger og medianløn efter land**, med rolle-/landefiltre og en **tendens fra gemte øjebliksbilleder** — aggregeret på klientsiden ud fra de sparsomme data, som scannerne allerede indsamler (ingen opdigtede tal), på alle 16 sprog. Bygger videre på v1.85.0 (tysk/italiensk/tyrkisk lokalitet), v1.84.0 (genansøgnings-cooldown) og v1.83.0 (genoplagsdetektor).
>
> _16 lokaliteter · 6 LLM-providere · 41 scanneradaptere · markedsstatistik efter målroller · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
