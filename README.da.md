...
> **🆕 Seneste udgivelse — v1.113.0**
>
> **Flydende "Spørg hjælpen"-assistent på hver side.** En gradient-robot-chatknap svæver i nederste højre hjørne (nederste venstre i RTL) på hver side — tryk for en kompakt chat, der svarer på brugsspørgsmål udelukkende fra den indbyggede hjælpeguide på dit sprog (læser aldrig dit CV eller din søgning). Live med en LLM-nøgle, eller en klar prompt uden.
>
> _flydende hjælpeassistent · docs- og QA-konsolidering · lukning af sikkerheds-backlog · docs & QA ×16 · Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
