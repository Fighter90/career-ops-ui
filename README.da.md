...
> **🆕 Seneste udgivelse — v1.175.0** — **Regressionsvagt for SEO-beskrivelsen** — en CI-test fejler nu, hvis et af de 17 site-sprog mister `{adapters}`-pladsholderen eller hard-koder et antal igen (driften bag "~55"-fejlen), plus en nullsikker legitimitets-strip. **2451 tests.**
>
