...
> **🆕 Seneste udgivelse — v1.91.0**
>
> **Networking og dybdegående virksomhedsresearch (Epic 16):** en ny **`#/networking`**-side forvandler en virksomhed til en handlingsorienteret plan — et **virksomhedsdossier**, **hvem du skal kontakte** (personaer + LinkedIn-søgestrenge), den **varmeste introvej** og skræddersyede **kontaktudkast** — alt forankret i dit CV og din two-pager. Kører live med enhver LLM-nøgle eller udleverer en kopiér-indsæt-prompt, og du kan **gemme planer** pr. virksomhed. Bygger videre på v1.90.0 (jobsamtale-øvelse), v1.89.0 (markedsfit via two-pager) og v1.88.0 (Scan-i18n + API-hygiejne).
>
> _16 lokaliteter · 6 LLM-providere · 45 scanneradaptere · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · markedsstatistik efter målroller · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
