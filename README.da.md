...
> **🆕 Seneste udgivelse — v1.100.0**
>
> **AI-autoudfyldning af two-pager + eksport.** Two-pageren (`#/two-pager`) udfylder nu sig selv fra dit CV + profil via din konfigurerede udbyder (intet opdigtet; kopiér-prompt-fallback uden nøgle), tilføjer en **Forhåndsvis og eksportér**-visning og får eksport til **PDF / DOCX / Markdown** — DOCX via en ny afhængighedsfri `.docx`-generator, også koblet til markeds-, karriereplan- og orienteringsrapporterne.
>
> _two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
