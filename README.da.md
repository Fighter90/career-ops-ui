...
> **🆕 Seneste udgivelse — v1.85.0**
>
> **Tysk, italiensk og tyrkisk lokalitet** (lokalitetsparitet med forælderens career-ops v1.16.0): brugerfladen leveres nu på **16 sprog** — Deutsch 🇩🇪, Italiano 🇮🇹 og Türkçe 🇹🇷 slutter sig til de eksisterende 13, med fuld oversættelse af den indbyggede Hjælp, README og CHANGELOG samt lokaliseret stillads til LLM-prompts. Bygger videre på v1.84.0 (genansøgnings-cooldown + kompensation), v1.83.0 (genoplagsdetektor) og v1.82.0 (NoDesk).
>
> _16 lokaliteter · 6 LLM-providere · 41 scanneradaptere · genoplagsdetektor · genansøgnings-cooldown · paritet med forælderens career-ops v1.16.0._
