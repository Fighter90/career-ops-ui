...
> **🆕 Seneste udgivelse — v1.183.0** — **Smartere dublet-registrering** — scanneren nøgler nu hvert job på en kanonisk URL, så det samme opslag genopslået med et sporingslink (`?utm_…`), over `http`/`https`, eller med afsluttende skråstreg ikke længere vises to gange. **2477 tests.**
>
