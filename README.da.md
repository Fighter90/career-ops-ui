...
> **🆕 Seneste udgivelse — v1.187.0** — **`skip_tiers` virker igen** — en `skip_tiers: [intern, entry]`-liste i `portals.yml` frasorterer nu opslag efter niveau under en scanning (før blev den stiltiende ignoreret). **2492 tests.**
>
