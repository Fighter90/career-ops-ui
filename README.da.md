...
> **🆕 Seneste udgivelse — v1.115.0**
>
> **Designfinpudsning (konservativ, koralbrand).** En let forfinelse af det delte designsystem — ingen omstrukturering eller paletændring: metrikkort løfter sig med en koralkant ved hover, knapper får en hvileskygge og et blidt løft, store tal justeres via tabular-nums, og kontroller får en blød koral-fokusglorie. Bevægelse respekterer prefers-reduced-motion.
>
> _designfinpudsning · forbrugsmåler · flydende hjælpeassistent · docs- og QA-konsolidering · lukning af sikkerheds-backlog · docs & QA ×16 · Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
