...
> **🆕 Seneste udgivelse — v1.101.0**
>
> **CV Studio: tilpas til et job + ansøgning.** Et nyt **Tilpas til et job**-kort på `#/cv-studio` gør en jobbeskrivelse til et tilpasset CV plus en matchende ansøgning og kører dem gennem en rekrutterings-**checkliste-gate** (fejl blokerer, advarsler rådgiver). Destilleret fra karrierecoaching-praksis til generiske regler — bygger kun på dit eget CV, din profil og din two-pager; det opdigter aldrig. Eksportér resultatet til Markdown / PDF / DOCX.
>
> _tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
