...
> **🆕 Seneste udgivelse — v1.111.0**
>
> **Sikkerhed — lukning af CodeQL-backlog.** Tre defense-in-depth-hærdninger lukker de resterende fund fra statisk analyse ved kilden: CV-markdown-saniteringen escaper nu enhver afkortet farlig tag-åbning, så dens output aldrig kan indeholde et levende `<script`/`<iframe`; CV-import læser bufferens størrelse via en eksplicit numerisk tvang; og modus-rollelinjer er skabelonstrenge interpoleret med `String.replace` frem for gemte funktioner, hvilket fjerner det sidste dynamiske dispatch-kald. Ingen synlig ændring.
>
> _lukning af sikkerheds-backlog · docs & QA ×16 · Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
