...
> **🆕 Seneste udgivelse — v1.214.2** — **HTML-strip-rettelse** — en beskrivelse med `>` inde i en HTML-attribut (f.eks. `title="salary > 100k"`) lækker ikke længere den efterfølgende attributtekst ind i den Greenhouse / Recruitee-beskrivelse, et indholdsfilter læser. **2742 tests.**
>
