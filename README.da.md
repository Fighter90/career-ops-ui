...
> **🆕 Seneste udgivelse — v1.116.0**
>
> **Forbrugsmåler omarbejdet + første ende-til-ende widget-test.** AI-forbrugsmåleren er nu fastgjort nederst i venstre sidebjælke (dækker aldrig menuen — reserverer plads, så nav ruller frit), opdateres live og viser rigtige tokens · estimeret omkostning pr. vindue. En holdbar typeof-barriere lukker en tilbagevendende CodeQL-falsk positiv, og en ny Playwright ende-til-ende-test kører begge vedvarende widgets i en rigtig browser.
>
> _forbrugsmåler-omarbejdning · designfinpudsning · forbrugsmåler · flydende hjælpeassistent · docs- og QA-konsolidering · lukning af sikkerheds-backlog · docs & QA ×16 · Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
