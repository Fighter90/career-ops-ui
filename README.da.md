...
> **🆕 Seneste udgivelse — v1.144.0** — **indstillinger og filtre (Fase 4): aktivér/deaktivér fulgte portaler** — slå en overvåget virksomhed til/fra fra `#/portals` (`POST /api/portals/toggle`, kirurgisk portals.yml-skrivning); scanneren springer allerede `enabled: false`-virksomheder over. **2368 tests.**
>
