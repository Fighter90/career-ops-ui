...
> **🆕 Seneste udgivelse — v1.89.0**
>
> **Kandidat-markedsfit — the two-pager (Epic 14):** en ny **`#/two-pager`**-side indfanger, hvad _du_ faktisk vil have af din næste rolle (det du elsker, must-haves, det du hader, deal-breakers, ikke-forhandlingsbare punkter) i "Mnookin two-pager"-formatet. En **AI-udfyldningsassistent** udkaster den ud fra dit CV + profil, hver opslag på `#/scan` får en **`◎`-score for fit-til-det-du-vil-have**, og two-pageren fodrer hver evaluering. Bygger videre på v1.88.0 (Scan-i18n + API-hygiejne), v1.87.0 (4 nye scan-udbydere) og v1.86.0 (målrolle-statistik).
>
> _16 lokaliteter · 6 LLM-providere · 45 scanneradaptere · markedsfit via two-pager · markedsstatistik efter målroller · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
