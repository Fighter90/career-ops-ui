...
> **🆕 Seneste udgivelse — v1.222.0** — **Lokaliserede udbydertekster** — API-nøgle-, model- og base-URL-teksterne for de udvidede udbydere (DeepSeek … Volcengine Ark) under Indstillinger → API-nøgler er nu oversat på alle 17 sprog, ikke kun engelsk. **2779 tests.**
>
