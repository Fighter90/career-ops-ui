...
> **🆕 Seneste udgivelse — v1.227.2** — **Rettelse til smalle skærme** — `#/config` scroller ikke længere sidelæns ved ≤ 352 px: 18 selects bar et inline `min-width: 300px`, der ikke kunne krympe. Nu afskærmet af en Playwright-gennemgang ved 320 px. **2846 tests · 101 Playwright.**
