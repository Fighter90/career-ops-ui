...
> **🆕 Seneste udgivelse — v1.189.0** — **`skip_tiers` taler nu alle sprog** — tier-klassifikatoren læser romertal (I/II/III/IV/V) efter jobordet i enhver skrift ("Инженер III", "エンジニア I", "Ingénieur IV"), ikke kun efter ASCII-ord; før faldt de til "mid" og slap forbi `skip_tiers`. **2498 tests.**
>
