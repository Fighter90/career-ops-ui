...
> **🆕 Seneste udgivelse — v1.173.0** — **Hermes føjes til AI-CLI-detektoren** — fanen `#/config` "AI CLI-værktøjer" registrerer nu Hermes (Nous Research), forældreprojektets nye agent-runtime; skrivebeskyttet PATH-scanning, 11 værktøjer. **2444 tests.**
>
