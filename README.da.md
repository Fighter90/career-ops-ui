...
> **🆕 Seneste udgivelse — v1.214.0** — **Beskrivelser føder indholdsfilteret + klogere senioritet** — Greenhouse- / Ashby- / Recruitee-opslag kan nu indholdsfiltreres, og "Associate <senior titel>" (inkl. akademiske rangeringer) klassificeres som senior i stedet for entry-level. **2736 tests.**
>
