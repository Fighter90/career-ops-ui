...
> **🆕 Seneste udgivelse — v1.221.0** — **DNS-rebinding-hærdning** — scanneren afviser nu enhver kilde, hvis host slår op til en privat/loopback/cloud-metadata-adresse (fx `169.254.169.254`) — forsvar i dybden oven på de eksisterende SSRF-beskyttelser. **2775 tests.**
>
