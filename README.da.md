...
> **🆕 Seneste udgivelse — v1.142.0** — **rettelse: ikke flere "Unknown" arketyper** — `#/orientation` rangerer nu altid blandt de otte navngivne karrierevektorer i stedet for nogle gange at svare "Unknown" og anbefale at "satse mere" (AI-prompt-begrænsning). **2364 tests.**
>
