...
> **🆕 Seneste udgivelse — v1.94.0**
>
> **Statistik, omarbejdet (Epic 25):** siden **`#/stats`** er nu en **Statistik**-sektion med tre faner, med rigtige grafer og langt flere data. En ny fane **Markedsrapport** genererer en AI-drevet løn- og arbejdsmarkedsanalyse af dine målroller — efter niveau med P10–P90-percentiler, de største arbejdsgivere, efterspurgte kompetencer, personalegoder, fjernarbejdsfordeling, tendenser og forhandlingsvejledning, i den region og **valuta**, du vælger (tal mærket som retningsgivende modelestimater, aldrig skrabet). En ny fane **Min pipeline** grafer din egen tracker (scorer, tragt, de største virksomheder/roller, tidslinje, konverteringsrater). Hver rapport eksporteres til **Markdown eller PDF**. Bygger videre på v1.93.0 (hukommelseslag) og v1.92.0 (CV Studio).
>
> _Statistik, omarbejdet · 16 lokaliteter · 6 LLM-providere · 45 scanneradaptere · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · genoplagsdetektor · paritet med forælderens career-ops v1.16.0._
