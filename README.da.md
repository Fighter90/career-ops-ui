...
> **🆕 Seneste udgivelse — v1.102.0**
>
> **Spørg guiden — en forankret hjælpechat.** En ny **Spørg guiden 💬**-side besvarer how-to-spørgsmål ved **kun** at bruge appens hjælpeguide på dit sprog (den viser de brugte afsnit og læser aldrig dit CV eller din jobsøgning). Afhængighedsfri nøgleordssøgning over guidens `##`-afsnit; modellen svarer ud fra dem eller indrømmer, at guiden ikke dækker det. Live med en LLM-nøgle, eller en kopiér-prompt uden.
>
> _spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
