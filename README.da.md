...
> **🆕 Seneste udgivelse — v1.215.0** — **Kør den fra OpenWorker** — en ny kodefri AI-coworker kører hele din jobsøgning (og starter dette dashboard) fra Andrew Ngs OpenWorker-app; hjælpen i appen og Spørg dokumentationen-assistenten dækker den nu på alle 17 sprog. **2742 tests.**
>
