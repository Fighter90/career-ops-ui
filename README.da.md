...
> **🆕 Seneste udgivelse — v1.227.4** — **Præfiks-rettelse, del 2** — `word:` / `stem:` blev stadig ignoreret af `content_filter`; v1.227.3 koblede kun titelfilteret på. Fundet i AI-gennemgang. **2858 tests.**
