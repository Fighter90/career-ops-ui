...
> **🆕 Seneste udgivelse — v1.118.3**
>
> **Forældre-paritet v1.18.0.** Ni nye scanningsudbydere (Cornerstone, Phenom, Radancy, Deutsche Bahn, EchoJobs, TKMS, Heckler & Koch, Rheinmetall, LaraJobs — nu 54 adaptere) plus Lever EU-boards, den kanoniske `Hired`-status med «jobbet er i hus»-banner i trackeren, og en Samlet-fane i Statistik, der relæer forælderens stats.mjs og salary-gap.mjs (akkumuleret tragt, scannertal, lønobservationer).
>
> _forældre-paritet v1.18 · 54 adaptere · Hired-status · samlet statistik · paritetspakke · 50 adaptere · forbrugsmåler-omarbejdning · designfinpudsning · forbrugsmåler · flydende hjælpeassistent · docs- og QA-konsolidering · lukning af sikkerheds-backlog · docs & QA ×16 · Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
...
| Suite                       | Tests | What                                                                                                       |
| --------------------------- | ----- | ---------------------------------------------------------------------------------------------------------- |
| `node --test tests/*.test.mjs` (unit + integration) | **1823** | Every endpoint, ephemeral server, no network. 215 files: parsers, scanners (mocked), runners, anthropic/openai, security headers, XSS, JD sanitize, URL validation, i18n parity, + the v1.55→v1.56 UX-fix suites. |
