...
> **🆕 Seneste udgivelse — v1.160.0** — **Ærlig udbydertekst (rettelse)** — `#/config` og dashboardet påstod, at der kun scores med Anthropic/Gemini (og at OpenAI "ikke bruges") — falsk siden 7-udbyder-kaskaden. Nu nævnes alle syv, Evaluer-kortet er neutralt, og `Keys: N/5` → `N/7`. **2413 tests.**
>
