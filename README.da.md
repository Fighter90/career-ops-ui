...
> **🆕 Seneste udgivelse — v1.109.0**
>
> **Scan Udeluk-filter + pipeline-overblik.** Søg-feltet behandler kommaer som ELLER ("roller at finde"), og et nyt Udeluk-felt skjuler rækker, der matcher et kommasepareret ord; begge bevares i gemte søgninger. Pipeline-siden får en kompakt overbliksstribe — N i indbakke, N sporet og Applied / Responded / Interview / Offer-antal fra trackeren, hver linker til `#/tracker`.
>
> _Scan Udeluk · pipeline-overblik · sikkerhedshærdning 2 · sanitizer-hærdning · sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
