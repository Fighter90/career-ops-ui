...
> **🆕 Seneste udgivelse — v1.227.3** — **Titelfilterets præfikser virker nu** — `word:` / `stem:` blev matchet som bogstavelig tekst, så linjerne intet gjorde (en `word:intern`-regel filtrerede intet her, men virkede i CLI'en). Porteret fra moderprojektet, Unicode-grænser inklusive. **2852 tests.**
