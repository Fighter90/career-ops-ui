...
> **🆕 Seneste udgivelse — v1.194.0** — **Workday enkelt-segment-URL'er rettet** — sider som `https://parsons.wd5.myworkdayjobs.com/Search` (ét segment) peger nu på det rigtige jobfeed i stedet for at falde tilbage til `External`. Rapporteret i #255. **2517 tests.**
>
