...
> **🆕 Seneste udgivelse — v1.224.0** — **Rigtige udbyderlogoer** — LLM-udbyderfliserne viser nu det rigtige mærkelogo (Anthropic, OpenAI, Gemini, DeepSeek, Mistral, Ollama, …), hvor udbyderen udgiver et open source-ikon — stadig fuldt CSP-sikkert (indlejret SVG, ingen fjernressourcer). **2784 tests.**
>
