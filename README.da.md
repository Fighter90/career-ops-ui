...
> **🆕 Seneste udgivelse — v1.167.0** — **Hævede flader adskilt fra hårlinjer (design-rettelse)** — `--panel-2`/`--surface-elev1` blev til samme `--slate` som kanterne, uden adskillelse. Et dedikeret tema-token `--elev` understøtter dem nu. **2428 tests.**
>
