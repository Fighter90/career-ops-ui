...
> **🆕 Seneste udgivelse — v1.106.0**
>
> **Sikkerhedshærdning (CodeQL-triage).** Rute-renderingens fejlsti escaper nu fejlmeddelelsen, før den når DOM'en (en serverfejl kan gengive brugerinput — XSS-grænse), og profil/config-egenskabsskrivninger afviser `__proto__` / `constructor` / `prototype`-nøgler (prototype-forureningsværn). Størstedelen af de resterende advarsler er falske positiver på scannerens legitime `data/*`-I/O og blev afvist med begrundelse.
>
> _sikkerhedshærdning · AI-forbrug & -omkostning · firmalogoer · AI CLI-værktøjer · spørg guiden · tilpas CV + ansøgning · two-pager-autoudfyldning · DOCX-eksport · portalsundhed · indbygget fejlrapportør · 16 lokaliteter · 6 LLM-providere · 46 scanneradaptere · karriereorientering · karriereplan · statistik omarbejdet · hukommelseslag · CV Studio · networking-planlægger · jobsamtale-øvelse · markedsfit via two-pager · paritet med forælderens career-ops v1.16.0._
