...
[![tests](https://img.shields.io/badge/tests-2563%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.201.0** — **Cabeçalhos de rastreador localizados não ficam mais em branco** — um `data/applications.md` com cabeçalhos não ingleses ou variantes (`empresa`/`estado`, `position`/`stage`/`link`…) agora é mapeado para os campos canônicos. **2563 testes.**
>
