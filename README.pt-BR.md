...
[![tests](https://img.shields.io/badge/tests-2846%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.227.1** — **Correções na ajuda** — a divisão de fontes do §17 agora fecha (80 EN + 5 RU, antes 78+5=83), a âncora de versão obsoleta sai e o banner do GitHub não é mais impresso como marcação no `#/help` — os três agora com teste. **2846 testes.**
