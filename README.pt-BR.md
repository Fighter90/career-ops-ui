...
> **🆕 Última versão — v1.85.0**
>
> **Locales alemão, italiano e turco** (paridade de locales com o career-ops v1.16.0): a interface agora vem em **16 idiomas** — Deutsch 🇩🇪, Italiano 🇮🇹 e Türkçe 🇹🇷 juntam-se aos 13 existentes, com tradução completa da Ajuda integrada, do README e do CHANGELOG, além de scaffolding localizado de prompts LLM. Baseia-se na v1.84.0 (cooldown de recandidatura + compensação), v1.83.0 (detector de repostagens) e v1.82.0 (NoDesk).
>
> _16 locales · 6 provedores LLM · 41 adaptadores de scanner · detector de repostagens · cooldown de recandidatura · paridade com career-ops v1.16.0._
