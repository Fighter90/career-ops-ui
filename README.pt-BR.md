...
[![tests](https://img.shields.io/badge/tests-2453%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.176.0** — **Parsing de pontuação (FIND-5)** — uma pontuação sob um rótulo em negrito que a tabela RU não lista (`**Итоговый балл:**`, `**Скор:**`) agora é detectada pela forma de valor `X.X / 5` — independente de idioma, a salvo de cabeçalhos e datas. **2453 testes.**
>
