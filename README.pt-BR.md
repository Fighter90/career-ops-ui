...
[![tests](https://img.shields.io/badge/tests-2594%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.203.0** — **Dica "reutilizar um CV anterior?" no CV Studio** — uma vaga salva é comparada com suas outras vagas (determinístico, zero tokens) para dizer se vale reutilizar um CV adaptado, reutilizá-lo com ajustes ou adaptar um novo. **2594 testes.**
>
