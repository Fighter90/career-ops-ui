...
[![tests](https://img.shields.io/badge/tests-2837%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.227.0** — **Hong Kong e follow-ups mais precisos** — JobsDB Hong Kong entra no Jobstreet/SEEK (agora na API v5), um filtro de somente pendentes no painel de cadência e empregadores confidenciais exibem a agência que os intermediou — paridade com a 1.30.0 do projeto pai. **2837 testes.**
