...
> **🆕 Última versão — v1.207.1** — **A página inicial cabe em qualquer tela** — o título, a introdução e o terminal de instalação não são mais cortados pela borda direita em celulares pequenos; o comando de instalação rola dentro do terminal. **2618 testes.**
>
