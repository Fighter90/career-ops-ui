...
> **🆕 Última versão — v1.91.0**
>
> **Networking e pesquisa profunda de empresas (Epic 16):** uma nova página **`#/networking`** transforma uma empresa em um plano acionável — um **dossiê da empresa**, **quem contatar** (personas + strings de busca do LinkedIn), a **via de apresentação mais calorosa** e **rascunhos de contato** sob medida — tudo ancorado no seu CV e no seu two-pager. Funciona ao vivo com qualquer chave LLM ou devolve um prompt para copiar e colar, e você pode **salvar planos** por empresa. Baseia-se na v1.90.0 (mock interview), v1.89.0 (encaixe candidato-mercado com o two-pager) e v1.88.0 (i18n de Scan + higiene da API).
>
> _16 locales · 6 provedores LLM · 45 adaptadores de scanner · planejador de networking · mock interview · encaixe de mercado com o two-pager · estatísticas de mercado por cargo-alvo · detector de repostagens · paridade com career-ops v1.16.0._
