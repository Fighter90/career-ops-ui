...
[![tests](https://img.shields.io/badge/tests-2458%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.179.0** — **Consolidação de decodificadores** — 20 decodificadores de entidades HTML duplicados nas fontes de varredura agora passam por um único módulo compartilhado (−237 linhas), com uma guarda contra reduplicação. Preserva o comportamento. **2458 testes.**
>
