...
> **🆕 Última versão — v1.111.0**
>
> **Segurança — fechamento do backlog do CodeQL.** Três reforços de defesa em profundidade fecham os achados de análise estática restantes na origem: o sanitizador de markdown do CV agora escapa qualquer abertura de tag perigosa truncada, de modo que sua saída nunca contém um `<script`/`<iframe` vivo; a importação de CV lê o tamanho do buffer por coerção numérica explícita; e as linhas de papel dos modos são strings de template interpoladas com `String.replace` em vez de funções armazenadas, removendo a última chamada de despacho dinâmico. Sem mudança visível.
>
> _fechamento backlog segurança · docs e QA ×16 · Excluir no Scan · visão geral pipeline · reforço de segurança 2 · reforço do sanitizador · reforço de segurança · uso e custo de IA · logos de empresa · ferramentas CLI de IA · perguntar ao guia · adaptar CV + carta · autopreenchimento do two-pager · exportação DOCX · saúde dos portais · relator de bugs integrado · 16 locales · 6 provedores LLM · 46 adaptadores de scanner · orientação de carreira · plano de carreira · reformulação de estatísticas · camada de memória · CV Studio · planejador de networking · mock interview · encaixe de mercado com o two-pager · paridade com career-ops v1.16.0._
