...
[![tests](https://img.shields.io/badge/tests-2687%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.212.1** — **Correção da contagem de fontes da landing** — o cvstart.org listava 80 fontes e descartava o Job Bank (Canadá) após v1.212.0; voltou a 81 em sincronia com o app, e o build do site agora falha em qualquer divergência de contagem. **2687 testes.**
>
