...
[![tests](https://img.shields.io/badge/tests-2644%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.210.1** — **Títulos do Habr corrigidos** — títulos de vagas e nomes de empresa com "&" ou aspas agora são decodificados, então não somem mais do seu filtro nem chegam corrompidos ao tracker. **2644 testes.**
>
