...
> **🆕 Última versão — v1.86.0**
>
> **Estatísticas por cargos-alvo** (`#/stats`): uma nova página de Analytics lê seus **cargos-alvo do perfil** (não fixados no código) e seu escaneamento mais recente para gerar gráficos de **vagas e salário mediano por país**, com filtros de cargo/país e uma **tendência de instantâneos salvos** — agregada no lado do cliente a partir dos dados esparsos que os scanners já coletam (sem números fabricados), nos 16 idiomas. Baseia-se na v1.85.0 (locales alemão/italiano/turco), v1.84.0 (cooldown de recandidatura) e v1.83.0 (detector de repostagens).
>
> _16 locales · 6 provedores LLM · 41 adaptadores de scanner · estatísticas de mercado por cargo-alvo · detector de repostagens · paridade com career-ops v1.16.0._
