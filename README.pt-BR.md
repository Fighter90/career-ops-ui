...
[![tests](https://img.shields.io/badge/tests-2508%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.192.0** — **Verifique os fatos do seu CV** — um novo controle em `#/cv-studio` verifica um CV ou carta adaptados contra seu CV/perfil/two-pager reais e sinaliza cada métrica inventada ou afirmação sem respaldo (pass/warn/block). **2508 testes.**
>
