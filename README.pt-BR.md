...
[![tests](https://img.shields.io/badge/tests-2522%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.196.0** — **Reforço do endpoint do Workday** — um `api:` do Workday em `portals.yml` agora é validado pelo **hostname**, não por substring, então uma URL forjada como `https://evil.com/?x=myworkdayjobs.com` não passa mais como alvo de fetch. Reportado pelo CodeQL (#443). **2522 testes.**
>
