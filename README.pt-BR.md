...
[![tests](https://img.shields.io/badge/tests-2521%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.195.0** — **Detecção de reposts mais rápida** — a detecção de duplicados não é mais O(N²) em históricos grandes; o agrupamento de títulos por empresa agora é um índice invertido. A saída é idêntica (comprovada por teste diferencial), só bem mais rápido. **2521 testes.**
>
