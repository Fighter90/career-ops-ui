...
> **🆕 Última versão — v1.94.0**
>
> **Estatísticas, reformuladas (Epic 25):** a página **`#/stats`** agora é uma seção de **Estatísticas** com três abas, com gráficos reais e muito mais dados. Uma nova aba de **Relatório de mercado** gera uma análise com IA de salários e do mercado de trabalho dos seus cargos-alvo — por nível com percentis P10–P90, principais empregadores, competências em demanda, benefícios, divisão de remoto, tendências e orientação de negociação, na região e na **moeda** que você escolher (números rotulados como estimativas direcionais do modelo, nunca extraídos). Uma nova aba de **Meu pipeline** plota o seu próprio tracker (pontuações, funil, principais empresas/cargos, linha do tempo, taxas de conversão). Cada relatório é exportado para **Markdown ou PDF**. Baseia-se na v1.93.0 (camada de memória) e v1.92.0 (CV Studio).
>
> _reformulação de estatísticas · 16 locales · 6 provedores LLM · 45 adaptadores de scanner · camada de memória · CV Studio · planejador de networking · mock interview · encaixe de mercado com o two-pager · detector de repostagens · paridade com career-ops v1.16.0._
