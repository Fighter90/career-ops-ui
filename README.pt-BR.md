...
[![tests](https://img.shields.io/badge/tests-2818%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.226.0** — **Duas fontes de vagas vietnamitas** — ITviec + CareerViet entram no scanner (85 fontes · 80 adaptadores) — paridade com o projeto pai 1.30.0. **2818 testes.**
