...
[![tests](https://img.shields.io/badge/tests-2504%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.191.0** — **O que aprender a seguir** — uma nova aba em `#/stats` ordena as habilidades que mais afundam suas baixas aderências (ponderadas, em níveis Critical/High/Medium) — para saber o que estudar primeiro. **2504 testes.**
>
