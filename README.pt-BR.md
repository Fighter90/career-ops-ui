...
[![tests](https://img.shields.io/badge/tests-2784%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.224.0** — **Logotipos reais dos provedores** — os blocos de provedor LLM agora mostram o logotipo real da marca (Anthropic, OpenAI, Gemini, DeepSeek, Mistral, Ollama, …) onde o provedor publica um ícone de código aberto — continua seguro para a CSP (SVG inline, sem recursos remotos). **2784 testes.**
>
