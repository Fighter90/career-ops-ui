...
[![tests](https://img.shields.io/badge/tests-2501%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.190.0** — **Quais empresas realmente respondem?** — novo painel **Histórico da empresa** em `#/tracker`: escolha uma empresa e veja se ficou em silêncio com você, misto ou respondeu antes — e se a mesma vaga é republicada — juntando tracker, follow-ups e histórico de scan. **2501 testes.**
>
