...
> **🆕 Última versão — v1.89.0**
>
> **Encaixe candidato-mercado — o two-pager (Epic 14):** uma nova página **`#/two-pager`** captura o que _você_ realmente quer da sua próxima vaga (o que ama, os imprescindíveis, o que odeia, os deal-breakers, os inegociáveis) no formato "two-pager de Mnookin". Um **assistente de preenchimento com IA** o redige a partir do seu CV + perfil, cada vaga em `#/scan` recebe uma pontuação **`◎` de encaixe-com-o-que-você-quer**, e o two-pager alimenta cada avaliação. Baseia-se na v1.88.0 (i18n de Scan + higiene da API), v1.87.0 (4 novos provedores de scan) e v1.86.0 (estatísticas por cargo-alvo).
>
> _16 locales · 6 provedores LLM · 45 adaptadores de scanner · encaixe de mercado com o two-pager · estatísticas de mercado por cargo-alvo · detector de repostagens · paridade com career-ops v1.16.0._
