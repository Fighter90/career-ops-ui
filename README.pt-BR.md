...
> **🆕 Última versão — v1.92.0**
>
> **CV Studio (Epic 21):** uma nova página **`#/cv-studio`** dá ao seu CV três ferramentas honestas — **diagnóstico de currículo** (uma pontuação determinística de 0–100 com explicações por verificação), uma **máscara de privacidade** (oculta e-mail/telefone/links/endereço/nome inteiramente no navegador) e **torne-o humano** (reescreve linhas rígidas na _sua_ voz, ancorado no seu voice-dna e nas suas amostras de escrita, sem inventar fatos). Baseia-se na v1.91.0 (planejador de networking), v1.90.0 (mock interview) e v1.89.0 (encaixe de mercado com o two-pager).
>
> _16 locales · 6 provedores LLM · 45 adaptadores de scanner · CV Studio · planejador de networking · mock interview · encaixe de mercado com o two-pager · estatísticas de mercado por cargo-alvo · detector de repostagens · paridade com career-ops v1.16.0._
