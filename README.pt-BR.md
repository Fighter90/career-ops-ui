...
[![tests](https://img.shields.io/badge/tests-2527%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.197.0** — **Acompanhe um quadro Getro só pela URL** — informe a um quadro Getro acompanhado a sua própria `careers_url` e o id numérico da coleção agora **se resolve sozinho** a partir da página (uma busca segura contra SSRF), sem procura manual. **2527 testes.**
>
