...
[![tests](https://img.shields.io/badge/tests-1874%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.123.0**
>
> **Paridade com o pai v1.21.0.** A v1.123.0 porta o source de scan **Oracle Recruiting Cloud** (API REST zero-auth do ORC usada por JPMorgan Chase, Oracle, BNY Mellon, American Express, … — **62 adaptadores** agora) e a correção do detector de repostagens que mantém os títulos base distintos de vagas irmãs com sufixo de especialização.
>
...
│  └─ reviews/REVIEW-*.md
└─ tests/                    # 1874 unit/integration + 90 Playwright e2e
