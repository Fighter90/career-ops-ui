...
[![tests](https://img.shields.io/badge/tests-2779%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.222.0** — **Dicas de provedor localizadas** — as dicas de chave, modelo e URL base dos provedores estendidos (DeepSeek … Volcengine Ark) em Configurações → Chaves API agora são traduzidas nos 17 idiomas, não só em inglês. **2779 testes.**
>
