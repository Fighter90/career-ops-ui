...
> **🆕 Última versão — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** uma nova página **`#/mock-interview`** executa um ensaio de entrevista turno a turno diante de uma vaga real. Cada resposta recebe **feedback STAR+R**, uma **pontuação** e uma **pergunta de acompanhamento** — fundamentados no seu CV, no two-pager e no seu banco de histórias. Funciona ao vivo com qualquer chave LLM ou devolve um prompt para copiar e colar, e você pode **salvar transcrições** por empresa/cargo. Baseia-se na v1.89.0 (encaixe candidato-mercado com o two-pager), v1.88.0 (i18n de Scan + higiene da API) e v1.87.0 (4 novos provedores de scan).
>
> _16 locales · 6 provedores LLM · 45 adaptadores de scanner · mock interview · encaixe de mercado com o two-pager · estatísticas de mercado por cargo-alvo · detector de repostagens · paridade com career-ops v1.16.0._
