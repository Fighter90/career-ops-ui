...
[![tests](https://img.shields.io/badge/tests-2485%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.186.0** — **Painel "Lacuna de habilidades" no CV Studio** — escolha uma descrição de vaga salva e veja quais das habilidades exigidas seu CV cita, apenas insinua ou está faltando — sem IA, nada gravado. **2485 testes.**
>
