...
> **🆕 Última versão — v1.95.0**
>
> **Plano de carreira (Epic 26):** uma nova página **`#/career-plan`** transforma o seu CV e o seu perfil em um plano de desenvolvimento concreto e personalizado. Escolha um **horizonte** (6/12/24 meses) e um foco opcional, e o modelo redige um retrato do ponto de partida, uma SWOT de forças/crescimento, metas como **SMART / OKR / WOOP**, trajetórias alternativas, um plano de competências técnicas e comportamentais, um **roteiro mês a mês**, acompanhamento do progresso, armadilhas e alavancas de apoio — ancorado nos seus próprios materiais, sem nunca inventar o seu histórico. Edite-o em linha, **Salve-o** na camada de usuário e exporte-o para **Markdown ou PDF**. Baseia-se na v1.94.0 (reformulação de estatísticas) e v1.93.0 (camada de memória).
>
> _16 locales · 6 provedores LLM · 45 adaptadores de scanner · plano de carreira · reformulação de estatísticas · camada de memória · CV Studio · planejador de networking · mock interview · encaixe de mercado com o two-pager · paridade com career-ops v1.16.0._
