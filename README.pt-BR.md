...
[![tests](https://img.shields.io/badge/tests-2775%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.221.0** — **Reforço anti-DNS-rebinding** — o scanner agora recusa qualquer fonte cujo host resolva para um endereço privado/loopback/de metadados de nuvem (ex.: `169.254.169.254`) — defesa em profundidade sobre as proteções SSRF existentes. **2775 testes.**
>
