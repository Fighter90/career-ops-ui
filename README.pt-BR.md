...
[![tests](https://img.shields.io/badge/tests-2755%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.217.0** — **Ark entra na lista** — BytePlus Ark + Volcengine Ark (Doubao da ByteDance) agora são provedores de avaliação ⚡ ao vivo (**18 no total**), cada um com seu emblema de marca em Configurações. **2755 testes.**
>
