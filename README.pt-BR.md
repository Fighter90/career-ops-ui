...
[![tests](https://img.shields.io/badge/tests-2557%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.200.0** — **Verificação "ainda ativa?" para vagas em ATS** — em #/tracker, um clique consulta o JSON público de uma vaga Greenhouse/Lever/Ashby/Workday/SmartRecruiters (zero tokens, sem navegador) e mostra **Ativa / Expirada / Desconhecida**. **2557 testes.**
>
