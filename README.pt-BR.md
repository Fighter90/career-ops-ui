...
> **🆕 Última versão — v1.225.1** — **Correção do banner de provedores** — o banner de logotipos agora aparece corretamente no README e na ajuda (PNG renderizado via URL absoluta; o SVG com XML inválido foi corrigido). **2784 testes.**
