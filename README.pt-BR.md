...
[![tests](https://img.shields.io/badge/tests-2465%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.180.0** — **Relatórios em tabela** — `#/reports` agora é uma tabela (Relatório · Data · Legitimidade · Pontuação); um chip longo de "Pontuação não detectada" não quebra mais o nome caractere por caractere, e recupera-se uma pontuação real que um marcador do Machine Summary escondia. **2465 testes.**
>
