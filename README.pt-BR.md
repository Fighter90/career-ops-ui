...
> **🆕 Última versão — v1.207.2** — **Planos de IA voltam a renderizar direito** — o plano de desenvolvimento e o perfil de orientação não aparecem mais como um despejo de código monoespaçado quando o modelo envolve toda a resposta em uma cerca ```markdown. **2621 testes.**
>
