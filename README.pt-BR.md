...
[![tests](https://img.shields.io/badge/tests-2602%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.204.0** — **"Doutor de configuração" em Ajustes** — checagem sem tokens do seu `cv.md` + `config/profile.yml` que lista problemas bloqueantes e avisos (dados de exemplo, métricas fixas), para corrigir uma configuração incompleta antes que enfraqueça varreduras e adaptações. **2602 testes.**
>
