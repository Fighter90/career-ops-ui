...
[![tests](https://img.shields.io/badge/tests-2588%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.202.0** — **Descubra quadros ATS em #/portals** — digite uma empresa e o app sonda Greenhouse/Ashby/Lever pelo quadro público (zero LLM, sem navegador, seguro contra SSRF); um clique adiciona às empresas rastreadas. **2588 testes.**
>
