...
[![tests](https://img.shields.io/badge/tests-2451%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.175.0** — **Guarda de regressão da descrição SEO** — um teste de CI agora falha se algum dos 17 idiomas do site perder o placeholder `{adapters}` ou refixar uma contagem (o desvio do bug "~55"), além de um strip de legitimidade seguro a nulos. **2451 testes.**
>
