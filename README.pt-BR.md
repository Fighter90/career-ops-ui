...
> **🆕 Última versão — v1.227.2** — **Correção em telas estreitas** — `#/config` não rola mais lateralmente a ≤ 352 px: 18 selects tinham `min-width: 300px` inline que não encolhia. Agora com gate de varredura Playwright a 320 px. **2846 testes · 101 Playwright.**
