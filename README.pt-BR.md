...
> **🆕 Última versão — v1.205.0** — **Registro de habilidades** — anote uma autoavaliação (empresa, plataforma, habilidade, pontuação %, nota) em Análises → Registro de habilidades; é anexado a `data/assessments.tsv` e lista entradas anteriores. Sem tokens; escrita protegida contra caracteres de controle. **2610 testes.**
>
