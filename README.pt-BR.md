...
[![tests](https://img.shields.io/badge/tests-2783%20passed-brightgreen)](#testes)
...
> **🆕 Última versão — v1.223.0** — **Correção do badge de eval + instalação do coworker** — uma ⚡ eval ao vivo bem-sucedida não é mais pintada de vermelho, e o coworker do OpenWorker instala direto da URL do GitHub / .zip / um comando. **2783 testes.**
>
