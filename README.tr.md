...
> **🆕 En son sürüm — v1.95.0**
>
> **Kariyer planı (Epic 26):** yeni bir **`#/career-plan`** sayfası, CV'ni ve profilini somut, kişiselleştirilmiş bir gelişim planına dönüştürür. Bir **ufuk** (6/12/24 ay) ve isteğe bağlı bir odak seç; model bir başlangıç noktası anlık görüntüsü, güçlü yönler/büyüme SWOT'u, **SMART / OKR / WOOP** olarak hedefler, alternatif yörüngeler, bir hard/soft beceri planı, bir **ay ay yol haritası**, ilerleme izleme, tuzaklar ve destek adımları yazar — kendi materyallerine dayalı, geçmişini asla uydurmadan. Onu inline düzenle, kullanıcı katmanına **Kaydet** ve **Markdown veya PDF** olarak dışa aktar. v1.94.0 (istatistiklerin yeniden tasarımı) ve v1.93.0 (bellek katmanı) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
