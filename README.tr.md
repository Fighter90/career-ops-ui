...
> **🆕 Son sürüm — v1.220.0** — **Get on Board, birden çok kategori** — tek bir giriş artık `programming`, `operations-management`, `machine-learning-ai`, … tarayabilir (URL’ye göre yinelenenler ayıklanır, en fazla 12), böylece EM/veri aramaları panonun ayırdığı rolleri kaçırmaz. **2771 test.**
>
