...
> **🆕 En son sürüm — v1.92.0**
>
> **CV Studio (Epic 21):** yeni bir **`#/cv-studio`** sayfası, özgeçmişine üç dürüst araç sunar — **özgeçmiş tanılaması** (kontrol başına açıklamalarla 0–100 arası deterministik bir puan), bir **gizlilik maskesi** (e-posta/telefon/bağlantı/adres/ad bilgilerini tümüyle tarayıcıda karartır) ve **insanileştir** (sert satırları _senin_ sesinde yeniden yazar; voice-dna'na ve yazı örneklerine dayanır, asla olgu uydurmadan). v1.91.0 (networking planlayıcı), v1.90.0 (deneme mülakatı) ve v1.89.0 (two-pager ile pazar uyumu) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
