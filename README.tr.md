...
> **🆕 En son sürüm — v1.115.0**
>
> **Tasarım rötuşu (muhafazakâr, mercan marka).** Ortak tasarım sisteminde hafif bir ince ayar — yeniden yapılandırma veya palet değişikliği yok: metrik kartları üzerine gelince mercan kenarlıkla yükselir, düğmeler durağan gölge ve nazik yükseliş kazanır, büyük sayılar tabular-nums ile hizalanır ve denetimler yumuşak bir mercan odak halesi alır. Hareket prefers-reduced-motion'a saygı gösterir.
>
> _tasarım rötuşu · kullanım göstergesi · yüzen yardım asistanı · doküman & QA konsolidasyonu · güvenlik backlog kapanışı · docs & QA ×16 · Scan Hariç Tut · pipeline genel bakışı · güvenlik sıkılaştırması 2 · temizleyici sıkılaştırması · güvenlik sıkılaştırması · AI kullanımı & maliyeti · şirket logoları · yapay zeka CLI araçları · belgelere sor · CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
