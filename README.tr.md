...
> **🆕 Son sürüm — v1.183.0** — **Daha akıllı yinelenen tespiti** — tarayıcı artık her ilanı kanonik bir URL ile anahtarlıyor, böylece takip bağlantısı (`?utm_…`), `http`/`https`, ya da sondaki eğik çizgiyle yeniden yayımlanan aynı ilan iki kez görünmüyor. **2477 test.**
>
