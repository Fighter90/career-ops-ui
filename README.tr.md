...
> **🆕 Son sürüm — v1.187.0** — **`skip_tiers` yeniden çalışıyor** — `portals.yml`'deki `skip_tiers: [intern, entry]` listesi artık tarama sırasında ilanları kıdem düzeyine göre eliyor (önceden sessizce yok sayılıyordu). **2492 test.**
>
