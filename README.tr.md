...
> **🆕 Son sürüm — v1.221.0** — **DNS-rebinding sertleştirmesi** — tarayıcı artık ana bilgisayarı özel/loopback/bulut meta veri adresine (ör. `169.254.169.254`) çözülen her kaynağı reddediyor — mevcut SSRF korumaları üzerine derinlemesine savunma. **2775 test.**
>
