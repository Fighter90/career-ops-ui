...
> **🆕 Son sürüm — v1.227.1** — **Yardım düzeltmeleri** — §17'deki kaynak dökümü artık tutuyor (80 EN + 5 RU, önceden 78+5=83), eskimiş sürüm çıpası kalktı ve GitHub afişi `#/help` başında ham işaretleme olarak basılmıyor — üçü de artık test altında. **2845 test.**
