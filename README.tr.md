...
- **Çok CLI'li:** Claude Code, Codex, Cursor, Aider veya Gemini CLI'den aynı şekilde çalışır — `CLAUDE.md` / `AGENTS.md` / `GEMINI.md` ara katmanları tek bir doğruluk kaynağına işaret eder.
