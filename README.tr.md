...
> **🆕 En son sürüm — v1.94.0**
>
> **İstatistikler, yeniden tasarlandı (Epic 25):** **`#/stats`** sayfası artık gerçek grafikler ve çok daha fazla veri içeren üç sekmeli bir **İstatistikler** bölümü. Yeni bir **Pazar raporu** sekmesi, hedef rollerin için bir AI maaş ve iş gücü piyasası analizi üretir — P10–P90 yüzdelik dilimleriyle kademeye göre, önde gelen işverenler, talep gören beceriler, yan haklar, uzaktan çalışma dağılımı, eğilimler ve müzakere rehberliği; seçtiğin bölge ve **currency** ile (rakamlar, hiçbir zaman kazınmayan, modelin yönlü tahminleri olarak etiketlenir). Yeni bir **My pipeline** sekmesi kendi izleyicini grafikler (puanlar, huni, önde gelen şirketler/roller, zaman çizelgesi, dönüşüm oranları). Her rapor **Markdown veya PDF** olarak dışa aktarılır. v1.93.0 (bellek katmanı) ve v1.92.0 (CV Studio) üzerine inşa edilmiştir.
>
> _istatistiklerin yeniden tasarımı · 16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
