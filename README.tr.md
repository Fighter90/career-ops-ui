...
> **🆕 Son sürüm — v1.204.0** — **Ayarlar'da "Kurulum doktoru"** — `cv.md` + `config/profile.yml` için sıfır token denetimi; engelleyici sorunları ve uyarıları (örnek veri, sabit kodlanmış metrikler) listeler, böylece eksik kurulumu taramaları ve uyarlamaları zayıflatmadan düzeltirsiniz. **2602 test.**
>
