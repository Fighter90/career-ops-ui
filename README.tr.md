...
> **🆕 Son sürüm — v1.212.1** — **Açılış sayfası kaynak sayısı düzeltmesi** — cvstart.org v1.212.0 sonrası iş kaynaklarını 80 listeliyor ve Job Bank (Kanada)'yı düşürüyordu; uygulamayla senkron 81'e döndü ve site derlemesi artık her kaynak sayısı sapmasında sert başarısız oluyor. **2687 test.**
>
