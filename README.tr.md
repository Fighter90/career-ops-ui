...
> **🆕 Son sürüm — v1.198.0** — **Daha akıllı tarama yeniden denemeleri** — bir pano tarama sırasında kısa süre hız sınırladığında (HTTP 429/5xx), yeniden denemeler artık sabit kısa gecikme yerine **üstel geri çekilme + jitter** kullanıyor ve (sınırlandırılmış) bir `Retry-After`'a uyuyor. **2536 test.**
>
