...
> **🆕 Son sürüm — v1.197.0** — **Bir Getro panosunu yalnızca URL'siyle takip edin** — takip edilen bir Getro panosuna kendi `careers_url` değerini verin; sayısal koleksiyon id'si artık pano sayfasından **kendiliğinden çözülür** (SSRF'ye karşı güvenli tek bir istek), elle arama olmadan. **2527 test.**
>
