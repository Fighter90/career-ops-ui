...
> **🆕 En son sürüm — v1.116.0**
>
> **Kullanım göstergesi yeniden yapıldı + ilk uçtan uca widget testi.** AI kullanım göstergesi artık sol kenar çubuğunun altına sabitli (menüyü asla kapatmaz — gezinmenin serbestçe kayması için boşluk ayırır), canlı yenilenir ve pencere başına gerçek jeton · tahmini maliyet gösterir. Kalıcı bir typeof bariyeri tekrarlayan bir CodeQL yanlış pozitifini kapatır ve yeni bir Playwright uçtan uca testi her iki kalıcı widget'ı gerçek tarayıcıda çalıştırır.
>
> _kullanım göstergesi yeniden yapımı · tasarım rötuşu · kullanım göstergesi · yüzen yardım asistanı · doküman & QA konsolidasyonu · güvenlik backlog kapanışı · docs & QA ×16 · Scan Hariç Tut · pipeline genel bakışı · güvenlik sıkılaştırması 2 · temizleyici sıkılaştırması · güvenlik sıkılaştırması · AI kullanımı & maliyeti · şirket logoları · yapay zeka CLI araçları · belgelere sor · CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
