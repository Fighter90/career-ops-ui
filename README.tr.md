...
> **🆕 Son sürüm — v1.214.0** — **Açıklamalar içerik filtresini besliyor + daha akıllı kıdem** — Greenhouse / Ashby / Recruitee ilanları artık içeriğe göre filtrelenebilir ve "Associate <kıdemli unvan>" (akademik rütbeler dâhil) başlangıç yerine kıdemli olarak sınıflandırılır. **2736 test.**
>
