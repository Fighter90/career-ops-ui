...
> **🆕 En son sürüm — v1.86.0**
>
> **Hedef rollere göre istatistikler** (`#/stats`): yeni bir Analytics sayfası, **profildeki hedef rollerinizi** (koda gömülü değil) ve en son taramanızı okuyarak **ülkeye göre açık pozisyonları ve medyan maaşı** grafiklerle gösterir; rol/ülke filtreleri ve **kaydedilmiş anlık görüntülerden bir trend** sunar — tarayıcıların zaten topladığı seyrek verilerden istemci tarafında toplanır (uydurma sayı yok), 16 dilin tamamında. v1.85.0 (Almanca/İtalyanca/Türkçe yerel diller), v1.84.0 (yeniden başvuru bekleme süresi) ve v1.83.0 (yeniden yayın algılayıcı) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 41 tarayıcı adaptörü · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
