...
> **🆕 Son sürüm — v1.142.0** — **düzeltme: artık "Unknown" arketip yok** — `#/orientation` artık bazen "Unknown" yanıtlamak yerine her zaman sekiz adlandırılmış kariyer vektöründen sıralama yapıyor (AI istem kısıtı). **2364 test.**
>
