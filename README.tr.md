...
> **🆕 Son sürüm — v1.225.1** — **Sağlayıcı afişi düzeltmesi** — sağlayıcı logo afişi artık README ve yardımda doğru görünüyor (mutlak URL üzerinden işlenmiş PNG; geçersiz XML'li SVG düzeltildi). **2784 test.**
