...
> **🆕 Son sürüm — v1.227.3** — **Başlık filtresi önekleri artık çalışıyor** — `word:` / `stem:` birebir metin olarak eşleniyor, o satırları etkisiz bırakıyordu (`word:intern` kuralı CLI'da çalışıp burada hiçbir şeyi elemiyordu). Üst projeden aktarıldı, Unicode sınırlarıyla birlikte. **2852 test.**
