...
> **🆕 En son sürüm — v1.89.0**
>
> **Aday-pazar uyumu — the two-pager (Epic 14):** yeni bir **`#/two-pager`** sayfası, bir sonraki rolünüzden _sizin_ gerçekte ne istediğinizi (sevdikleriniz, olmazsa olmazlar, nefret ettikleriniz, deal-breaker'lar, pazarlık edilemezler) "Mnookin two-pager" formatında yakalar. Bir **yapay zeka doldurma asistanı** onu CV'niz + profilinizden taslaklar, `#/scan` üzerindeki her ilan bir **istediğinizle-uyum `◎` puanı** alır ve two-pager her değerlendirmeyi besler. v1.88.0 (Scan i18n + API hijyeni), v1.87.0 (4 yeni tarama sağlayıcısı) ve v1.86.0 (hedef rol istatistikleri) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · two-pager ile pazar uyumu · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
