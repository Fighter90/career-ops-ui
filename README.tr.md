...
> **🆕 Son sürüm — v1.195.0** — **Daha hızlı yeniden yayın tespiti** — yinelenen ilan tespiti büyük geçmişlerde artık O(N²) değil; şirket bazında başlık gruplaması artık bir ters dizin. Çıktı aynı (diferansiyel testle kanıtlandı), sadece çok daha hızlı. **2521 test.**
>
