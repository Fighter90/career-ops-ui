...
> **🆕 Son sürüm — v1.182.0** — **Yerelden bağımsız maaş aralıkları** — tarama ve takipçideki tek yönlü tutarlar artık İngilizce "from" / "up to" yerine `≥` / `≤` (ör. `≥ 120000 EUR`) olarak görünüyor, her dilde aynı okunuyor. **2471 test.**
>
