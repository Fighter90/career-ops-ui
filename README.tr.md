...
> **🆕 Son sürüm — v1.224.0** — **Gerçek sağlayıcı logoları** — LLM sağlayıcı kutucukları, sağlayıcının açık kaynak simge yayımladığı yerlerde artık gerçek marka logosunu (Anthropic, OpenAI, Gemini, DeepSeek, Mistral, Ollama, …) gösteriyor — hâlâ tamamen CSP-güvenli (satır içi SVG, uzak kaynak yok). **2784 test.**
>
