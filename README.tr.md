...
> **🆕 Son sürüm — v1.171.0** — **Yazı ölçeği + z-index belirteçleri (D-4, ilk adım)** — `--font-size-*` ve `--z-*` katmanları eklendi; her z-index düz değeri taşındı (değerler korundu), çekirdek boyutlar rampayı kullanıyor. Piksel değişikliği yok. **2437 test.**
>
