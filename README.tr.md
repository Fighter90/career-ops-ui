...
> **🆕 Son sürüm — v1.222.0** — **Yerelleştirilmiş sağlayıcı ipuçları** — Ayarlar → API anahtarları altındaki genişletilmiş sağlayıcıların (DeepSeek … Volcengine Ark) anahtar, model ve temel URL ipuçları artık yalnızca İngilizce değil 17 dile çevrildi. **2779 test.**
>
