...
> **🆕 Son sürüm — v1.192.0** — **CV'nizin gerçeklerini denetleyin** — `#/cv-studio` içinde yeni bir kapı, uyarlanmış bir CV veya ön yazıyı gerçek CV/profil/two-pager'ınızla karşılaştırır ve her uydurma metriği veya desteksiz iddiayı işaretler (pass/warn/block). **2508 test.**
>
