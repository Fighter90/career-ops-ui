...
> **🆕 En son sürüm — v1.85.0**
>
> **Almanca, İtalyanca ve Türkçe yerel diller** (üst career-ops v1.16.0 yerel dil eşdeğerliği): arayüz artık **16 dilde** sunuluyor — Deutsch 🇩🇪, Italiano 🇮🇹 ve Türkçe 🇹🇷 mevcut 13 dile katılıyor; uygulama içi Yardım, README ve CHANGELOG'un tam çevirisiyle birlikte yerelleştirilmiş LLM istem iskeleti de dahil. v1.84.0 (yeniden başvuru bekleme süresi + ücret), v1.83.0 (yeniden yayın algılayıcı) ve v1.82.0 (NoDesk) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 41 tarayıcı adaptörü · yeniden yayın algılayıcı · yeniden başvuru bekleme süresi · üst career-ops v1.16.0 eşdeğerliği._
