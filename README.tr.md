...
> **🆕 Son sürüm — v1.203.0** — **CV Studio'da "önceki bir CV'yi yeniden kullan?" ipucu** — kayıtlı bir ilan diğer ilanlarınızla karşılaştırılır (belirlenimci, sıfır token) ve uyarlanmış CV'yi yeniden mi, düzeltmelerle mi kullanacağınızı ya da yeni mi uyarlayacağınızı söyler. **2594 test.**
>
