...
> **🆕 Son sürüm — v1.132.0** — `#/scan` sonuç-render alt sistemi, dosya-boyutu sözleşmesini karşılamak için kendi modülüne (`public/js/lib/scan-results.js`) çıkarıldı; davranış bayt-bayt aynı, gerçek tarayıcıda doğrulandı. **2138 test.**
>
