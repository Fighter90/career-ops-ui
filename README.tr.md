...
> **🆕 En son sürüm — v1.109.0**
>
> **Scan Hariç Tut filtresi + pipeline genel bakışı.** Ara kutusu virgülleri VEYA olarak ele alır ("bulunacak roller") ve yeni bir Hariç tut alanı virgülle ayrılmış bir kelimeyle eşleşen satırları gizler; ikisi de kayıtlı aramalarda kalır. Pipeline sayfası kompakt bir genel bakış şeridi kazanır — N gelen kutusunda, N izlenen ve izleyiciden Applied / Responded / Interview / Offer sayıları, her biri `#/tracker`'a bağlanır.
>
> _Scan Hariç Tut · pipeline genel bakışı · güvenlik sıkılaştırması 2 · temizleyici sıkılaştırması · güvenlik sıkılaştırması · AI kullanımı & maliyeti · şirket logoları · yapay zeka CLI araçları · belgelere sor · CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
