...
> **🆕 En son sürüm — v1.91.0**
>
> **Networking ve derin şirket araştırması (Epic 16):** yeni bir **`#/networking`** sayfası, bir şirketi eyleme dönük bir plana çevirir — bir **şirket dosyası**, **kiminle iletişim kurulacağı** (kişi profilleri + LinkedIn arama dizeleri), **en sıcak tanışma yolu** ve role özel **outreach taslakları** — tümü CV'nize ve two-pager'ınıza dayanır. Herhangi bir LLM anahtarıyla canlı çalışır ya da kopyala-yapıştır için bir istem verir ve **planları** şirkete göre kaydedebilirsiniz. v1.90.0 (deneme mülakatı), v1.89.0 (two-pager ile pazar uyumu) ve v1.88.0 (Scan i18n + API hijyeni) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
