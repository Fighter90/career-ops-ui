...
> **🆕 Son sürüm — v1.191.0** — **Sırada ne öğrenmeli** — yeni bir `#/stats` sekmesi, düşük uyumlarını en sık batıran eksik becerileri sıralar (ağırlıklı, Critical/High/Medium kademeleri) — önce neyi çalışacağını bilesin diye. **2504 test.**
>
