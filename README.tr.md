...
> **🆕 En son sürüm — v1.102.0**
>
> **Belgelere sor — kaynağa dayalı bir yardım sohbeti.** Yeni bir **Belgelere sor 💬** sayfası, nasıl-yapılır sorularını **yalnızca** uygulamanın dilinizdeki yardım kılavuzunu kullanarak yanıtlar (kullanılan bölümleri gösterir ve özgeçmişinizi ya da iş aramanızı asla okumaz). Kılavuzun `##` bölümleri üzerinde bağımlılıksız anahtar kelime getirme; model bunlardan yanıtlar ya da kılavuzun kapsamadığını kabul eder. LLM anahtarıyla canlı ya da anahtarsız kopyalanacak istem.
>
> _belgelere sor · CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
