...
> **🆕 En son sürüm — v1.105.0**
>
> **AI kullanımı ve maliyeti sayfası.** Yeni bir **AI kullanımı** sayfası, canlı AI üretimlerinde harcadığınız jetonları sağlayıcı başına 24s / 7g / 30g / tüm zamanlar boyunca tahmini USD maliyetiyle gösterir. Her canlı çağrı `data/llm-usage.jsonl`'ye bir `{provider, in, out}` kaydı ekler (hiçbir şey makinenizden ayrılmaz); dolarlar sağlayıcı başına düzenlenebilir bir fiyat tablosundan gelir — jetonlar kesin, USD bir tahmindir, asla faturalanmaz.
>
> _AI kullanımı & maliyeti · şirket logoları · yapay zeka CLI araçları · belgelere sor · CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
