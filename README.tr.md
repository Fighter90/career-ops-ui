...
> **🆕 Son sürüm — v1.159.0** — **Dile duyarlı rapor meta verileri (düzeltme)** — İngilizce dışında bir dildeki raporlar boş bir meta veri şeridi gösteriyordu (puan/tarih/meşruiyet yok). `parseReportHeader` artık dilden bağımsız `## Machine Summary` bloğunu okuyor (İngilizce raporlar aynı kalır) ve yerel sayı biçimlerini tolere ediyor. **2410 test.**
>
