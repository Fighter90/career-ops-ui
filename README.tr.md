...
> **🆕 Son sürüm — v1.216.0** — **Dokuz LLM sağlayıcısı daha** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks ve yerel Ollama ⚡ canlı değerlendirmeye katıldı (artık **16 sağlayıcı**), her biri Ayarlar’da marka monogramıyla. **2752 test.**
>
