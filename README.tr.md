...
> **🆕 Son sürüm — v1.200.0** — **ATS ilanları için "hâlâ açık mı?" kontrolü** — #/tracker'da tek tık, bir Greenhouse/Lever/Ashby/Workday/SmartRecruiters ilanının genel JSON'unu sorgular (sıfır token, tarayıcı yok) ve **Açık / Süresi dolmuş / Bilinmiyor** gösterir. **2557 test.**
>
