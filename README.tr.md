...
> **🆕 En son sürüm — v1.93.0**
>
> **Bellek katmanı (Epic 24):** yeni bir **`#/memory`** sayfası, kısa, düzenlenebilir bir "benim hakkımda bunu hatırla" notu barındırır. Paylaşılan proje bağlamına gömülü olduğu için **tüm** sağlayıcılarda **her** AI isteğini — değerlendirme, deneme mülakatı, networking, CV Studio — yönlendirir. Tercihlerini ve çalışma tarzını yakalar (asla hakkında yeni olgular değil) ve bir **verilerinden-öner** yardımcısı, gözden geçirmen için izleyicinden davranışsal madde imleri taslağı çıkarır. v1.92.0 (CV Studio), v1.91.0 (networking planlayıcı) ve v1.90.0 (deneme mülakatı) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
