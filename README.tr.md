...
> **🆕 Son sürüm — v1.205.0** — **Beceri günlüğü** — Analitik → Beceri günlüğü'nde bir öz değerlendirme (şirket, platform, beceri, puan %, not) kaydedin; `data/assessments.tsv`'ye eklenir ve geçmiş kayıtları listeler. Sıfır token; yazma kontrol karakterine karşı korumalı (TSV enjeksiyonu yok). **2610 test.**
>
