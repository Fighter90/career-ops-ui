...
> **🆕 Son sürüm — v1.186.0** — **CV Studio'da "Beceri açığı" paneli** — kayıtlı bir iş tanımı seçin ve gerekli becerilerinden hangilerini CV'nizin adlandırdığını, yalnızca ima ettiğini veya eksik olduğunu görün — LLM yok, hiçbir şey yazılmaz. **2485 test.**
>
