...
> **🆕 Son sürüm — v1.196.0** — **Workday uç noktası sıkılaştırması** — `portals.yml`'deki bir Workday `api:` artık alt dize değil **ana bilgisayar adıyla** doğrulanıyor; böylece `https://evil.com/?x=myworkdayjobs.com` gibi düzmece bir URL artık fetch hedefi olarak geçemiyor. CodeQL tarafından bildirildi (#443). **2522 test.**
>
