...
> **🆕 Son sürüm — v1.225.0** — **Sağlayıcı logo afişi** — 18 LLM sağlayıcısının tümünün afişi — 11'i için gerçek logo, 7'si için monogram — artık README ve yardım kılavuzunun başında. **2784 test.**
