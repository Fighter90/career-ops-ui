...
> **🆕 Son sürüm — v1.207.2** — **Yapay zekâ planları yeniden düzgün görünüyor** — model tüm yanıtını bir ```markdown çitine sarsa bile gelişim planı ve yönlendirme profili artık tek aralıklı kod dökümü olarak çıkmıyor. **2621 test.**
>
