...
> **🆕 Son sürüm — v1.188.0** — **Düğmeler yeniden nefes alıyor** — eylem sayfalarındaki (mülakat özeti, yatırım alan şirketler, portallar, kariyer planı, kariyer yönlendirmesi) birincil eylem düğmesi artık alt başlığa yapışmıyor; uygun bir üst kenar boşluğuna sahip. **2497 test.**
>
