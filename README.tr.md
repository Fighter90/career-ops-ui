...
> **🆕 Son sürüm — v1.214.2** — **HTML ayıklama düzeltmesi** — bir HTML özniteliği içinde `>` bulunan açıklama (örn. `title="salary > 100k"`) artık sondaki öznitelik metnini içerik filtresinin okuduğu Greenhouse / Recruitee açıklamasına sızdırmıyor. **2742 test.**
>
