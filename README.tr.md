...
> **🆕 Son sürüm — v1.177.0** — **csod çerez yeniden gönderimi (parent #2769)** — arama API'sini oturum çerezleriyle koruyan Cornerstone kiracıları (401 → 0 iş) artık çalışıyor: açılış sayfasının `Set-Cookie`'si arama POST'unda `Cookie` başlığı olarak yeniden gönderiliyor, yalnızca aynı köken. **2454 test.**
>
