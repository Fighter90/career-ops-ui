...
> **🆕 Son sürüm — v1.180.0** — **Raporlar tablo olarak** — `#/reports` artık bir tablo (Rapor · Tarih · Meşruiyet · Puan); uzun bir "Puan algılanmadı" çipi adı artık harf harf bölmüyor ve bir Machine Summary yer tutucusunun gizlediği gerçek bir puan geri kazanılıyor. **2465 test.**
>
