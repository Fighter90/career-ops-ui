...
> **🆕 En son sürüm — v1.101.0**
>
> **CV Studio: bir işe göre uyarla + ön yazı.** `#/cv-studio` üzerinde yeni bir **Bir işe göre uyarla** kartı, bir iş ilanını uyarlanmış bir özgeçmişe ve uyumlu bir ön yazıya dönüştürür, ardından ikisini de işe alım uzmanı düzeyinde bir **kontrol listesi kapısından** geçirir (hatalar engeller, uyarılar öneri verir). Kariyer koçluğu pratiğinden genel kurallara damıtıldı — yalnızca kendi özgeçmişiniz, profiliniz ve two-pager'ınıza dayanır; asla uydurmaz. Sonucu Markdown / PDF / DOCX olarak dışa aktarın.
>
> _CV uyarlama + ön yazı · two-pager otomatik doldurma · DOCX dışa aktarımı · portal sağlığı · uygulama içi hata bildirici · 16 yerel dil · 6 LLM sağlayıcısı · 46 tarayıcı adaptörü · kariyer yönelimi · kariyer planı · istatistiklerin yeniden tasarımı · bellek katmanı · CV Studio · networking planlayıcı · deneme mülakatı · two-pager ile pazar uyumu · üst career-ops v1.16.0 eşdeğerliği._
