...
> **🆕 Son sürüm — v1.176.0** — **Puan ayrıştırma (FIND-5)** — RU tablosunun listelemediği kalın bir etiket altındaki puan (`**Итоговый балл:**`, `**Скор:**`) artık `X.X / 5` değer biçimiyle yakalanıyor — dilden bağımsız, başlıklara ve tarihlere karşı güvenli. **2453 test.**
>
