...
> **🆕 En son sürüm — v1.84.0**
>
> **pipeline.md içinde yeniden başvuru bekleme süresi + ücret** (üst career-ops v1.15.0 eşdeğerliği): EN taraması artık **yakın zamanda başvurduğunuz şirketlerdeki rolleri atlıyor** (`config/profile.yml → re_apply_windows:`, varsayılan olarak kapalı) böylece sonuçlar yeni açık pozisyonlara odaklı kalıyor ve taranan teklifler **maaşlarını** `data/pipeline.md` içinde isteğe bağlı bir `url | <comp>` sütunu olarak saklıyor. v1.83.0 (yeniden yayın algılayıcı), v1.82.0 (NoDesk) ve v1.81.0 (13 yeni kaynak) üzerine inşa edilmiştir.
>
> _13 yerel dil · 6 LLM sağlayıcısı · 41 tarayıcı adaptörü · yeniden yayın algılayıcı · yeniden başvuru bekleme süresi · üst career-ops v1.15.0 eşdeğerliği._
