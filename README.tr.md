...
> **🆕 Son sürüm — v1.201.0** — **Yerelleştirilmiş izleyici başlıkları artık boş görünmüyor** — İngilizce olmayan veya değişken başlıklar (`empresa`/`estado`, `position`/`stage`/`link`…) içeren bir `data/applications.md` artık kanonik alanlara katlanıyor. **2563 test.**
>
