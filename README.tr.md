...
> **🆕 En son sürüm — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** yeni bir **`#/mock-interview`** sayfası, belirli bir role karşı sıra sıra bir mülakat provası yürütür. Her yanıt **STAR+R geri bildirimi**, bir **puan** ve bir **takip sorusu** alır — CV'nize, two-pager'ınıza ve hikâye bankanıza dayanarak. Herhangi bir LLM anahtarıyla canlı çalışır ya da kopyala-yapıştır için bir istem verir ve **transkriptleri** şirket/role göre kaydedebilirsiniz. v1.89.0 (two-pager ile pazar uyumu), v1.88.0 (Scan i18n + API hijyeni) ve v1.87.0 (4 yeni tarama sağlayıcısı) üzerine inşa edilmiştir.
>
> _16 yerel dil · 6 LLM sağlayıcısı · 45 tarayıcı adaptörü · deneme mülakatı · two-pager ile pazar uyumu · hedef role göre pazar istatistikleri · yeniden yayın algılayıcı · üst career-ops v1.16.0 eşdeğerliği._
