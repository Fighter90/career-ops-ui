...
> **🆕 Son sürüm — v1.227.4** — **Önek düzeltmesi, 2. bölüm** — `word:` / `stem:` `content_filter` tarafından hâlâ yok sayılıyordu; v1.227.3 yalnızca başlık filtresini bağlamıştı. Yapay zekâ incelemesinde bulundu. **2858 test.**
