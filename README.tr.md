...
│  └─ reviews/REVIEW-*.md
└─ tests/                    # 1874 birim + 90 Playwright + 23/23 e2e:full + 20 e2e:smoke (baseline @ v1.121.0)
...
```bash
npm test                       # 1874 birim/entegrasyon testi
