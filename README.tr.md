...
> **🆕 Son sürüm — v1.212.0** — **Job Bank (Kanada) + düzeltmeler** — Kanada'nın federal panosu artık taranabilir, Consider tabanlı panolar yeniden sonuç döndürüyor ve çok konumlu Lever ilanları tüm konumlarını gösteriyor. (EchoJobs emekliye ayrıldı — beslemesi bot korumasının arkasında.) **2685 test.**
>
