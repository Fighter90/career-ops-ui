...
> **🆕 最新版本 — v1.101.0**
>
> **CV Studio：針對職缺客製 + 求職信。** `#/cv-studio` 新增**針對職缺客製**卡片，把職缺描述變成客製履歷與相符的求職信，並讓兩者通過招募人員等級的**檢查清單關卡**(錯誤攔截，警告提示)。將職涯輔導實務提煉為通用規則——僅根據你自己的履歷、檔案和兩頁紙，絕不杜撰。結果可匯出為 Markdown / PDF / DOCX。
>
> _履歷客製 + 求職信 · 兩頁紙自動填入 · DOCX 匯出 · 入口網站健康 · 應用程式內錯誤回報器 · 16 個 locales · 6 個 LLM 提供者 · 46 個掃描器轉接器 · 職業方向 · 職涯規劃 · 統計重構 · 記憶層 · CV Studio · 人脈拓展規劃器 · mock interview · two-pager 市場契合度 · 與父層 career-ops v1.16.0 對齊。_
