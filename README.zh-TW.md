...
> **🆕 最新版本 — v1.196.0** — **Workday 端點加固** — `portals.yml` 中的 Workday `api:` 現在按**主機名**驗證，而非子字串，因此像 `https://evil.com/?x=myworkdayjobs.com` 這樣的構造 URL 不再能作為 fetch 目標通過。由 CodeQL 回報（#443）。 **2522 項測試。**
>
