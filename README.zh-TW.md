...
> **🆕 最新版本 — v1.85.0**
>
> **德語、義大利語與土耳其語語系**（與父層 career-ops v1.16.0 語系對齊）：介面現已支援 **16 種語言** —— Deutsch 🇩🇪、Italiano 🇮🇹 與 Türkçe 🇹🇷 加入現有的 13 種語言,並提供完整的應用內說明、README 與 CHANGELOG 翻譯,以及在地化的 LLM 提示鷹架。在 v1.84.0（重新申請冷卻 + 薪酬）、v1.83.0（重複刊登偵測器）和 v1.82.0（NoDesk）的基礎上構建。
>
> _16 locales · 6 個 LLM 提供者 · 41 個掃描器轉接器 · 重複刊登偵測器 · 重新申請冷卻 · 與父層 career-ops v1.16.0 對齊。_
