...
> **🆕 Останній реліз — v1.95.0**
>
> **План кар'єри (Epic 26):** нова сторінка **`#/career-plan`** перетворює ваше резюме та профіль на конкретний, персоналізований план розвитку. Виберіть **горизонт** (6/12/24 місяці) та, за бажанням, фокус, і модель пише знімок відправної точки, SWOT сильних сторін і зростання, цілі у форматі **SMART / OKR / WOOP**, альтернативні траєкторії, план hard/soft-навичок, **помісячну дорожню карту**, відстеження прогресу, підводні камені та підтримувальні кроки — на основі ваших власних матеріалів, ніколи не вигадуючи вашу історію. Редагуйте її на місці, **Збережіть** її в користувацький шар і експортуйте її у **Markdown або PDF**. Базується на v1.94.0 (перероблення статистики) і v1.93.0 (шар пам'яті).
>
> _16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
