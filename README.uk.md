...
[![tests](https://img.shields.io/badge/tests-2485%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.186.0** — **Панель «Розрив навичок» у CV-студії** — виберіть збережену вакансію й подивіться, які потрібні навички ваше CV називає, лише натякає або яких немає — без LLM, нічого не записується. **2485 тестів.**
>
