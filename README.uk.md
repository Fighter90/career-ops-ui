...
[![tests](https://img.shields.io/badge/tests-2510%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.193.0** — **Тиша після співбесіди** — нова вкладка `#/stats` показує співбесіди, що замовкли після «ввічливого» вікна (типово 30 днів) — із тривалістю тиші й датою останньої співбесіди. **2510 тестів.**
>
