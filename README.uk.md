...
> **🆕 Останній реліз — v1.114.0**
>
> **Лічильник використання та вартості ШІ в бічній панелі.** Компактний розділ ВИКОРИСТАННЯ унизу бічної панелі (лівий нижній кут; правий нижній для RTL) показує використання токенів LLM за 24г / 7д / 30д зеленими смугами та оцінку вартості за 24г — з локального журналу лише для читання, того самого джерела, що й сторінка «Використання». Згортається; вартість оцінна, ручні запуски безкоштовні.
>
> _лічильник використання · плаваючий помічник довідки · консолідація доків та QA · закриття беклогу безпеки · докум. та QA ×16 · Виключити Scan · огляд пайплайна · посилення безпеки 2 · посилення санітайзера · посилення безпеки · витрати ШІ · логотипи компаній · інструменти CLI для ШІ · запитати довідку · адаптація CV + лист · автозаповнення two-pager · експорт у DOCX · здоров’я порталів · вбудований репортер багів · 16 locales · 6 LLM-провайдерів · 46 адаптерів сканера · кар'єрна орієнтація · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
