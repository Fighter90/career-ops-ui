...
[![tests](https://img.shields.io/badge/tests-2768%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.219.0** — **Torre долучається до сканера** — латиноамериканський маркетплейс талантів (torre.ai) став новим джерелом сканування (усього **83**), плюс виправлення пагінації a16z та коректні мітки + монограми провайдерів усюди. **2768 тестів.**
>
