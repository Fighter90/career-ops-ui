...
[![tests](https://img.shields.io/badge/tests-2481%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.185.0** — **Вкладка «Лійка та швидкість»** — частка відповідей та інтерв'ю поряд із ринковими орієнтирами, список очікування застряглих відгуків і медіанні дні за етапами — усе з вашого трекера, лише читання. **2481 тестів.**
>
