...
[![tests](https://img.shields.io/badge/tests-2586%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.202.0** — **Пошук ATS-дошок на #/portals** — введіть компанію, застосунок перевірить Greenhouse/Ashby/Lever на її публічну дошку (без LLM, без браузера, SSRF-безпечно), і одним кліком додасть її до відстежуваних. **2586 тестів.**
>
