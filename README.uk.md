...
[![tests](https://img.shields.io/badge/tests-2465%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.180.0** — **Звіти таблицею** — `#/reports` тепер таблиця (Звіт · Дата · Легітимність · Оцінка); довгий чип «Оцінку не виявлено» більше не рве назву по символах, і відновлено справжню оцінку, яку приховував заповнювач Machine Summary. **2465 тестів.**
>
