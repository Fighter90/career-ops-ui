...
> **🆕 Останній реліз — v1.102.0**
>
> **Запитати довідку — обґрунтований чат допомоги.** Нова сторінка **Запитати довідку 💬** відповідає на запитання, спираючись **лише** на вбудовану довідку застосунку вашою мовою (показує використані розділи й ніколи не читає ваше резюме чи пошук роботи). Пошук за ключовими словами без залежностей за розділами `##` довідки; модель відповідає з них або визнає, що довідка це не охоплює. Наживо з ключем LLM або промпт для копіювання без нього.
>
> _запитати довідку · адаптація CV + лист · автозаповнення two-pager · експорт у DOCX · здоров’я порталів · вбудований репортер багів · 16 locales · 6 LLM-провайдерів · 46 адаптерів сканера · кар'єрна орієнтація · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
