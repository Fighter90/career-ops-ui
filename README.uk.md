...
[![tests](https://img.shields.io/badge/tests-2536%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.198.0** — **Розумніші повтори сканування** — коли дошка ненадовго обмежує частоту (HTTP 429/5xx) під час скану, повтори тепер використовують **експоненційну затримку + джитер** і враховують (обмежений) `Retry-After` замість фіксованої короткої паузи. **2536 тестів.**
>
