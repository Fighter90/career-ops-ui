...
> **🆕 Останній реліз — v1.92.0**
>
> **CV Studio (Epic 21):** нова сторінка **`#/cv-studio`** дає вашому резюме три чесні інструменти — **діагностику резюме** (детермінована оцінка 0–100 із поясненнями за кожною перевіркою), **маску приватності** (вилучення email/телефону/посилань/адреси/імені цілком у браузері) та **make it human** (перепис сухих рядків _вашим_ голосом, обґрунтований вашим voice-dna та зразками текстів, без вигаданих фактів). Базується на v1.91.0 (планувальник нетворкінгу), v1.90.0 (пробна співбесіда) і v1.89.0 (ринкова відповідність через two-pager).
>
> _16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · ринкова статистика за цільовими ролями · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
