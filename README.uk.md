...
> **🆕 Останній реліз — v1.94.0**
>
> **Статистика, перероблена (Epic 25):** сторінка **`#/stats`** тепер є розділом **Статистика** з трьома вкладками, зі справжніми графіками та значно більшою кількістю даних. Нова вкладка **Звіт про ринок** генерує AI-аналіз зарплат і ринку праці для ваших цільових ролей — за рівнем із перцентилями P10–P90, провідні роботодавці, затребувані навички, пільги, частка віддаленої роботи, тренди та поради щодо перемовин, у вибраному вами регіоні та **валюті** (цифри позначені як орієнтовні оцінки моделі, ніколи не зібрані). Нова вкладка **Мій пайплайн** будує графіки за вашим власним трекером (оцінки, воронка, провідні компанії/ролі, часова шкала, коефіцієнти конверсії). Кожен звіт експортується у **Markdown або PDF**. Базується на v1.93.0 (шар пам'яті) і v1.92.0 (CV Studio).
>
> _перероблення статистики · 16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
