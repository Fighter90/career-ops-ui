...
> **🆕 Останній реліз — v1.132.0** — підсистему рендерингу результатів `#/scan` винесено в окремий модуль (`public/js/lib/scan-results.js`) для дотримання контракту розміру файлу; поведінка ідентична побайтово, перевірено в реальному браузері. **2138 тестів.**
>
