...
> **🆕 Останній реліз — v1.101.0**
>
> **CV Studio: адаптація під вакансію + лист.** Нова картка **Адаптувати під вакансію** на `#/cv-studio` перетворює опис вакансії на адаптоване резюме та відповідний супровідний лист, а потім проганяє обидва через рекрутерський **чек-лист-гейт** (помилки блокують, попередження радять). Витяжка з практики кар'єрного консультування в загальні правила — ґрунтується лише на вашому резюме, профілі та two-pager; нічого не вигадує. Експорт результату у Markdown / PDF / DOCX.
>
> _адаптація CV + лист · автозаповнення two-pager · експорт у DOCX · здоров’я порталів · вбудований репортер багів · 16 locales · 6 LLM-провайдерів · 46 адаптерів сканера · кар'єрна орієнтація · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
