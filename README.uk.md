...
[![tests](https://img.shields.io/badge/tests-2519%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.194.0** — **Виправлено односегментні URL Workday** — сторінки на кшталт `https://parsons.wd5.myworkdayjobs.com/Search` (один сегмент) тепер ведуть на правильний фід вакансій, а не падають у `External`. Повідомлено в #255. **2517 тестів.**
>
