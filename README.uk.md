...
[![tests](https://img.shields.io/badge/tests-2479%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.184.0** — **Рівна сітка Дашборда** — плитки швидких дій тепер використовують колонки однакової ширини, тож група з 3 більше не ширша за групу з 4 і всі секції вирівняні справа. **2479 тестів.**
>
