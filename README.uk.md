...
[![tests](https://img.shields.io/badge/tests-2477%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.183.0** — **Розумніше виявлення дублікатів** — сканер тепер ключує кожну вакансію за канонічним URL, тож та сама вакансія з посиланням-трекером (`?utm_…`), через `http`/`https` або з кінцевим слешем більше не показується двічі. **2477 тестів.**
>
