...
[![tests](https://img.shields.io/badge/tests-2756%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.217.1** — **Ark долучається** — BytePlus Ark і Volcengine Ark (Doubao від ByteDance) тепер провайдери ⚡ живого оцінювання (**18 загалом**), кожен із фірмовою монограмою в Налаштуваннях. **2756 тестів.**
>
