...
[![tests](https://img.shields.io/badge/tests-2752%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.216.0** — **Ще девʼять LLM-провайдерів** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks і локальний Ollama долучаються до ⚡ живого оцінювання (тепер **16 провайдерів**), кожен із фірмовою монограмою в Налаштуваннях. **2752 тестів.**
>
