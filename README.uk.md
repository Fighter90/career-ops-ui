...
[![tests](https://img.shields.io/badge/tests-2363%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.141.0** — **проникливі статистики (продовження): збагачення профінансованих компаній** — `#/funded` тепер наочна сітка карток: **логотипи** компаній, **графік за сумою** фінансування і картки **раунд / сума / оцінка / рекомендована дія**. 3 ключі ×17 локалей. **2363 тестів.**
>
