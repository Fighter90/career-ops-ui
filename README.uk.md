...
[![tests](https://img.shields.io/badge/tests-2527%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.197.0** — **Відстежуйте дошку Getro лише за URL** — вкажіть відстежуваній дошці Getro її власний `careers_url`, і числовий id колекції тепер **визначається автоматично** зі сторінки дошки (один захищений від SSRF запит), без ручного пошуку. **2527 тестів.**
>
