...
[![tests](https://img.shields.io/badge/tests-2454%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.177.0** — **Повтор кук csod (parent #2769)** — орендарі Cornerstone, що закривають search-API сесійними куками (401 → 0 вакансій), тепер працюють: `Set-Cookie` bootstrap-сторінки повторюється як заголовок `Cookie` в POST пошуку, лише той самий origin. **2454 тестів.**
>
