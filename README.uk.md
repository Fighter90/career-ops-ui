...
[![tests](https://img.shields.io/badge/tests-2456%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.178.0** — **Оновлення констант (паритет з батьком)** — User-Agent браузера піднято до Chrome 151 (паритет WAF/бот-фільтрів), а fallback станів трекера отримав турецькі аліаси станів із батька. **2456 тестів.**
>
