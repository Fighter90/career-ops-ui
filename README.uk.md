...
> **🆕 Останній реліз — v1.86.0**
>
> **Статистика за цільовими ролями** (`#/stats`): нова сторінка аналітики читає ваші **цільові ролі з профілю** (не захардкоджені) і останній скан, щоб побудувати графіки **вакансій і медіанної зарплати за країнами**, з фільтрами за роллю/країною та **трендом зі збережених знімків** — агрегується на боці клієнта з розріджених даних, які сканери вже збирають (без вигаданих чисел), усіма 16 мовами. Базується на v1.85.0 (німецька/італійська/турецька локалі), v1.84.0 (кулдаун повторних заявок) і v1.83.0 (детектор повторних публікацій).
>
> _16 locales · 6 LLM-провайдерів · 41 адаптер сканера · ринкова статистика за цільовими ролями · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
