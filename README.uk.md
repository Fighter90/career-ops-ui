...
> **🆕 Останній реліз — v1.207.0** — **Запис підсумку з трекера** — у кожному рядку дія **Підсумок**: оберіть, що сталося (відмова / офер / найнятий / відхилено / немає відповіді / співбесіда), перегляньте підсумковий статус і запишіть. Архівує надіслані артефакти й синхронізує стан трекера. **2618 тестів.**
>
