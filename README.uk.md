...
[![tests](https://img.shields.io/badge/tests-2858%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.227.4** — **Фікс префіксів, частина 2** — `word:` / `stem:` усе ще ігнорувалися в `content_filter`; v1.227.3 підключила лише фільтр заголовків. Знайдено AI-рев'ю. **2858 тестів.**
