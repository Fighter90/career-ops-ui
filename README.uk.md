...
> **🆕 Останній реліз — v1.105.0**
>
> **Сторінка витрат і вартості ШІ.** Нова сторінка **Витрати ШІ** показує, скільки токенів ви витратили на живі генерації ШІ, за провайдерами, за 24г / 7д / 30д / весь час, з оцінкою вартості в USD. Кожен живий виклик додає запис `{provider, in, out}` до `data/llm-usage.jsonl` (нічого не залишає вашу машину); долари беруться з редагованої таблиці цін за провайдерами — токени точні, USD — оцінка, не виставляється до оплати.
>
> _витрати ШІ · логотипи компаній · інструменти CLI для ШІ · запитати довідку · адаптація CV + лист · автозаповнення two-pager · експорт у DOCX · здоров’я порталів · вбудований репортер багів · 16 locales · 6 LLM-провайдерів · 46 адаптерів сканера · кар'єрна орієнтація · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
