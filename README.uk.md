...
[![tests](https://img.shields.io/badge/tests-2492%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.187.0** — **`skip_tiers` знову працює** — список `skip_tiers: [intern, entry]` у `portals.yml` тепер відкидає вакансії за грейдом під час скану (раніше мовчки ігнорувався). **2492 тестів.**
>
