...
[![tests](https://img.shields.io/badge/tests-2602%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.204.0** — **«Доктор налаштування» в Налаштуваннях** — перевірка без токенів `cv.md` + `config/profile.yml`, що перелічує блокуючі проблеми та попередження (демо-дані, зашиті метрики), щоб виправити неповне налаштування, перш ніж воно послабить скани й адаптацію. **2602 тестів.**
>
