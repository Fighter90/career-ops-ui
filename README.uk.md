...
[![tests](https://img.shields.io/badge/tests-2361%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.140.0** — **проникливі статистики: багатші дані про зарплати** — розбивка зарплат у «Мій пайплайн» на `#/stats` тепер показує **середнє** (не лише медіану), перемикач **на рік ⇄ на місяць** і таблицю **мін · сер · медіана · макс** за країнами. 8 ключів ×17 локалей. **2361 тестів.**
>
