...
[![tests](https://img.shields.io/badge/tests-2865%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.227.5** — **Регіональний скан більше не вичерпує пам'ять** — він тримав усі сирі влучання з 21 запиту до кінця (742 МБ проти стелі машини у 490 МБ, 4 падіння сервісу за добу); тепер дедуп і фільтрація щозапиту → **177 МБ**. Плюс виправлено флейк Playwright. **2865 тестів.**
