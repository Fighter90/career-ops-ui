...
[![tests](https://img.shields.io/badge/tests-2818%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.226.0** — **Два в'єтнамські джерела вакансій** — ITviec + CareerViet підключені до сканера (85 джерел · 80 адаптерів) — паритет із батьківським 1.30.0. **2818 тестів.**
