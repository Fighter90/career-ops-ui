...
[![tests](https://img.shields.io/badge/tests-2420%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.163.0** — **Довідка охоплює звіт → PDF (виправлення)** — асистент «Запитати документацію» казав, що посібник не описує експорт звіту в PDF, попри кнопку 📄 Generate PDF на `#/reports/:slug`. До всіх 17 пакетів довідки додано розділ «Експорт звіту в PDF». **2420 тестів.**
>
