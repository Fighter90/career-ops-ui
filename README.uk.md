...
> **🆕 Останній реліз — v1.227.2** — **Фікс для вузьких екранів** — `#/config` більше не з'їжджає вбік на ≤ 352 px: у 18 селектів був інлайновий `min-width: 300px`, який не стискався. Тепер під гейтом — прогін Playwright на 320 px. **2846 тестів · 101 Playwright.**
