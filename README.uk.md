...
[![tests](https://img.shields.io/badge/tests-2837%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.227.0** — **Гонконг і точніші фоллоу-апи** — JobsDB Гонконг приєднується до Jobstreet/SEEK (тепер на API v5), на дошці каденції з'явився фільтр «лише термінові», а нерозкриті роботодавці показують агентство-посередника — паритет з 1.30.0 батьківського проєкту. **2837 тестів.**
