...
[![release](https://img.shields.io/badge/release-v1.115.0-blue)](https://github.com/Fighter90/career-ops-ui/releases/tag/v1.115.0)

> **🆕 Останній реліз — v1.115.0**
>
> **Шліфування дизайну (консервативне, кораловий бренд).** Легке вдосконалення спільної дизайн-системи — без перебудови чи зміни палітри: картки метрик піднімаються з кораловою рамкою при наведенні, кнопки отримують тінь у спокої та м'яке підняття, великі числа вирівнюються через tabular-nums, а елементи керування отримують м'який кораловий ореол фокуса. Анімація поважає prefers-reduced-motion.
>
> _шліфування дизайну · лічильник використання · плаваючий помічник довідки · консолідація доків та QA · закриття беклогу безпеки · докум. та QA ×16 · Виключити Scan · огляд пайплайна · посилення безпеки 2 · посилення санітайзера · посилення безпеки · витрати ШІ · логотипи компаній · інструменти CLI для ШІ · запитати довідку · адаптація CV + лист · автозаповнення two-pager · експорт у DOCX · здоров’я порталів · вбудований репортер багів · 16 locales · 6 LLM-провайдерів · 46 адаптерів сканера · кар'єрна орієнтація · план кар'єри · перероблення статистики · шар пам'яті · CV Studio · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · паритет із батьківським career-ops v1.16.0._
