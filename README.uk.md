...
[![tests](https://img.shields.io/badge/tests-2522%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.196.0** — **Посилення ендпоінта Workday** — `api:` Workday у `portals.yml` тепер перевіряється за **іменем хоста**, а не за підрядком, тож підроблений URL на кшталт `https://evil.com/?x=myworkdayjobs.com` більше не пройде як ціль fetch. Повідомлено CodeQL (#443). **2522 тестів.**
>
