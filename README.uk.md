...
[![tests](https://img.shields.io/badge/tests-2458%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.179.0** — **Консолідація декодерів** — 20 дубльованих декодерів HTML-сутностей у джерелах сканування тепер проходять через єдиний спільний модуль (−237 рядків), із гардом проти повторного дублювання. Поведінку збережено. **2458 тестів.**
>
