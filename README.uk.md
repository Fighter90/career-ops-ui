...
> **🆕 Останній реліз — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** нова сторінка **`#/mock-interview`** проводить пробну співбесіду хід за ходом для конкретної ролі. Кожна відповідь отримує **фідбек STAR+R**, **оцінку** та **додаткове запитання** — на основі вашого CV, two-pager та банку історій. Працює наживо з будь-яким ключем LLM або повертає промт для копіювання, а **транскрипти** можна зберігати для кожної компанії/ролі. Базується на v1.89.0 (ринкова відповідність через two-pager), v1.88.0 (i18n для Scan + гігієна API) і v1.87.0 (4 нові провайдери сканування).
>
> _16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · пробна співбесіда · ринкова відповідність через two-pager · ринкова статистика за цільовими ролями · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
