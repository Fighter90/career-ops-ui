...
[![tests](https://img.shields.io/badge/tests-2418%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.162.0** — **Більша тап-ціль «?» (a11y-виправлення)** — «?»-підказка була ціллю 18×18 px, нижче мінімуму 24×24 WCAG 2.5.8. Тепер бокс 24×24, а видиме кільце лишається 18px (через `::before`), без зсувів. **2418 тестів.**
>
