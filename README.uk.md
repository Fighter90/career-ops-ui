...
> **🆕 Останній реліз — v1.154.0** — **Запуск усього стеку в хмарі** — Новий покроковий гайд, як розмістити батьківський пайплайн career-ops + цей переглядач + рушій ШІ (підписка Claude, локальний Hermes, або ключі API) на невеликому завжди увімкненому сервері — як Довідка §31 17 мовами, розділ README і вікі-сторінка. **2396 тестів.**
>
