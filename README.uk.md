...
[![tests](https://img.shields.io/badge/tests-2742%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.215.0** — **Запуск з OpenWorker** — новий AI-coworker без коду виконує весь ваш пошук роботи (і запускає цей дашборд) із застосунку OpenWorker від Andrew Ng; вбудована довідка та асистент «Запитати документацію» тепер охоплюють його всіма 17 мовами. **2742 тестів.**
>
