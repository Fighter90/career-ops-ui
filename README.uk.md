...
> **🆕 Останній реліз — v1.155.0** — **Чистіший вигляд config (рефакторинг)** — `config.js` (1030 рядків) розбито під ліміт 800 на два модулі, що зберігають поведінку — дані полів + фабрика панелі вкладок. Чистий рефакторинг, без зміни поведінки. **2396 тестів.**
>
