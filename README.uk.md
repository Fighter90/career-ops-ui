...
[![tests](https://img.shields.io/badge/tests-2504%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.191.0** — **Що вчити далі** — нова вкладка `#/stats` ранжує навички, що найчастіше топлять ваші низькі відповідності (зважені, грейди Critical/High/Medium) — щоб знати, що вчити спершу. **2504 тестів.**
>
