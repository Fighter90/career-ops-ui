...
> **🆕 Останній реліз — v1.91.0**
>
> **Нетворкінг і глибоке дослідження компаній (Epic 16):** нова сторінка **`#/networking`** перетворює компанію на дієвий план — **досьє компанії**, **з ким зв'язатися** (персони + пошукові рядки LinkedIn), **найтепліший шлях для представлення** та адаптовані **чернетки для контакту** — усе на основі вашого CV та two-pager. Працює наживо з будь-яким ключем LLM або повертає промт для копіювання, а **плани** можна зберігати для кожної компанії. Базується на v1.90.0 (пробна співбесіда), v1.89.0 (ринкова відповідність через two-pager) і v1.88.0 (i18n для Scan + гігієна API).
>
> _16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · планувальник нетворкінгу · пробна співбесіда · ринкова відповідність через two-pager · ринкова статистика за цільовими ролями · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
