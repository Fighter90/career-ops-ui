...
[![tests](https://img.shields.io/badge/tests-2540%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.199.0** — **Широкі таблиці прокручуються вбік** — таблиці, ширші за вікно (Scan, Трекер, Статистика…), обрізалися без смуги прокрутки; тепер показують **горизонтальну смугу** за потреби, тож будь-який стовпець доступний. **2540 тестів.**
>
