...
[![tests](https://img.shields.io/badge/tests-2453%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.176.0** — **Розбір балу (FIND-5)** — бал під жирною міткою, якої немає в RU-таблиці (`**Итоговый балл:**`, `**Скор:**`), тепер ловиться за формою значення `X.X / 5` — незалежно від мови, безпечно щодо заголовків і дат. **2453 тестів.**
>
