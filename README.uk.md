...
[![tests](https://img.shields.io/badge/tests-2738%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.214.1** — **Ліміт опису Ashby** — описи Ashby тепер ріжуться до 4000 символів, як у Greenhouse і Recruitee, тож контент-фільтр поводиться однаково на кожній дошці, і жодна не роздуває кеш сканування. **2738 тестів.**
>
