...
[![tests](https://img.shields.io/badge/tests-2771%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.220.0** — **Get on Board, кілька категорій** — один запис тепер сканує `programming`, `operations-management`, `machine-learning-ai`, … (дедуп за URL, ліміт 12), щоб пошуки EM/data не втрачали ролі, які дошка виділяє окремо. **2771 тестів.**
>
