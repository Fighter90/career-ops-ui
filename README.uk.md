...
> **🆕 Останній реліз — v1.208.0** — **Застосунок вміщається на телефоні** — жодна сторінка не їде вбік: верхня панель переноситься, широкі таблиці/код прокручуються в рамці, довідка перебудовується, а довгі шляхи переносяться, а не розтягують верстку. **2621 тестів.**
>
