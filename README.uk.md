...
[![tests](https://img.shields.io/badge/tests-2557%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.200.0** — **Перевірка «ще активна?» для вакансій на ATS** — на #/tracker один клік запитує публічний JSON вакансії Greenhouse/Lever/Ashby/Workday/SmartRecruiters (без токенів, без браузера) і показує **Активна / Закрита / Невідомо**. **2557 тестів.**
>
