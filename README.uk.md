...
[![tests](https://img.shields.io/badge/tests-2758%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.218.0** — **Значки провайдерів усюди** — чип дашборда, зведення «Активний» у налаштуваннях і результат ⚡ оцінювання тепер показують монограму кожного провайдера та його правильну назву серед усіх 18 (виправлено три застарілі мітки на 5 провайдерів). **2758 тестів.**
>
