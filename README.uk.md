...
>
> **Шар пам'яті (Epic 24):** нова сторінка **`#/memory`** містить коротку редаговану нотатку «запам'ятай це про мене». Оскільки вона вбудована у спільний контекст проєкту, вона керує **кожним** AI-запитом — оцінка, пробна співбесіда, нетворкінг, CV Studio — в **усіх** провайдерах. Вона фіксує ваші вподобання й стиль роботи (ніколи не нові факти про вас), а помічник **підказок з ваших даних** готує поведінкові пункти з вашого трекера для перегляду. Базується на v1.92.0 (CV Studio), v1.91.0 (планувальник нетворкінгу) і v1.90.0 (пробна співбесіда).
>
