...
> **🆕 Останній реліз — v1.89.0**
>
> **Відповідність кандидата ринку — two-pager (Epic 14):** нова сторінка **`#/two-pager`** фіксує те, що _ви_ насправді хочете від наступної ролі (що вам подобається, обов'язкові умови, що ви ненавидите, deal-breaker'и, непереговорне) у форматі «two-pager Мнукіна». **ШІ-асистент заповнення** складає її на основі вашого CV + профілю, кожна вакансія на `#/scan` отримує оцінку **`◎` відповідності-тому-що-ви-хочете**, а two-pager живить кожну оцінку. Базується на v1.88.0 (i18n для Scan + гігієна API), v1.87.0 (4 нові провайдери сканування) і v1.86.0 (статистика за цільовими ролями).
>
> _16 locales · 6 LLM-провайдерів · 45 адаптерів сканера · ринкова відповідність через two-pager · ринкова статистика за цільовими ролями · детектор повторних публікацій · паритет із батьківським career-ops v1.16.0._
