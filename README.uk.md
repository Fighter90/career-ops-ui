...
[![tests](https://img.shields.io/badge/tests-2437%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.171.0** — **Токени типошкали + z-index (D-4, перший крок)** — додано `--font-size-*` і шари `--z-*`; кожен літерал z-index мігровано (значення збережені), основні розміри використовують рампу. Без піксельних змін. **2437 тестів.**
>
