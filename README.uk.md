...
[![tests](https://img.shields.io/badge/tests-2497%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.188.0** — **Кнопки знову «дихають»** — основна кнопка дії на сторінках дій (дайджест співбесід, профінансовані компанії, портали, кар'єрний план, кар'єрна орієнтація) більше не притиснута до підзаголовка; тепер має правильний верхній відступ. **2497 тестів.**
>
