...
[![tests](https://img.shields.io/badge/tests-2381%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.148.0** — **Охайніші фільтри сканування** — панель фільтрів `#/scan` тепер акуратна адаптивна сітка (раніше — рваний flex-wrap), а «Застосувати / Скинути» винесені в окремий рядок із вирівнюванням праворуч. Фільтри ті самі, читати зручніше. **2381 тестів.**
>
