...
[![tests](https://img.shields.io/badge/tests-2426%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.166.0** — **Формулювання рубрики за докам (виправлення)** — UI/сайт/вікі казали «рубрика з шести вимірів», а доки — «п'ять вимірів плюс цілісна загальна оцінка» (5+1=6). Формулювання документації прийнято в README/сайті/довідці/вікі ×17. **2426 тестів.**
>
