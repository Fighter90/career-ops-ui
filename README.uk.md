...
> **🆕 Останній реліз — v1.214.2** — **Фікс очищення HTML** — опис із `>` усередині HTML-атрибута (напр. `title="salary > 100k"`) більше не протягує хвіст атрибута в опис Greenhouse / Recruitee, який читає контент-фільтр. **2742 тестів.**
>
