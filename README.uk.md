...
[![tests](https://img.shields.io/badge/tests-2508%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.192.0** — **Перевірка фактів у CV** — новий запобіжник у `#/cv-studio` звіряє адаптоване CV чи лист із вашими справжніми CV/профілем/two-pager і позначає кожну вигадану метрику чи необґрунтоване твердження (pass/warn/block). **2508 тестів.**
>
