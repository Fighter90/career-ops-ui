...
[![tests](https://img.shields.io/badge/tests-2594%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.203.0** — **Підказка «повторно використати попереднє резюме?» у CV Studio** — збережена вакансія порівнюється з іншими (детерміновано, без токенів), щоб підказати: повторно використати адаптоване резюме, з правками чи готувати нове. **2594 тестів.**
>
