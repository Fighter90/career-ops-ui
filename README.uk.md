...
> **🆕 Останній реліз — v1.231.2** — **Верхня панель на телефоні знову в один рядок, дії — піктограмами.** Кнопки дій виштовхувалися на другий рядок на всю ширину, і на телефоні виходило `[☰ · Пошук]`, а під ним `[🔔 🌙 Doctor Відкрити Scan]` — дві широкі «пігулки» в окремому рядку. Тепер це квадрати 36 px (🩺 / ⚡) поруч із дзвіночком і перемикачем теми, і все вміщується в рядок навіть на 320 px — це виміряно, а не оцінено на око: на 320/360/390/430 px і по всій смузі 560–760 px, де кнопки раніше наїжджали на поле пошуку. **Мова більше взагалі не впливає на мобільне розкладання** — підпис прихований, а кнопка фіксованого розміру. Ще виправлено: сервер працював на батьківському **1.31.0**, хоча реліз зібрано проти **1.32.0**, а `cvstart.ru` додавав `/ru/` до будь-якого шляху, не дивлячись, що там уже є — `/en/help` ставав `/ru/en/help`, повністю закриваючи англійську версію. **3009 тестів.**
