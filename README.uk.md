...
> **🆕 Останній реліз — v1.208.1** — **Фікс верхньої панелі на мобільному** — її кнопки більше не накривають заголовок сторінки при переносі на другий рядок; панель росте під них. **2621 тестів.**
>
