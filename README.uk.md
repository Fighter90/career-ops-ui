...
[![tests](https://img.shields.io/badge/tests-2521%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.195.0** — **Швидше виявлення переоприлюднень** — виявлення дублів більше не O(N²) на великих історіях; групування заголовків за компанією тепер інвертований індекс. Вивід ідентичний (доведено диф-тестом), просто набагато швидше. **2521 тестів.**
>
