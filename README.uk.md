...
[![tests](https://img.shields.io/badge/tests-2852%20passed-brightgreen)](#тести)
...
> **🆕 Останній реліз — v1.227.3** — **Префікси фільтра заголовків запрацювали** — `word:` / `stem:` зіставлялися як буквальний текст, через що ці рядки були пустушкою (правило `word:intern` працювало в CLI і не фільтрувало тут нічого). Портовано з батьківського проєкту разом із межами Unicode. **2852 тести.**
