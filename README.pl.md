...
> **🆕 Najnowsze wydanie — v1.207.1** — **Strona startowa mieści się na każdym ekranie** — na małych telefonach nagłówek, wprowadzenie i terminal instalacji nie są już ucinane przy prawej krawędzi; długie polecenie instalacji przewija się w terminalu. **2618 testów.**
>
