...
[![tests](https://img.shields.io/badge/tests-2852%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.227.3** — **Prefiksy filtra tytułów już działają** — `word:` / `stem:` były dopasowywane jako dosłowny tekst, przez co te linie nic nie robiły (reguła `word:intern` działała w CLI i nie filtrowała tu niczego). Przeniesione z projektu nadrzędnego, z granicami Unicode. **2852 testów.**
