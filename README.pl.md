...
[![tests](https://img.shields.io/badge/tests-2477%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.183.0** — **Sprytniejsze wykrywanie duplikatów** — skaner identyfikuje teraz każdą ofertę po kanonicznym URL, więc ta sama oferta z linkiem śledzącym (`?utm_…`), przez `http`/`https`, lub z końcowym ukośnikiem nie pojawia się już dwa razy. **2477 testów.**
>
