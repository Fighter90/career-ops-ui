...
[![tests](https://img.shields.io/badge/tests-2456%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.178.0** — **Odświeżenie stałych (parytet z rodzicem)** — User-Agent przeglądarki podnosi się do Chrome 151 (parytet bramek WAF/bot), a fallback stanów trackera zyskuje tureckie aliasy stanów rodzica. **2456 testów.**
>
