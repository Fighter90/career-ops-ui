...
[![tests](https://img.shields.io/badge/tests-2594%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.203.0** — **Podpowiedź „użyć ponownie wcześniejszego CV?" w CV Studio** — zapisana oferta jest porównywana z innymi (deterministycznie, zero tokenów), by wskazać: użyć ponownie dopasowanego CV, użyć z poprawkami czy przygotować nowe. **2594 testów.**
>
