...
[![tests](https://img.shields.io/badge/tests-2527%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.197.0** — **Śledź tablicę Getro tylko po URL** — podaj śledzonej tablicy Getro jej własny `careers_url`, a liczbowy id kolekcji **rozwiązuje się teraz automatycznie** ze strony tablicy (jedno bezpieczne wobec SSRF pobranie), bez ręcznego szukania. **2527 testów.**
>
