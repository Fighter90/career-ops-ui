...
[![tests](https://img.shields.io/badge/tests-2465%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.180.0** — **Raporty jako tabela** — `#/reports` to teraz tabela (Raport · Data · Wiarygodność · Wynik); długi chip „Nie wykryto wyniku" nie łamie już nazwy po znaku, a odzyskano prawdziwy wynik ukrywany przez symbol zastępczy Machine Summary. **2465 testów.**
>
