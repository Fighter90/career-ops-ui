...
[![tests](https://img.shields.io/badge/tests-2908%20passed-brightgreen)](#testy)
...
└─ web-ui/          ← to repozytorium
   ...
   └─ tests/        # 2908 testów jednostkowych + 101 Playwright + 44 e2e
```
...
```bash
npm test                    # 2908 testów jednostkowych/integracyjnych
