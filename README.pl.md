...
[![tests](https://img.shields.io/badge/tests-2364%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.142.0** — **poprawka: koniec z archetypem „Unknown"** — `#/orientation` zawsze klasyfikuje teraz spośród ośmiu nazwanych wektorów kariery zamiast czasem odpowiadać „Unknown" i doradzać „postawienie na niego" (ograniczenie promptu AI). **2364 testów.**
>
