...
[![tests](https://img.shields.io/badge/tests-2775%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.221.0** — **Utwardzenie przeciw DNS-rebinding** — skaner odrzuca teraz każde źródło, którego host rozwiązuje się na adres prywatny/loopback/metadanych chmury (np. `169.254.169.254`) — obrona w głąb ponad istniejące zabezpieczenia SSRF. **2775 testów.**
>
