...
> **🆕 Najnowsze wydanie — v1.232.1** — **Zapis na `#/config` zapisywał pola nigdy niedotknięte.** Wartość wstawiona do *pokazania* szła jako wybór użytkownika: zmiana jednej listy wysyłała **28 kluczy i przypinała 18**. Porównanie z `cfg.values` nie wystarcza; teraz porównujemy z tym, **czym zasiano każdą kontrolkę**. Liczba zapisanych kluczy wróciła do powiadomienia. **3018 testów · 111 przeglądarkowych.**
