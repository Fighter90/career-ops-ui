...
[![tests](https://img.shields.io/badge/tests-2837%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.227.0** — **Hongkong i celniejsze follow-upy** — JobsDB Hongkong dołącza do Jobstreet/SEEK (już na API v5), tablica kadencji zyskuje filtr tylko wymagających, a poufni pracodawcy pokazują agencję, która ich reprezentowała — parytet z 1.30.0 projektu nadrzędnego. **2837 testów.**
