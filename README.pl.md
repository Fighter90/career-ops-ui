...
[![tests](https://img.shields.io/badge/tests-2768%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.219.0** — **Torre dołącza do skanera** — latynoamerykański rynek talentów (torre.ai) to nowe źródło skanowania (łącznie **83**), plus poprawka paginacji a16z oraz poprawne etykiety + monogramy dostawców wszędzie. **2768 testów.**
>
