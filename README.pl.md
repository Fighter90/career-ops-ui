...
> **🆕 Najnowsze wydanie — v1.207.2** — **Plany AI znów renderują się poprawnie** — plan rozwoju i profil orientacji nie pokazują się już jako zrzut kodu o stałej szerokości, gdy model zawija całą odpowiedź w ogrodzenie ```markdown. **2621 testów.**
>
