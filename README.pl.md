...
[![tests](https://img.shields.io/badge/tests-2557%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.200.0** — **Sprawdzenie „czy nadal aktualna?" dla ofert ATS** — na #/tracker jedno kliknięcie odpytuje publiczny JSON oferty Greenhouse/Lever/Ashby/Workday/SmartRecruiters (zero tokenów, bez przeglądarki) i pokazuje **Aktualna / Wygasła / Nieznana**. **2557 testów.**
>
