...
[![tests](https://img.shields.io/badge/tests-2370%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.144.0** — **ustawienia i filtry (Faza 4): włączanie/wyłączanie śledzonych portali** — włącz lub wyłącz obserwowaną firmę z `#/portals` (`POST /api/portals/toggle`, chirurgiczny zapis portals.yml); skaner już pomija firmy `enabled: false`. **2370 testów.**
>
