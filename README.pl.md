...
[![tests](https://img.shields.io/badge/tests-2458%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.179.0** — **Konsolidacja dekoderów** — 20 zduplikowanych dekoderów encji HTML w źródłach skanowania przechodzi teraz przez jeden wspólny moduł (−237 linii), ze strażnikiem przeciw ponownej duplikacji. Zachowuje zachowanie. **2458 testów.**
>
