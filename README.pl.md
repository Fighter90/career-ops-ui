...
[![tests](https://img.shields.io/badge/tests-2563%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.201.0** — **Zlokalizowane nagłówki śledzenia nie są już puste** — `data/applications.md` z nieangielskimi lub wariantowymi nagłówkami (`empresa`/`estado`, `position`/`stage`/`link`…) jest teraz mapowany na kanoniczne pola. **2563 testów.**
>
