...
[![tests](https://img.shields.io/badge/tests-2372%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.145.0** — **wnikliwe statystyki (cd.): przebudowywalny wykres** — karta trendu ról `#/stats` zyskuje widżet **Zbuduj wykres**: wybierz metrykę (oferty / mediana / średnia) × wymiar (wg kraju / wg roli), odrys na żywo. **2372 testów.**
>
