...
> **🆕 Najnowsze wydanie — v1.227.2** — **Poprawka wąskich ekranów** — `#/config` nie przewija się już w bok przy ≤ 352 px: 18 selectów miało inline'owy `min-width: 300px`, który nie mógł się skurczyć. Teraz pod bramką przebiegu Playwright przy 320 px. **2846 testów · 101 Playwright.**
