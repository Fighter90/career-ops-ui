...
[![tests](https://img.shields.io/badge/tests-2448%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.174.0** — **Oceny w zlokalizowanych raportach + poprawka SEO** — raporty nieanglojęzyczne nie pokazują już „Score not detected" (H1 ze słowem etykiety był mylony z oceną); odznaki wiarygodności usuwają zbędne `**`, długie oceny nie wychodzą poza kartę, a opis cvstart.org liczy realny rejestr (~75). **2448 testów.**
>
