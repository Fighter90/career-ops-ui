...
[![tests](https://img.shields.io/badge/tests-2522%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.196.0** — **Utwardzenie endpointu Workday** — `api:` Workday w `portals.yml` jest teraz walidowane po **nazwie hosta**, nie po podciągu, więc spreparowany URL jak `https://evil.com/?x=myworkdayjobs.com` już nie przejdzie jako cel fetch. Zgłoszone przez CodeQL (#443). **2522 testów.**
>
