...
[![tests](https://img.shields.io/badge/tests-2644%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.210.1** — **Poprawka tytułów Habr** — tytuły ofert i nazwy firm z „&" lub cudzysłowami są teraz dekodowane, więc nie znikają już z twojego filtra ani nie trafiają zniekształcone do trackera. **2644 testów.**
>
