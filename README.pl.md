...
[![tests](https://img.shields.io/badge/tests-2779%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.222.0** — **Zlokalizowane podpowiedzi dostawców** — podpowiedzi klucza, modelu i bazowego URL rozszerzonych dostawców (DeepSeek … Volcengine Ark) w Ustawienia → Klucze API są teraz przetłumaczone na 17 języków, nie tylko po angielsku. **2779 testów.**
>
