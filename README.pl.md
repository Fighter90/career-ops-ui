...
[![tests](https://img.shields.io/badge/tests-2771%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.220.0** — **Get on Board, wiele kategorii** — jeden wpis może teraz skanować `programming`, `operations-management`, `machine-learning-ai`, … (deduplikacja po URL, limit 12), by wyszukiwania EM/data nie pomijały ról, które tablica rozdziela. **2771 testów.**
>
