...
> **🆕 Najnowsze wydanie — v1.205.0** — **Dziennik umiejętności** — zapisz samoocenę (firma, platforma, umiejętność, wynik %, notatka) w Analityka → Dziennik umiejętności; dopisuje do `data/assessments.tsv` i pokazuje wcześniejsze wpisy. Bez tokenów; zapis chroniony przed znakami kontrolnymi (brak wstrzyknięcia TSV). **2610 testów.**
>
