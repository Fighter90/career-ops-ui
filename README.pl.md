...
[![tests](https://img.shields.io/badge/tests-2504%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.191.0** — **Czego się dalej uczyć** — nowa zakładka `#/stats` porządkuje brakujące umiejętności, które najczęściej topią Twoje niskie dopasowania (ważone, poziomy Critical/High/Medium) — byś wiedział, czego uczyć się najpierw. **2504 testów.**
>
