...
[![tests](https://img.shields.io/badge/tests-2497%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.188.0** — **Przyciski znów oddychają** — główny przycisk akcji na stronach akcji (przegląd rozmów, finansowane firmy, portale, plan kariery, orientacja zawodowa) nie przylega już do podtytułu; ma teraz odpowiedni górny margines. **2497 testów.**
>
