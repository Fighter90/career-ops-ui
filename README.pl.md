...
[![tests](https://img.shields.io/badge/tests-2481%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.185.0** — **Zakładka „Lejek i tempo"** — wskaźniki odpowiedzi i rozmów obok rynkowych punktów odniesienia, lista oczekujących zablokowanych aplikacji i mediana dni na etap — wszystko z twojego trackera, tylko do odczytu. **2481 testów.**
>
