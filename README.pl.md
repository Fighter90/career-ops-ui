...
[![tests](https://img.shields.io/badge/tests-2479%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.184.0** — **Równa siatka Pulpitu** — kafelki szybkich akcji używają teraz kolumn o równej szerokości, więc grupa 3 nie jest już szersza niż grupa 4, a każda sekcja wyrównuje się do prawej. **2479 testów.**
>
