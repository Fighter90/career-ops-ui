...
[![tests](https://img.shields.io/badge/tests-3021%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.233.1** — **Przewodnik nigdy nie opisał kontrolki dodanej w v1.233.0.** Każda lista rozwijana zaczyna się teraz od „Użyj wartości domyślnej (…)”, wyrażając stan, którego interfejs nie umiał pokazać: **klucz nieustawiony**. Znika też wiersz z `### Recognized keys`, który nie nazywał żadnego klucza i radził rejestrację na dev.hh.ru — bezużyteczną od **v1.65.0** — wraz z dwiema równie przestarzałymi wzmiankami. `tests/help-recognized-keys.test.mjs` to brakująca bramka. **3021 testów · 116 przeglądarkowych.**
