...
[![tests](https://img.shields.io/badge/tests-2485%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.186.0** — **Panel „Luka kompetencji" w CV Studio** — wybierz zapisany opis stanowiska i zobacz, które z wymaganych umiejętności twoje CV wymienia, tylko sugeruje lub których brakuje — bez LLM, nic nie zapisywane. **2485 testów.**
>
