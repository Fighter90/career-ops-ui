...
[![tests](https://img.shields.io/badge/tests-2588%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.202.0** — **Znajduj tablice ATS z #/portals** — wpisz firmę, a aplikacja sprawdzi Greenhouse/Ashby/Lever pod kątem publicznej tablicy (zero LLM, bez przeglądarki, bezpiecznie wobec SSRF); jedno kliknięcie dodaje ją do śledzonych firm. **2588 testów.**
>
