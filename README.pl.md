...
[![tests](https://img.shields.io/badge/tests-2492%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.187.0** — **`skip_tiers` znów działa** — lista `skip_tiers: [intern, entry]` w `portals.yml` teraz odrzuca oferty według poziomu podczas skanu (wcześniej po cichu ignorowana). **2492 testów.**
>
