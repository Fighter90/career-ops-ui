...
[![tests](https://img.shields.io/badge/tests-2602%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.204.0** — **„Doktor konfiguracji" w Ustawieniach** — sprawdzenie bez tokenów `cv.md` + `config/profile.yml`, wypisujące problemy blokujące i ostrzeżenia (dane przykładowe, zaszyte metryki), byś naprawił niekompletną konfigurację, zanim osłabi skany i dopasowania. **2602 testów.**
>
