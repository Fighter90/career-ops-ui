...
[![tests](https://img.shields.io/badge/tests-2451%20passed-brightgreen)](#testy)
...
> **🆕 Najnowsze wydanie — v1.175.0** — **Strażnik regresji opisu SEO** — test CI zawodzi teraz, jeśli którykolwiek z 17 języków witryny utraci placeholder `{adapters}` lub ponownie zakoduje liczbę (dryf stojący za błędem "~55"), plus odporny na nulle strip wiarygodności. **2451 testów.**
>
