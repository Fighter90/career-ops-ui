...
> **🆕 Ultima release — v1.227.0** — **Hong Kong e follow-up più mirati** — JobsDB Hong Kong si aggiunge a Jobstreet/SEEK (ora sull'API v5), un filtro solo in scadenza sulla bacheca della cadenza e i datori di lavoro riservati mostrano l'agenzia che li ha presentati — parità con la 1.30.0 del progetto padre. **2837 test.**
