...
> **🆕 Ultima release — v1.221.0** — **Irrobustimento anti-DNS-rebinding** — lo scanner ora rifiuta qualsiasi sorgente il cui host si risolve a un indirizzo privato/loopback/di metadati cloud (es. `169.254.169.254`) — difesa in profondità oltre le protezioni SSRF esistenti. **2775 test.**
>
