...
> **🆕 Ultima release — v1.100.0**
>
> **Compilazione automatica IA del two-pager + esportazione.** Il two-pager (`#/two-pager`) ora si compila dal tuo CV + profilo tramite il provider configurato (senza inventare nulla; ripiego copia-il-prompt senza chiave), aggiunge una vista **Anteprima ed esporta** e ottiene l'esportazione in **PDF / DOCX / Markdown** — DOCX tramite un nuovo generatore `.docx` senza dipendenze, collegato anche ai report di mercato, piano di carriera e orientamento.
>
> _compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
