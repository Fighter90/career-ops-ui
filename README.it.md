...
> **🆕 Ultima release — v1.214.0** — **Le descrizioni alimentano il filtro di contenuto + seniority più intelligente** — gli annunci Greenhouse / Ashby / Recruitee ora sono filtrabili per contenuto, e "Associate <titolo senior>" (inclusi i ranghi accademici) è classificato come senior anziché entry-level. **2736 test.**
>
