...
> **🆕 Ultima release — v1.192.0** — **Verifica i fatti del tuo CV** — un nuovo controllo in `#/cv-studio` verifica un CV o una lettera su misura rispetto al tuo CV/profilo/two-pager reali e segnala ogni metrica inventata o affermazione non supportata (pass/warn/block). **2508 test.**
>
