...
> **🆕 Ultima release — v1.212.1** — **Fix del conteggio fonti della landing** — cvstart.org elencava 80 fonti e scartava Job Bank (Canada) dopo la v1.212.0; torna a 81 in sincronia con l'app, e la build del sito ora fallisce duramente a ogni scostamento del conteggio. **2687 test.**
>
