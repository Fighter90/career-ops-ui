...
> **🆕 Ultima release — v1.197.0** — **Segui una bacheca Getro con la sola URL** — fornisci a una bacheca Getro seguita la sua `careers_url` e l'id numerico della collezione ora **si risolve automaticamente** dalla pagina (una richiesta sicura contro l'SSRF), senza ricerca manuale. **2527 test.**
>
