...
> **🆕 Ultima release — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** una nuova pagina **`#/mock-interview`** conduce una simulazione di colloquio turno per turno contro un ruolo concreto. Ogni risposta riceve **feedback STAR+R**, un **punteggio** e una **domanda di follow-up** — ancorati al tuo CV, al two-pager e alla story bank. Gira live con qualsiasi chiave LLM oppure restituisce un prompt da copiare-incollare, e puoi **salvare le trascrizioni** per azienda/ruolo. Si basa su v1.89.0 (fit di mercato con il two-pager), v1.88.0 (i18n di Scan + igiene dell'API) e v1.87.0 (4 nuovi provider di scansione).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · colloquio simulato · fit di mercato con il two-pager · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
