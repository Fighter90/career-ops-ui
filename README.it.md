...
> **🆕 Ultima release — v1.108.0**
>
> **Rafforzamento della sicurezza (triage CodeQL, round 2).** Il costruttore di prompt risolve la riga di ruolo per chiave propria + `typeof === function`, lo slug del nome file PDF è limitato prima del suo regex (ReDoS polinomiale), e l'importazione documenti forza un `filename` array a stringa (type-confusion). Su v1.106–v1.108 l'arretrato dell'analisi statica è passato da 167 a ~14, ogni risultato reale corretto e il resto respinto con motivazione.
>
