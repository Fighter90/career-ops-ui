...
> **🆕 Ultima release — v1.211.0** — **Yourator + decodifica più precisa** — una nuova job board tech taiwanese, e le entità accentate di titolo/azienda (`D&eacute;veloppeur`) ora si decodificano ovunque e i nomi azienda accentati corrispondono al proprio dominio. **2667 test.**
>
