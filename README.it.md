...
> **🆕 Ultima release — v1.227.5** — **La scansione regionale non esaurisce più la memoria** — tratteneva tutti i risultati grezzi delle 21 query fino alla fine (742 MB contro il tetto di 490 MB della macchina, 4 cadute del servizio in un giorno); ora deduplica e filtra per query → **177 MB**. Più un flake di Playwright corretto. **2865 test.**
