...
> **🆕 Ultima release — v1.179.0** — **Consolidamento dei decoder** — 20 decoder di entità HTML duplicati nelle sorgenti di scansione ora passano per un unico modulo condiviso (−237 righe), con una guardia contro la ri-duplicazione. Preserva il comportamento. **2458 test.**
>
