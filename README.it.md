...
> **🆕 Ultima release — v1.178.0** — **Aggiornamento costanti (parità col padre)** — lo User-Agent del browser sale a Chrome 151 (parità dei gate WAF/bot) e il fallback degli stati del tracker riceve gli alias di stato turchi del padre. **2456 test.**
>
