...
> **🆕 Ultima release — v1.194.0** — **URL Workday a segmento singolo corretti** — pagine come `https://parsons.wd5.myworkdayjobs.com/Search` (un segmento) ora puntano al feed di offerte giusto invece di ripiegare su `External`. Segnalato in #255. **2517 test.**
>
