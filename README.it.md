...
> **🆕 Ultima release — v1.148.0** — **Filtri di ricerca più chiari** — il pannello dei filtri di `#/scan` è ora una griglia responsiva ordinata (prima un flex-wrap irregolare), con Applica / Reimposta su una riga dedicata allineata a destra. Stessi filtri, più leggibili. **2381 test.**
>
