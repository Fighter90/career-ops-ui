...
> **🆕 Ultima release — v1.189.0** — **`skip_tiers` ora parla ogni lingua** — il classificatore di livello legge i numeri romani (I/II/III/IV/V) dopo la parola del ruolo in qualsiasi scrittura ("Инженер III", "エンジニア I", "Ingénieur IV"), non solo dopo parole ASCII; prima cadevano su "mid" e sfuggivano a `skip_tiers`. **2498 test.**
>
