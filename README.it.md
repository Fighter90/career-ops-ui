...
> **🆕 Ultima release — v1.205.0** — **Registro competenze** — annota un'autovalutazione (azienda, piattaforma, competenza, punteggio %, nota) in Analisi → Registro competenze; si aggiunge a `data/assessments.tsv` ed elenca le voci precedenti. Zero token; scrittura protetta dai caratteri di controllo (nessuna iniezione TSV). **2610 test.**
>
