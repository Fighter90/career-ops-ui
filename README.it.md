...
> **🆕 Ultima release — v1.227.4** — **Fix dei prefissi, parte 2** — `word:` / `stem:` erano ancora ignorati da `content_filter`; la v1.227.3 aveva collegato solo il filtro sui titoli. Trovato in revisione IA. **2858 test.**
