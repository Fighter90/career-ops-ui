...
> **🆕 Ultima release — v1.84.0**
>
> **Cooldown di ricandidatura + retribuzione in pipeline.md** (parità con career-ops principale v1.15.0): la scansione EN ora **salta i ruoli presso aziende a cui ti sei candidato di recente** (`config/profile.yml → re_apply_windows:`, disattivato di default) così i risultati restano focalizzati sulle nuove posizioni, e le offerte scansionate salvano la loro **retribuzione** come colonna opzionale `url | <comp>` in `data/pipeline.md`. Si basa su v1.83.0 (rilevatore di ripubblicazioni), v1.82.0 (NoDesk) e v1.81.0 (13 nuove fonti).
>
> _13 lingue · 6 provider LLM · 41 adattatori di scansione · rilevatore di ripubblicazioni · cooldown di ricandidatura · parità con career-ops principale v1.15.0._
