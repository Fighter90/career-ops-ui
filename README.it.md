...
> **🆕 Ultima release — v1.203.0** — **Suggerimento "riutilizzare un CV precedente?" in CV Studio** — un annuncio salvato è confrontato con gli altri (deterministico, zero token) per dirti se riutilizzare un CV su misura, riutilizzarlo con modifiche o prepararne uno nuovo. **2594 test.**
>
