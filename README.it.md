...
> **🆕 Ultima release — v1.225.0** — **Banner dei loghi dei provider** — un banner di tutti i 18 provider LLM — loghi reali per 11, monogramma per 7 — apre ora il README e la guida. **2784 test.**
