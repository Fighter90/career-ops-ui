...
> **🆕 Ultima release — v1.107.0**
>
> **Rafforzamento del sanitizzatore (XSS a riposo).** Il sanitizzatore di markdown di CV/annuncio ora rimuove l'HTML pericoloso **fino a un punto fisso** (per intercettare una rimozione che riforma un payload), corrisponde ai tag di chiusura script/style con residui (`</script foo>`) e rimuove un apertore eseguibile non chiuso. Difesa in profondità dietro il client con escape-al-rendering; chiude i risultati CodeQL corrispondenti.
>
> _rafforzamento del sanitizzatore · rafforzamento della sicurezza · uso e costo IA · logo aziendali · strumenti CLI IA · chiedi alla guida · adatta CV + lettera · compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
