...
> **🆕 Ultima release — v1.177.0** — **Replay dei cookie csod (parent #2769)** — i tenant Cornerstone che proteggono l'API di ricerca con cookie di sessione (401 → 0 offerte) ora funzionano: il `Set-Cookie` del bootstrap viene ripetuto come header `Cookie` sul POST di ricerca, solo stessa origine. **2454 test.**
>
