...
> **🆕 Ultima release — v1.201.0** — **Le intestazioni di tracker localizzate non appaiono più vuote** — un `data/applications.md` con intestazioni non inglesi o varianti (`empresa`/`estado`, `position`/`stage`/`link`…) ora si ripiega sui campi canonici. **2563 test.**
>
