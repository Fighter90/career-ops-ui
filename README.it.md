...
> **🆕 Ultima release — v1.198.0** — **Ritentativi di scansione più intelligenti** — quando una bacheca limita la frequenza (HTTP 429/5xx) durante una scansione, i ritentativi usano ora **backoff esponenziale + jitter** e rispettano un `Retry-After` (limitato) invece di un ritardo breve fisso. **2536 test.**
>
