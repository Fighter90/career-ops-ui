...
> **🆕 Ultima release — v1.86.0**
>
> **Statistiche per ruoli target** (`#/stats`): una nuova pagina Analytics legge i tuoi **ruoli target dal profilo** (non cablati nel codice) e la tua scansione più recente per tracciare **posizioni aperte e stipendio mediano per paese**, con filtri per ruolo/paese e un **trend da snapshot salvati** — aggregati lato client dai dati sparsi che gli scanner già raccolgono (nessun numero inventato), in tutte le 16 lingue. Si basa su v1.85.0 (locale tedesco/italiano/turco), v1.84.0 (cooldown di ricandidatura) e v1.83.0 (rilevatore di ripubblicazioni).
>
> _16 lingue · 6 provider LLM · 41 adattatori di scansione · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
