...
> **🆕 Ultima release — v1.93.0**
>
> **Livello di memoria (Epic 24):** una nuova pagina **`#/memory`** conserva una breve nota modificabile «ricorda questo su di me». Poiché è inserita nel contesto di progetto condiviso, orienta **ogni** richiesta AI — valutazione, colloquio simulato, networking, CV Studio — su **tutti** i provider. Cattura le tue preferenze e il tuo stile di lavoro (mai nuovi fatti su di te), e un helper **suggerisci-dai-tuoi-dati** abbozza punti elenco comportamentali dal tuo tracker da rivedere. Si basa su v1.92.0 (CV Studio), v1.91.0 (pianificatore di networking) e v1.90.0 (colloquio simulato).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
