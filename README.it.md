...
> **🆕 Ultima release — v1.175.0** — **Guardia di regressione della descrizione SEO** — un test CI ora fallisce se una delle 17 lingue del sito perde il placeholder `{adapters}` o rifissa un conteggio (la deriva dietro il bug "~55"), più uno strip di legittimità sicuro ai nulli. **2451 test.**
>
