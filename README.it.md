...
> **🆕 Ultima release — v1.105.0**
>
> **Pagina uso e costo IA.** Una nuova pagina **Uso IA** mostra quanti token hai speso in generazioni IA live, per provider, su 24h / 7g / 30g / sempre, con un costo stimato in USD. Ogni chiamata live aggiunge un record `{provider, in, out}` a `data/llm-usage.jsonl` (nulla lascia la tua macchina); i dollari vengono da una tabella prezzi modificabile per provider — i token sono esatti, l'USD è una stima, mai fatturata.
>
> _uso e costo IA · logo aziendali · strumenti CLI IA · chiedi alla guida · adatta CV + lettera · compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
