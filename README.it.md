...
> **🆕 Ultima release — v1.172.0** — **Correzione del crash del decoder di entità HTML** — un'entità numerica malformata (es. `&#99999999;`) poteva sollevare un `RangeError` e interrompere una sorgente di scansione; un decoder condiviso ora limita i riferimenti numerici all'insieme Char di XML 1.0 (parità career-ops #2150). **2444 test.**
>
