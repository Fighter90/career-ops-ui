...
> **🆕 Ultima release — v1.174.0** — **Punteggi dei report localizzati + fix SEO** — i report non inglesi non mostrano più "Score not detected" (un H1 con la parola dell'etichetta veniva scambiato per il punteggio); i chip di legittimità rimuovono i `**` residui, i punteggi lunghi non escono dalla card e la descrizione di cvstart.org conta il registro reale (~75). **2448 test.**
>
