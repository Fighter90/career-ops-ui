...
> **🆕 Ultima release — v1.173.0** — **Hermes entra nel rilevatore di CLI di IA** — la scheda `#/config` "Strumenti CLI di IA" ora rileva Hermes (Nous Research), il nuovo runtime di agente del progetto padre; scansione di PATH in sola lettura, 11 strumenti. **2444 test.**
>
