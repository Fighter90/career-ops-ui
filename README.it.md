...
> **🆕 Ultima release — v1.188.0** — **I pulsanti respirano di nuovo** — il pulsante d'azione principale nelle pagine d'azione (riepilogo colloqui, aziende finanziate, portali, piano di carriera, orientamento professionale) non è più attaccato al sottotitolo; ora ha un margine superiore adeguato. **2497 test.**
>
