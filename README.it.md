...
> **🆕 Ultima release — v1.204.0** — **"Dottore di configurazione" nelle Impostazioni** — un controllo a zero token del tuo `cv.md` + `config/profile.yml` che elenca problemi bloccanti e avvisi (dati di esempio, metriche fisse), per correggere una configurazione incompleta prima che indebolisca scansioni e adattamenti. **2602 test.**
>
