...
> **🆕 Ultima release — v1.215.0** — **Eseguilo da OpenWorker** — un nuovo coworker IA senza codice esegue tutta la tua ricerca di lavoro (e avvia questa dashboard) dall'app OpenWorker di Andrew Ng; la guida in-app e l'assistente Chiedi ai docs ora lo coprono, in tutte le 17 lingue. **2742 test.**
>
