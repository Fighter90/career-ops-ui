...
> **🆕 Ultima release — v1.95.0**
>
> **Piano di carriera (Epic 26):** una nuova pagina **`#/career-plan`** trasforma il tuo CV e il tuo profilo in un piano di sviluppo concreto e personalizzato. Scegli un **orizzonte** (6/12/24 mesi) e un focus opzionale, e il modello scrive un'istantanea del punto di partenza, una SWOT di punti di forza/crescita, obiettivi come **SMART / OKR / WOOP**, traiettorie alternative, un piano di competenze hard/soft, una **roadmap mese per mese**, monitoraggio dei progressi, insidie e mosse di supporto — radicato nei tuoi materiali, senza mai inventare la tua storia. Modificalo inline, **Salvalo** nel livello utente ed esportalo in **Markdown o PDF**. Si basa su v1.94.0 (rielaborazione delle statistiche) e v1.93.0 (livello di memoria).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
