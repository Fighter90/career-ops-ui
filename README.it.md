...
> **🆕 Ultima release — v1.176.0** — **Parsing del punteggio (FIND-5)** — un punteggio sotto un'etichetta in grassetto che la tabella RU non elenca (`**Итоговый балл:**`, `**Скор:**`) ora viene colto dalla forma di valore `X.X / 5` — indipendente dalla lingua, al sicuro da intestazioni e date. **2453 test.**
>
