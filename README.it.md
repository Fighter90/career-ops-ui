...
> **🆕 Ultima release — v1.171.0** — **Token scala tipografica + z-index (D-4, primo passo)** — introdotti `--font-size-*` e livelli `--z-*`; migrato ogni letterale z-index (valori preservati) e le dimensioni centrali usano la rampa. Nessun cambiamento di pixel. **2437 test.**
>
