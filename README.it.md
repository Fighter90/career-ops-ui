...
- **Multi-CLI:** si guida in modo identico da Claude Code, Codex, Cursor, Aider o Gemini CLI — gli shim `CLAUDE.md` / `AGENTS.md` / `GEMINI.md` puntano a un'unica fonte di verità.
