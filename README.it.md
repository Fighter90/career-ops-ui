...
> **🆕 Ultima release — v1.102.0**
>
> **Chiedi alla guida — una chat di aiuto fondata.** Una nuova pagina **Chiedi alla guida 💬** risponde alle domande d'uso usando **solo** la guida di aiuto dell'app nella tua lingua (mostra le sezioni usate e non legge mai il tuo CV o la tua ricerca di lavoro). Recupero per parole chiave senza dipendenze sulle sezioni `##` della guida; il modello risponde da esse o ammette che la guida non lo copre. In tempo reale con una chiave LLM, o un prompt da copiare senza.
>
> _chiedi alla guida · adatta CV + lettera · compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
