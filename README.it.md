...
> **🆕 Ultima release — v1.187.0** — **`skip_tiers` funziona di nuovo** — un elenco `skip_tiers: [intern, entry]` in `portals.yml` ora scarta le offerte per livello durante una scansione (prima ignorato in silenzio). **2492 test.**
>
