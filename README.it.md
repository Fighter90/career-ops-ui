...
> **🆕 Ultima release — v1.193.0** — **Silenzio dopo il colloquio** — una nuova scheda `#/stats` elenca i colloqui rimasti in silenzio oltre una finestra di cortesia (30 giorni di default) — con da quanto ciascuno è in silenzio e la data dell'ultimo colloquio. **2510 test.**
>
