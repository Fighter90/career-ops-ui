...
> **🆕 Ultima release — v1.163.0** — **L'aiuto copre report → PDF (fix)** — l'assistente "Chiedi ai docs" diceva che la guida non copriva l'esportazione di un report in PDF, nonostante il pulsante 📄 Generate PDF su `#/reports/:slug`. Aggiunta una sezione "Esportare un report in PDF" a tutti i 17 bundle di aiuto. **2420 test.**
>
