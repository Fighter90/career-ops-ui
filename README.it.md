...
> **🆕 Ultima release — v1.214.2** — **Fix pulizia HTML** — una descrizione con `>` dentro un attributo HTML (es. `title="salary > 100k"`) non fa più trapelare il testo di attributo finale nella descrizione Greenhouse / Recruitee letta da un filtro di contenuto. **2742 test.**
>
