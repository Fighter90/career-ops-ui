...
> **🆕 Ultima release — v1.220.0** — **Get on Board, più categorie** — una voce può ora scansionare `programming`, `operations-management`, `machine-learning-ai`, … (deduplicato per URL, limite 12) così le ricerche EM/dati non perdono ruoli che la board separa. **2771 test.**
>
