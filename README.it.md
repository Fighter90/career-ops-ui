...
> **🆕 Ultima release — v1.85.0**
>
> **Locale tedesco, italiano e turco** (parità dei locale con career-ops principale v1.16.0): l'interfaccia ora è disponibile in **16 lingue** — Deutsch 🇩🇪, Italiano 🇮🇹 e Türkçe 🇹🇷 si aggiungono alle 13 esistenti, con traduzione completa della Guida in-app, del README e del CHANGELOG oltre a scaffolding localizzato dei prompt LLM. Si basa su v1.84.0 (cooldown di ricandidatura + retribuzione), v1.83.0 (rilevatore di ripubblicazioni) e v1.82.0 (NoDesk).
>
> _16 lingue · 6 provider LLM · 41 adattatori di scansione · rilevatore di ripubblicazioni · cooldown di ricandidatura · parità con career-ops principale v1.16.0._
