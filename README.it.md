...
> **🆕 Ultima release — v1.101.0**
>
> **CV Studio: adatta a un lavoro + lettera.** Una nuova scheda **Adatta a un lavoro** su `#/cv-studio` trasforma una descrizione di lavoro in un CV adattato più una lettera di presentazione coerente, poi li passa attraverso un **controllo** in stile recruiter (gli errori bloccano, gli avvisi consigliano). Distillato dalla pratica del career coaching in regole generiche — basato solo sul tuo CV, profilo e two-pager; non inventa mai. Esporta il risultato in Markdown / PDF / DOCX.
>
> _adatta CV + lettera · compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
