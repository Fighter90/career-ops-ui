...
> **🆕 Ultima release — v1.182.0** — **Fasce salariali neutre** — gli importi a un solo lato in scan e tracker ora appaiono come `≥` / `≤` (es. `≥ 120000 EUR`) invece di "from" / "up to" in inglese, così si leggono uguali in ogni lingua. **2470 test.**
>
