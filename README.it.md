...
> **🆕 Ultima release — v1.212.0** — **Job Bank (Canada) + fix** — la board federale del Canada ora è scansionabile, le board Consider restituiscono di nuovo risultati e le offerte Lever multi-sede mostrano tutte le sedi. (EchoJobs ritirata — il suo feed è bloccato da anti-bot.) **2685 test.**
>
