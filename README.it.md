...
> **🆕 Ultima release — v1.89.0**
>
> **Fit candidato-mercato — il two-pager (Epic 14):** una nuova pagina **`#/two-pager`** cattura ciò che _tu_ vuoi davvero dal tuo prossimo ruolo (ciò che ami, gli imprescindibili, ciò che odi, i deal-breaker, i punti non negoziabili) nel formato "two-pager di Mnookin". Un **assistente di compilazione IA** lo redige a partire dal tuo CV + profilo, ogni annuncio su `#/scan` riceve un punteggio **`◎` di fit-con-ciò-che-vuoi**, e il two-pager alimenta ogni valutazione. Si basa su v1.88.0 (i18n di Scan + igiene dell'API), v1.87.0 (4 nuovi provider di scansione) e v1.86.0 (statistiche per ruoli target).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · fit di mercato con il two-pager · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
