...
> **🆕 Ultima release — v1.223.0** — **Fix del badge di eval + installazione del coworker** — una ⚡ eval live riuscita non è più colorata di rosso, e il coworker OpenWorker si installa dal suo URL GitHub / .zip / un comando. **2783 test.**
>
