...
> **🆕 Ultima release — v1.149.0** — **Portali spostati nelle Impostazioni** — `#/portals` è ora nel gruppo **Setup** accanto a *Impostazioni app* (è una superficie di configurazione da v1.144.0), anziché in *Sourcing*. Solo modifica di navigazione. **2383 test.**
>
