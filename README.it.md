...
> **🆕 Ultima release — v1.202.0** — **Scopri bacheche ATS da #/portals** — digita un'azienda e l'app sonda Greenhouse/Ashby/Lever per la sua bacheca pubblica (zero LLM, nessun browser, sicuro da SSRF); un clic la aggiunge alle aziende monitorate. **2588 test.**
>
