...
> **🆕 Ultima release — v1.196.0** — **Irrobustimento dell'endpoint Workday** — un `api:` Workday in `portals.yml` è ora validato in base al suo **hostname**, non a una sottostringa, così un URL forgiato come `https://evil.com/?x=myworkdayjobs.com` non passa più come target di fetch. Segnalato da CodeQL (#443). **2522 test.**
>
