...
> **🆕 Ultima release — v1.111.0**
>
> **Sicurezza — chiusura del backlog CodeQL.** Tre rafforzamenti difesa-in-profondità chiudono i restanti rilievi dell'analisi statica alla fonte: il sanitizzatore del markdown del CV ora fa l'escape di qualsiasi apertura di tag pericoloso troncata, così che il suo output non possa mai contenere un `<script`/`<iframe` vivo; l'import del CV legge la dimensione del buffer tramite una coercizione numerica esplicita; e le righe di ruolo delle modalità sono stringhe template interpolate con `String.replace` invece di funzioni memorizzate, rimuovendo l'ultima chiamata a dispatch dinamico. Nessun cambiamento visibile.
>
> _chiusura backlog sicurezza · docs & QA ×16 · Escludi Scan · panoramica pipeline · rafforzamento della sicurezza 2 · rafforzamento del sanitizzatore · rafforzamento della sicurezza · uso e costo IA · logo aziendali · strumenti CLI IA · chiedi alla guida · adatta CV + lettera · compilazione auto del two-pager · esportazione DOCX · salute dei portali · segnalatore di bug integrato · 16 lingue · 6 provider LLM · 46 adattatori di scansione · orientamento professionale · piano di carriera · rielaborazione delle statistiche · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · parità con career-ops principale v1.16.0._
