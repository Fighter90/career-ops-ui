...
> **🆕 Ultima release — v1.91.0**
>
> **Networking e ricerca approfondita sull'azienda (Epic 16):** una nuova pagina **`#/networking`** trasforma un'azienda in un piano operativo — un **dossier aziendale**, **chi contattare** (persona + stringhe di ricerca LinkedIn), il **percorso di presentazione più caldo** e **bozze di outreach** su misura — il tutto ancorato al tuo CV e al two-pager. Gira live con qualsiasi chiave LLM oppure restituisce un prompt da copiare-incollare, e puoi **salvare i piani** per azienda. Si basa su v1.90.0 (colloquio simulato), v1.89.0 (fit di mercato con il two-pager) e v1.88.0 (i18n di Scan + igiene dell'API).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
