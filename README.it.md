...
> **🆕 Ultima release — v1.216.0** — **Altri nove provider LLM** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks e Ollama locale si aggiungono alla valutazione ⚡ dal vivo (ora **16 provider**), ciascuno con un monogramma di marca nelle Impostazioni. **2752 test.**
>
