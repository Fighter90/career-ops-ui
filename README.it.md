...
> **🆕 Ultima release — v1.222.0** — **Suggerimenti provider localizzati** — i suggerimenti di chiave, modello e URL base dei provider estesi (DeepSeek … Volcengine Ark) in Impostazioni → Chiavi API sono ora tradotti in tutte le 17 lingue, non più solo in inglese. **2779 test.**
>
