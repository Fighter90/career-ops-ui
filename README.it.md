...
> **🆕 Ultima release — v1.94.0**
>
> **Statistiche, rielaborate (Epic 25):** la pagina **`#/stats`** è ora una sezione **Statistiche** a tre schede, con grafici veri e molti più dati. Una nuova scheda **Report di mercato** genera un'analisi AI delle retribuzioni e del mercato del lavoro per i tuoi ruoli target — per livello con percentili P10–P90, principali datori di lavoro, competenze richieste, benefit, ripartizione remoto, tendenze e indicazioni per la negoziazione, nella regione e nella **valuta** che scegli (cifre etichettate come stime orientative del modello, mai estratte). Una nuova scheda **La mia pipeline** rappresenta il tuo tracker (punteggi, imbuto, principali aziende/ruoli, timeline, tassi di conversione). Ogni report si esporta in **Markdown o PDF**. Si basa su v1.93.0 (livello di memoria) e v1.92.0 (CV Studio).
>
> _Statistiche, rielaborate · 16 lingue · 6 provider LLM · 45 adattatori di scansione · livello di memoria · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
