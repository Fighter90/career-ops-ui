...
> **🆕 Ultima release — v1.191.0** — **Cosa imparare dopo** — una nuova scheda `#/stats` ordina le competenze mancanti che più spesso affondano le tue basse compatibilità (pesate, livelli Critical/High/Medium) — per sapere cosa studiare prima. **2504 test.**
>
