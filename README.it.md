...
> **🆕 Ultima release — v1.190.0** — **Quali aziende ti rispondono davvero?** — nuovo pannello **Cronologia azienda** su `#/tracker`: scegli un'azienda e vedi se è stata in silenzio, mista o ha già risposto — e se lo stesso ruolo viene ripubblicato — unendo tracker, follow-up e cronologia di scansione. **2501 test.**
>
