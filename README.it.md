...
> **🆕 Ultima release — v1.195.0** — **Rilevamento repost più veloce** — il rilevamento di duplicati non è più O(N²) su cronologie grandi; il raggruppamento dei titoli per azienda è ora un indice invertito. L'output è identico (dimostrato da un test differenziale), solo molto più veloce. **2521 test.**
>
