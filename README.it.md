...
> **🆕 Ultima release — v1.180.0** — **Report come tabella** — `#/reports` è ora una tabella (Report · Data · Legittimità · Punteggio); un lungo chip "Punteggio non rilevato" non spezza più il nome carattere per carattere, e viene recuperato un punteggio reale che un segnaposto di Machine Summary nascondeva. **2465 test.**
>
