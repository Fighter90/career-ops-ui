...
> **🆕 Ultima release — v1.92.0**
>
> **CV Studio (Epic 21):** una nuova pagina **`#/cv-studio`** offre al tuo CV tre strumenti onesti — la **diagnostica del curriculum** (un punteggio deterministico da 0 a 100 con spiegazioni per ogni controllo), una **maschera privacy** (oscura email/telefono/link/indirizzo/nome interamente nel browser) e **rendilo umano** (riscrive righe rigide nella _tua_ voce, ancorata alla tua voice-dna e ai tuoi campioni di scrittura, senza mai inventare fatti). Si basa su v1.91.0 (pianificatore di networking), v1.90.0 (colloquio simulato) e v1.89.0 (fit di mercato con il two-pager).
>
> _16 lingue · 6 provider LLM · 45 adattatori di scansione · CV Studio · pianificatore di networking · colloquio simulato · fit di mercato con il two-pager · statistiche di mercato per ruolo target · rilevatore di ripubblicazioni · parità con career-ops principale v1.16.0._
