...
- **Правки футера лендінгу** — неробоче посилання Discussions (функцію не ввімкнено в репозиторії) тепер веде на **вікі** проєкту, а у футері вказано автора: **Sergey Emelyanov** ([sergey-cv.com](https://sergey-cv.com/) · [LinkedIn](https://www.linkedin.com/in/sergey-emelyanov-in-job/)).
