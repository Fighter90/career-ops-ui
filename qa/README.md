...
**Baselines as of v1.233.1** — **3021** `node --test` · **101** Playwright ·
...
├── QA-REGRESSION-PROMPT-v1.233.1.md   ← the CURRENT release's delta driver
...
| File | Scope | When |
|---|---|---|
| **[`QA-REGRESSION-PROMPT-v1.233.1.md`](./QA-REGRESSION-PROMPT-v1.233.1.md)** | This release's delta: §0 exact `node --test` gates, what changed, the manual browser pass, contract/security invariants, what was deliberately not ported | Every release, before merge |
