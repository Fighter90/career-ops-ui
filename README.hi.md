...
> **🆕 नवीनतम रिलीज़ — v1.167.0** — **उठी सतहें हेयरलाइन से अलग (डिज़ाइन फ़िक्स)** — `--panel-2`/`--surface-elev1` किनारों वाले `--slate` में ही हल होते थे, बिना पृथक्करण। एक समर्पित थीम टोकन `--elev` अब उन्हें सहारा देता है। **2428 परीक्षण।**
>
