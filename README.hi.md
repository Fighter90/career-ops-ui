...
> **🆕 नवीनतम रिलीज़ — v1.121.0**
>
> **The CareerOps Manifesto + cvstart.org सेक्शन।** v1.120.0 (parent v1.20.0 parity) ने [the CareerOps Manifesto](https://career-ops.org/manifesto) को पूरे ऐप में सामने लाया — साइडबार-फ़ुटर लिंक, 16 भाषाओं में help §29, README सेक्शन। v1.121.0 [cvstart.org](https://cvstart.org) में चार सेक्शन जोड़ता है: **Methodology** (छह-आयामी स्कोरिंग रूब्रिक, [career-ops.org/methodology](https://career-ops.org/methodology) से), **Compare**, **License**, और **Changelog** (सभी 16 भाषाओं में), साथ ही docs और help गाइड में methodology लिंक्स।
>
