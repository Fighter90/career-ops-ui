...
> **🆕 नवीनतम रिलीज़ — v1.171.0** — **टाइप-स्केल + z-index टोकन (D-4, पहला चरण)** — `--font-size-*` और `--z-*` लेयर पेश; हर z-index लिटरल माइग्रेट (मान सुरक्षित), मुख्य फ़ॉन्ट आकार रैम्प का उपयोग। कोई पिक्सेल बदलाव नहीं। **2437 परीक्षण।**
>
