...
> **🆕 नवीनतम रिलीज़ — v1.187.0** — **`skip_tiers` फिर से काम करता है** — `portals.yml` में `skip_tiers: [intern, entry]` सूची अब स्कैन के दौरान वरिष्ठता स्तर से पोस्टिंग हटाती है (पहले चुपचाप अनदेखा होती थी)। **2492 परीक्षण।**
>
