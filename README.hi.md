...
> **🆕 नवीनतम रिलीज़ — v1.198.0** — **स्मार्ट स्कैन री-ट्राई** — जब कोई बोर्ड स्कैन के बीच थोड़ी देर रेट-लिमिट (HTTP 429/5xx) करता है, तो री-ट्राई अब निश्चित छोटी देरी के बजाय **एक्सपोनेंशियल बैकऑफ़ + जिटर** का उपयोग करते हैं और (सीमित) `Retry-After` का सम्मान करते हैं। **2536 परीक्षण।**
>
