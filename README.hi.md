...
- **Telegram चैनल (v1.228.0)** — कोई भी **सार्वजनिक** चैनल: उसे `telegram_channels:` ब्लॉक में सूचीबद्ध करें, और वह `t.me/s/<चैनल>` पूर्वावलोकन से पढ़ा जाता है — न बॉट टोकन, न API कुंजी। Telegram RSS प्रकाशित नहीं करता और Bot API उस चैनल को नहीं पढ़ सकता जिसका आपका बॉट प्रशासक नहीं है, इसलिए पूर्वावलोकन ही एकमात्र रास्ता है। **पोस्ट गद्य है, नौकरी का रिकॉर्ड नहीं**: शीर्षक पहली सारवान पंक्ति से, कंपनी और स्थान केवल स्पष्ट लेबल से, और असली रिक्तियों को विज्ञापन से अलग करना आपके `title_filter` का काम है।
...
├─ server/
│  ├─ index.mjs              # ~130 LOC ऑर्केस्ट्रेटर: middleware + 37 register<Topic>Routes(app) कॉल + SPA कैच-ऑल
│  └─ lib/
...
│     └─ routes/             # 37 राउट मॉड्यूल — प्रति टॉपिक एक (P-2)
...
## 📘 यह रिपॉज़िटरी एजेंट्स के साथ कैसे बनाई जाती है

इस प्रोजेक्ट का अधिकांश भाग कोडिंग एजेंट्स के साथ लिखा जाता है। यह अपनी खुद की विफलता-प्रवृत्तियों
वाली एक प्रैक्टिस है, इसलिए इसे जानबूझकर चलाया जाता है, किरिल मोकेवनिन (Kirill Mokevnin) की किताब
[**Agentic Coding Design Patterns**](https://mokevnin.github.io/agentic-coding-design-patterns/en/)
([रूसी संस्करण](https://mokevnin.github.io/agentic-coding-design-patterns/ru/)) का अनुसरण करते
हुए। नीचे दी गई फ़ाइलें उसी प्रैक्टिस का ठोस रूप हैं। इनमें से कोई भी चल रहे ऐप को प्रभावित नहीं
करती — ये इसलिए मौजूद हैं ताकि एक नया सेशन उन्हीं चीज़ों को दोबारा निकालने, दोबारा तय करने और
दोबारा बिगाड़ने के बजाय वहीं से आगे बढ़े जहाँ पिछला सेशन छोड़ गया था।
...
| **[`evals/workflow/`](evals/workflow/)** | ग्रेडर्स के साथ एक स्थिर टास्क-सेट, जो प्रोडक्ट के व्यवहार की नहीं बल्कि *पाइपलाइन* के व्यवहार की जाँच करते हैं। | किसी स्किल, प्रॉम्प्ट या टूल को बदलने से पहले और बाद में। |
| **[`.claude/skills/`](.claude/skills/)** | पैक किए गए वर्कफ़्लो। `parent-sync` एक पूरी पैरिटी रिलीज़ को नौ गेटेड चरणों में चलाता है। | किसी रिलीज़ को तात्कालिक रूप से बनाने के बजाय। |
| **[`.githooks/pre-commit`](.githooks/pre-commit)** | निष्पादन-योग्य गार्डरेल — एक निश्चयात्मक न्यूनतम स्तर जो कठोरता से विफल होता है, साथ ही एक सलाहकार AI परत जो कभी नहीं रोकती। | यह अपने-आप चलती है। |

### इनका उपयोग करना

इन दस्तावेज़ों को किसी सेटअप की ज़रूरत नहीं — ये सादा Markdown हैं, जिन्हें आप और एजेंट दोनों पढ़ते
हैं। दो चीज़ें जोड़ी हुई हैं और जानने लायक़ हैं:

```bash
# गार्डरेल: रिपॉज़िटरी-स्वामित्व वाले hooks, ताकि जाँचें सिर्फ़ आपकी मशीन पर नहीं बल्कि सबके लिए लागू हों।
git config core.hooksPath .githooks

# वर्कफ़्लो evals: docs/adr/ और PROGRESS.md के नियमों के आधार पर रिपॉज़िटरी की स्थिति को परखते हैं।
node evals/workflow/run.mjs              # सभी ग्रेडर्स
node evals/workflow/run.mjs --task qa-prompt-mandatory
```

`evals/workflow/tasks.yml` में हर ग्रेडर किसी ऐसी ग़लती से मेल खाता है जो कभी शिप हो चुकी थी — कोई
नष्ट हो चुका ऐतिहासिक श्रेय, फ़ैन-आउट के बीच में चलाया गया एक साइट बिल्ड, कोई छूटा हुआ no-port।
परिणाम और प्रक्रिया को अलग-अलग परखा जाता है, और जो ग्रेडर रिपॉज़िटरी से तय नहीं किया जा सकता वह
चुपचाप पास होने के बजाय `SKIP` रिपोर्ट करता है: जो जाँच चल ही नहीं सकती, उसे कभी हरी नहीं दिखना
चाहिए।

### इन्हें सही बनाए रखना

एक पुराना पड़ चुका शब्दकोश, कोई शब्दकोश न होने से भी बुरा है, इसलिए इन्हें लिखने का काम ख़ुद
रिलीज़ का ही हिस्सा है — `parent-sync` का चरण 0 इन्हें लोड करता है और चरण 8 जो कुछ सीखा गया उसे
वापस इनमें भेजता है। जिस कमिट में कोई संकल्पना पेश की जाए, उसी कमिट में `CONTEXT.md` में एक शब्द
जोड़ें; जब कोई चुनाव छह महीने बाद मनमाना लग सकता हो तो एक ADR खोलें; किसी अस्वीकृत तरीक़े को
अस्वीकार होते ही `PROGRESS.md` में दर्ज करें।

किताब के कौन-से पैटर्न यहाँ वाक़ई लागू किए गए हैं — और कौन-से नहीं — इसकी जाँच
[Agentic Practices](https://github.com/Fighter90/career-ops-ui/wiki/Agentic-Practices) विकी
पेज पर की जाती है।
