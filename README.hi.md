...
> **🆕 नवीनतम रिलीज़ — v1.192.0** — **अपने CV के तथ्य जाँचें** — `#/cv-studio` में एक नया गेट एक अनुकूलित CV या कवर लेटर को आपके असली CV/प्रोफ़ाइल/two-pager से मिलाता है और हर गढ़े गए मीट्रिक या असमर्थित दावे को चिह्नित करता है (pass/warn/block)। **2508 परीक्षण।**
>
