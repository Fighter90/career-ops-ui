...
**AI असिस्टेंट्स** जिनके भीतर career-ops चलता है (web-ui स्टैंडअलोन विकल्प है): Claude Code, Gemini CLI, Codex, Qwen Code, OpenCode, GitHub Copilot CLI, Antigravity CLI। web-ui की ⚡ लाइव फ़ीचर्स इन्हें **`#/config`** में API प्रोवाइडर्स से मैप करती हैं: Claude Code→Anthropic, Gemini CLI→Gemini, Codex→OpenAI, Qwen Code→Qwen, OpenCode→any/OpenRouter, GitHub Copilot CLI→GitHub Models, Antigravity CLI→Gemini।
