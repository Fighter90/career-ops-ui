...
> **🆕 नवीनतम रिलीज़ — v1.201.0** — **स्थानीयकृत ट्रैकर हेडर अब खाली नहीं दिखते** — गैर-अंग्रेज़ी या भिन्न हेडर (`empresa`/`estado`, `position`/`stage`/`link`…) वाली `data/applications.md` अब कैनोनिकल फ़ील्ड में मैप हो जाती है। **2563 परीक्षण।**
>
