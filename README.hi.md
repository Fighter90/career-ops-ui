...
> **🆕 नवीनतम रिलीज़ — v1.197.0** — **किसी Getro बोर्ड को केवल उसके URL से ट्रैक करें** — ट्रैक किए जा रहे Getro बोर्ड को उसका अपना `careers_url` दें, और संख्यात्मक कलेक्शन id अब बोर्ड पेज से **अपने-आप हल** हो जाता है (एक SSRF-सुरक्षित फ़ेच), बिना हाथ से खोजे। **2527 परीक्षण।**
>
