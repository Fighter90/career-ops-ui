...
> **🆕 नवीनतम रिलीज़ — v1.196.0** — **Workday एंडपॉइंट सख़्ती** — `portals.yml` में एक Workday `api:` अब सबस्ट्रिंग नहीं, बल्कि अपने **होस्टनेम** से सत्यापित होता है, इसलिए `https://evil.com/?x=myworkdayjobs.com` जैसा गढ़ा URL अब fetch लक्ष्य के रूप में पास नहीं होता। CodeQL द्वारा रिपोर्ट (#443)। **2522 परीक्षण।**
>
