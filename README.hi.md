...
> **🆕 नवीनतम रिलीज़ — v1.189.0** — **`skip_tiers` अब हर भाषा समझता है** — टियर वर्गीकरणकर्ता अब किसी भी लिपि में भूमिका शब्द के बाद रोमन अंक स्तर (I/II/III/IV/V) पढ़ता है ("Инженер III", "エンジニア I", "Ingénieur IV"), केवल ASCII शब्दों के बाद नहीं; पहले वे "mid" पर गिरकर `skip_tiers` से बच निकलते थे। **2498 परीक्षण।**
>
