...
> **🆕 नवीनतम रिलीज़ — v1.204.0** — **सेटिंग्स में "सेटअप डॉक्टर"** — `cv.md` + `config/profile.yml` की शून्य-टोकन जाँच जो अवरोधक समस्याएँ और चेतावनियाँ (उदाहरण डेटा, हार्डकोडेड मीट्रिक) सूचीबद्ध करती है, ताकि अधूरा सेटअप स्कैन और अनुकूलन कमज़ोर करने से पहले ठीक हो जाए। **2602 परीक्षण।**
>
