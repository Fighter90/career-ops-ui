...
> **🆕 नवीनतम रिलीज़ — v1.177.0** — **csod कुकी रीप्ले (parent #2769)** — जो Cornerstone टेनेंट सर्च API को सेशन कुकीज़ से सुरक्षित रखते हैं (401 → 0 नौकरियाँ) अब काम करते हैं: बूटस्ट्रैप पेज का `Set-Cookie` सर्च POST पर `Cookie` हेडर के रूप में दोबारा भेजा जाता है, केवल समान-मूल। **2454 परीक्षण।**
>
