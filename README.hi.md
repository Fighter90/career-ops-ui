...
**AI असिस्टेंट्स** जिनके भीतर career-ops चलता है (web-ui स्टैंडअलोन विकल्प है): Claude Code, Codex, OpenCode, Antigravity CLI, Grok Build CLI, Qwen Code, Kimi, GitHub Copilot CLI, Gemini CLI (legacy)। web-ui की ⚡ लाइव फ़ीचर्स इन्हें **`#/config`** में API प्रोवाइडर्स से मैप करती हैं: Claude Code→Anthropic, Gemini CLI→Gemini, Codex→OpenAI, Qwen Code→Qwen, OpenCode→any/OpenRouter, GitHub Copilot CLI→GitHub Models, Antigravity CLI→Gemini, Kimi CLI→any/OpenRouter, Grok Build CLI→any/OpenRouter।
...
- **मल्टी-CLI:** Claude Code, Codex, Cursor, Aider, या Gemini CLI से समान रूप से चलता है — `CLAUDE.md` / `AGENTS.md` / `GEMINI.md` शिम्स एक ही स्रोत-सत्य (single source of truth) की ओर इशारा करते हैं।
