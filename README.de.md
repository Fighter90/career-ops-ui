...
> **🆕 Neueste Version — v1.84.0**
>
> **Abklingzeit für Neubewerbungen + Vergütung in pipeline.md** (Parität mit dem übergeordneten career-ops v1.15.0): Der EN-Scan **überspringt nun Rollen bei Unternehmen, bei denen Sie sich kürzlich beworben haben** (`config/profile.yml → re_apply_windows:`, standardmäßig deaktiviert), sodass die Ergebnisse auf neue Stellen fokussiert bleiben, und gescannte Angebote speichern ihr **Gehalt** als optionale Spalte `url | <comp>` in `data/pipeline.md`. Baut auf v1.83.0 (Repost-Detektor), v1.82.0 (NoDesk) und v1.81.0 (13 neue Quellen) auf.
>
> _13 Sprachen · 6 LLM-Anbieter · 41 Scanner-Adapter · Repost-Detektor · Abklingzeit für Neubewerbungen · Parität mit dem übergeordneten career-ops v1.15.0._
