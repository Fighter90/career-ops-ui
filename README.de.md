...
> **🆕 Neueste Version — v1.91.0**
>
> **Networking & tiefe Unternehmensrecherche (Epic 16):** eine neue **`#/networking`**-Seite verwandelt ein Unternehmen in einen umsetzbaren Plan — ein **Unternehmensdossier**, **wen kontaktieren** (Personas + LinkedIn-Suchzeichenketten), der **wärmste Vorstellungspfad** und maßgeschneiderte **Outreach-Entwürfe** — alles verankert in deinem CV und deinem two-pager. Läuft live mit jedem LLM-Schlüssel oder liefert einen kopierfertigen Prompt, und du kannst **Pläne** pro Unternehmen speichern. Baut auf v1.90.0 (Mock-Interview), v1.89.0 (Markt-Fit über two-pager) und v1.88.0 (Scan-i18n + API-Hygiene) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
