...
> **🆕 Neueste Version — v1.89.0**
>
> **Kandidat-Markt-Fit — der two-pager (Epic 14):** eine neue **`#/two-pager`**-Seite hält fest, was _du_ von deiner nächsten Rolle wirklich willst (was du liebst, Must-haves, was du hasst, Deal-Breaker, Nicht-Verhandelbares) im Format „Mnookin two-pager". Ein **KI-Ausfüllassistent** entwirft ihn aus deinem CV + Profil, jede Anzeige auf `#/scan` erhält einen **`◎`-Score für Fit-mit-dem-was-du-willst**, und der two-pager speist jede Bewertung. Baut auf v1.88.0 (Scan-i18n + API-Hygiene), v1.87.0 (4 neue Scan-Anbieter) und v1.86.0 (Zielrollen-Statistik) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · Markt-Fit über two-pager · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
