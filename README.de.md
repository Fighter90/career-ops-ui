...
> **🆕 Neueste Version — v1.220.0** — **Get on Board, mehrere Kategorien** — ein Eintrag kann jetzt `programming`, `operations-management`, `machine-learning-ai`, … scannen (nach URL dedupliziert, auf 12 begrenzt), damit EM/Data-Suchen keine Rollen verpassen, die das Board aufteilt. **2771 Tests.**
>
