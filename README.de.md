...
> **🆕 Neueste Version — v1.227.2** — **Fix für schmale Displays** — `#/config` scrollt bei ≤ 352 px nicht mehr seitwärts: 18 Selects trugen ein Inline-`min-width: 300px`, das nicht schrumpfen konnte. Jetzt durch einen Playwright-Durchlauf bei 320 px abgesichert. **2846 Tests · 101 Playwright.**
