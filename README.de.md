...
> **🆕 Neueste Version — v1.214.2** — **HTML-Strip-Fix** — eine Beschreibung mit `>` in einem HTML-Attribut (z. B. `title="salary > 100k"`) leckt den nachfolgenden Attributtext nicht mehr in die Greenhouse- / Recruitee-Beschreibung, die ein Inhaltsfilter liest. **2742 Tests.**
>
