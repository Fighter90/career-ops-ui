...
> **🆕 Neueste Version — v1.174.0** — **Scores in lokalisierten Berichten + SEO-Fix** — nicht-englische Berichte zeigen kein „Score not detected" mehr (ein H1 mit dem Label-Wort wurde als Score missverstanden); Seriositäts-Chips entfernen übrige `**`, lange Scores laufen nicht mehr über die Karte, und die cvstart.org-Beschreibung zählt das echte Registry (~75). **2448 Tests.**
>
