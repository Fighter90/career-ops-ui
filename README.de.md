...
> **🆕 Neueste Version — v1.181.0** — **Getro: Gehalt & alle Standorte** — der Getro-Scanner zeigt jetzt ein Gehalt, vereint alle Standorte einer Stelle und erkennt `work_mode: remote` (Parität mit Eltern #2640). **2470 Tests.**
>
