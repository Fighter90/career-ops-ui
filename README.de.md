...
> **🆕 Neueste Version — v1.107.0**
>
> **Sanitizer-Härtung (XSS im Ruhezustand).** Der Lebenslauf-/Stellen-Markdown-Sanitizer entfernt gefährliches HTML jetzt **bis zu einem Fixpunkt** (um ein Entfernen zu erfassen, das eine Payload neu bildet), trifft script/style-Endtags mit nachfolgendem Müll (`</script foo>`) und entfernt einen ungeschlossenen ausführbaren Opener. Verteidigung in der Tiefe hinter dem Escape-beim-Rendern-Client; schließt die entsprechenden CodeQL-Funde.
>
> _Sanitizer-Härtung · Sicherheitshärtung · KI-Nutzung & Kosten · Firmenlogos · KI-CLI-Tools · Doku fragen · Lebenslauf-Anpassung + Anschreiben · Two-Pager-Autofüllung · DOCX-Export · Portal-Gesundheit · integrierter Fehlermelder · 16 Sprachen · 6 LLM-Anbieter · 46 Scanner-Adapter · Berufsorientierung · Karriereplan · Statistik-Überarbeitung · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Parität mit dem übergeordneten career-ops v1.16.0._
