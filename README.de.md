...
> **🆕 Neueste Version — v1.115.0**
>
> **Design-Feinschliff (konservativ, Korallen-Marke).** Eine leichte Verfeinerung des gemeinsamen Designsystems — ohne Umstrukturierung oder Palettenänderung: Metrikkarten heben sich beim Hover mit korallenem Rand, Buttons erhalten einen Ruheschatten und ein sanftes Anheben, große Zahlen richten sich per tabular-nums aus, und Steuerelemente bekommen einen weichen Korallen-Fokus-Halo. Bewegung respektiert prefers-reduced-motion.
>
