...
> **🆕 Neueste Version — v1.227.3** — **Die Titelfilter-Präfixe funktionieren jetzt** — `word:` / `stem:` wurden als wörtlicher Text verglichen, wodurch diese Zeilen wirkungslos blieben (eine `word:intern`-Regel filterte hier nichts und wirkte in der CLI). Aus dem übergeordneten Projekt portiert, samt Unicode-Grenzen. **2852 Tests.**
