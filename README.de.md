...
> **🆕 Neueste Version — v1.177.0** — **csod-Cookie-Replay (parent #2769)** — Cornerstone-Tenants, die die Such-API hinter Session-Cookies sperren (401 → 0 Jobs), funktionieren nun: das `Set-Cookie` der Bootstrap-Seite wird als `Cookie`-Header auf dem Such-POST erneut gesendet, nur gleicher Origin. **2454 Tests.**
>
