...
> **🆕 Neueste Version — v1.92.0**
>
> **CV Studio (Epic 21):** eine neue **`#/cv-studio`**-Seite gibt deinem Lebenslauf drei ehrliche Werkzeuge — **Lebenslauf-Diagnostik** (ein deterministischer 0–100-Score mit Erklärungen je Prüfung), eine **Datenschutz-Maske** (schwärzt E-Mail/Telefon/Links/Anschrift/Name vollständig im Browser) und **menschlich machen** (schreibt steife Zeilen in _deiner_ Stimme um, verankert in deiner voice-dna und deinen Schreibproben, ohne je Fakten zu erfinden). Baut auf v1.91.0 (Networking-Planer), v1.90.0 (Mock-Interview) und v1.89.0 (Markt-Fit über two-pager) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
