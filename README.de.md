...
> **🆕 Neueste Version — v1.180.0** — **Berichte als Tabelle** — `#/reports` ist jetzt eine Tabelle (Bericht · Datum · Legitimität · Bewertung); ein langer Chip „Bewertung nicht erkannt" bricht den Namen nicht mehr Zeichen für Zeichen um, und eine echte Bewertung, die ein Machine-Summary-Platzhalter verdeckte, wird wiederhergestellt. **2465 Tests.**
>
