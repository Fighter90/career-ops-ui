...
> **🆕 Neueste Version — v1.86.0**
>
> **Statistik nach Zielrollen** (`#/stats`): Eine neue Analytics-Seite liest deine **Zielrollen aus dem Profil** (nicht fest verdrahtet) und deinen letzten Scan, um **Stellen und Mediangehalt nach Land** zu visualisieren, mit Rollen-/Länderfiltern und einem **Trend aus gespeicherten Snapshots** — clientseitig aggregiert aus den spärlichen Daten, die die Scanner ohnehin erfassen (keine erfundenen Zahlen), in allen 16 Sprachen. Baut auf v1.85.0 (deutsche/italienische/türkische Sprachpakete), v1.84.0 (Abklingzeit für Neubewerbungen) und v1.83.0 (Repost-Detektor) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 41 Scanner-Adapter · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
