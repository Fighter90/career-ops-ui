...
> **🆕 Neueste Version — v1.207.0** — **Ergebnis aus dem Tracker erfassen** — jede Zeile erhält eine **Ergebnis**-Aktion: wähle, was passiert ist (abgelehnt / Angebot / eingestellt / abgelehnt / keine Antwort / Interview), sieh dir den resultierenden Status als Vorschau an und erfasse ihn. Es archiviert die eingereichten Artefakte und synchronisiert den Tracker-Status. **2618 Tests.**
>
