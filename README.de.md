...
> **🆕 Neueste Version — v1.216.0** — **Neun weitere LLM-Anbieter** — DeepSeek, GLM (Z.ai), Kimi, MiniMax, Mistral, Grok (xAI), Together, Fireworks und lokales Ollama kommen zur ⚡ Live-Bewertung hinzu (jetzt **16 Anbieter**), jeder mit einem Marken-Monogramm in den Einstellungen. **2752 Tests.**
>
