...
> **🆕 Neueste Version — v1.212.0** — **Job Bank (Kanada) + Fixes** — Kanadas föderales Board ist nun scannbar, Consider-Boards liefern wieder Ergebnisse, und Lever-Stellen mit mehreren Standorten zeigen alle Standorte. (EchoJobs stillgelegt — sein Feed ist bot-blockiert.) **2685 Tests.**
>
