...
> **🆕 Neueste Version — v1.183.0** — **Schlauere Dublettenerkennung** — der Scanner schlüsselt jede Stelle jetzt über eine kanonische URL, sodass dieselbe Stelle mit Tracking-Link (`?utm_…`), über `http`/`https` oder mit abschließendem Schrägstrich nicht mehr doppelt erscheint. **2477 Tests.**
>
