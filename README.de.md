...
> **🆕 Neueste Version — v1.199.0** — **Breite Tabellen scrollen seitwärts** — Tabellen, die breiter als das Fenster waren (Scan, Tracker, Statistik…), wurden ohne Bildlaufleiste abgeschnitten; sie zeigen jetzt bei Bedarf eine **horizontale Bildlaufleiste**, sodass jede Spalte erreichbar bleibt. **2540 Tests.**
>
