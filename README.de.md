...
> **🆕 Neueste Version — v1.167.0** — **Erhöhte Flächen von Haarlinien getrennt (Design-Fix)** — `--panel-2`/`--surface-elev1` lösten zum selben `--slate` wie die Rahmen auf, ohne Trennung. Ein dediziertes Theme-Token `--elev` trägt sie jetzt. **2428 Tests.**
>
