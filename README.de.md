...
> **🆕 Neueste Version — v1.101.0**
>
> **CV Studio: an einen Job anpassen + Anschreiben.** Eine neue Karte **An einen Job anpassen** auf `#/cv-studio` macht aus einer Stellenbeschreibung einen zugeschnittenen Lebenslauf plus ein passendes Anschreiben und führt beide durch ein recruitertaugliches **Checklisten-Gate** (Fehler blockieren, Warnungen raten). Aus der Karriere-Coaching-Praxis in generische Regeln destilliert — basiert nur auf deinem eigenen Lebenslauf, Profil und Two-Pager; es erfindet nie. Exportiere das Ergebnis als Markdown / PDF / DOCX.
>
> _Lebenslauf-Anpassung + Anschreiben · Two-Pager-Autofüllung · DOCX-Export · Portal-Gesundheit · integrierter Fehlermelder · 16 Sprachen · 6 LLM-Anbieter · 46 Scanner-Adapter · Berufsorientierung · Karriereplan · Statistik-Überarbeitung · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Parität mit dem übergeordneten career-ops v1.16.0._
