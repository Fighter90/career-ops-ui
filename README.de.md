...
> **🆕 Neueste Version — v1.182.0** — **Sprachneutrale Gehaltsspannen** — einseitige Beträge in Scan und Tracker erscheinen jetzt als `≥` / `≤` (z. B. `≥ 120000 EUR`) statt englischem „from" / „up to" und lesen sich in jeder Sprache gleich. **2470 Tests.**
>
