...
> **🆕 Neueste Version — v1.227.4** — **Präfix-Fix, Teil 2** — `word:` / `stem:` wurden von `content_filter` weiterhin ignoriert; v1.227.3 hatte nur den Titelfilter verdrahtet. Im KI-Review gefunden. **2858 Tests.**
