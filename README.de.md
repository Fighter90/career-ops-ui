...
> **🆕 Neueste Version — v1.189.0** — **`skip_tiers` spricht jetzt jede Sprache** — der Tier-Klassifikator liest römische Ziffern (I/II/III/IV/V) nach dem Berufswort in jeder Schrift („Инженер III", „エンジニア I", „Ingénieur IV"), nicht nur nach ASCII-Wörtern; zuvor fielen sie auf „mid" und rutschten an `skip_tiers` vorbei. **2498 Tests.**
>
