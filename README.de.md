...
> **🆕 Neueste Version — v1.90.0**
>
> **Mock Interview 2.0 (Epic 15):** eine neue **`#/mock-interview`**-Seite führt eine Interview-Probe Zug um Zug gegen eine konkrete Rolle. Jede Antwort erhält **STAR+R-Feedback**, einen **Score** und eine **Anschlussfrage** — verankert in deinem CV, deinem two-pager und deiner Story-Bank. Läuft live mit jedem LLM-Schlüssel oder liefert einen kopierfertigen Prompt, und du kannst **Transkripte** pro Unternehmen/Rolle speichern. Baut auf v1.89.0 (Markt-Fit über two-pager), v1.88.0 (Scan-i18n + API-Hygiene) und v1.87.0 (4 neue Scan-Anbieter) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · Mock-Interview · Markt-Fit über two-pager · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
