...
> **🆕 Neueste Version — v1.192.0** — **Fakten im Lebenslauf prüfen** — ein neuer Wächter in `#/cv-studio` prüft einen angepassten Lebenslauf oder ein Anschreiben gegen deinen echten Lebenslauf/dein Profil/den Two-Pager und markiert jede erfundene Kennzahl oder unbelegte Aussage (pass/warn/block). **2508 Tests.**
>
