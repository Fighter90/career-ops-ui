...
> **🆕 Neueste Version — v1.187.0** — **`skip_tiers` greift wieder** — eine `skip_tiers: [intern, entry]`-Liste in `portals.yml` verwirft beim Scan jetzt Stellen nach Senioritätsstufe (vorher still ignoriert). **2492 Tests.**
>
