...
> **🆕 Neueste Version — v1.194.0** — **Workday-Ein-Segment-URLs behoben** — Seiten wie `https://parsons.wd5.myworkdayjobs.com/Search` (ein Segment) verweisen jetzt auf den richtigen Job-Feed, statt still auf `External` zurückzufallen. Gemeldet in #255. **2517 Tests.**
>
