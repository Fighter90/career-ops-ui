...
> **🆕 Neueste Version — v1.173.0** — **Hermes tritt dem KI-CLI-Detektor bei** — der Tab `#/config` „KI-CLI-Werkzeuge" erkennt nun Hermes (Nous Research), die neue Agent-Laufzeit des Elternprojekts; schreibgeschützter PATH-Scan, 11 Werkzeuge. **2444 Tests.**
>
