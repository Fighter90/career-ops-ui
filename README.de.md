...
> **🆕 Neueste Version — v1.221.0** — **DNS-Rebinding-Härtung** — der Scanner weist nun jede Quelle ab, deren Host auf eine private/Loopback-/Cloud-Metadaten-Adresse (z. B. `169.254.169.254`) auflöst — Verteidigung in der Tiefe über den bestehenden SSRF-Schutz hinaus. **2775 Tests.**
>
