...
> **🆕 Neueste Version — v1.150.0** — **Konsistente Leerzustände** — jedes „noch nichts hier"-Panel wird jetzt über den gemeinsamen `.empty`-Stil gerendert; `#/activity`, `#/cv-studio`, `#/stats` und `#/usage` haben eine redundante Inline-Überschreibung entfernt, um zu allen anderen zu passen (tokenisiertes 48px-Padding + gestrichelter Rahmen). **2385 Tests.**
>
