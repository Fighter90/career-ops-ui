...
> **🆕 Neueste Version — v1.144.0** — **Einstellungen & Filter (Phase 4): verfolgte Portale aktivieren/deaktivieren** — ein beobachtetes Unternehmen auf `#/portals` ein-/ausschalten (`POST /api/portals/toggle`, chirurgischer portals.yml-Write); der Scanner überspringt bereits `enabled: false`-Unternehmen. **2368 Tests.**
>
