...
> **🆕 Neueste Version — v1.186.0** — **"Skill-Gap"-Panel in CV Studio** — wähle eine gespeicherte Stellenbeschreibung und sieh, welche ihrer geforderten Fähigkeiten dein CV nennt, nur andeutet oder fehlt — ohne LLM, nichts wird geschrieben. **2485 Tests.**
>
