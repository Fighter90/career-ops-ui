...
> **🆕 Neueste Version — v1.102.0**
>
> **Doku fragen — ein fundierter Hilfe-Chat.** Eine neue Seite **Doku fragen 💬** beantwortet How-to-Fragen mit **ausschließlich** dem Hilfe-Leitfaden der App in deiner Sprache (sie zeigt die verwendeten Abschnitte und liest nie deinen Lebenslauf oder deine Jobsuche). Abhängigkeitsfreie Schlüsselwortsuche über die `##`-Abschnitte des Leitfadens; das Modell antwortet daraus oder gibt zu, dass der Leitfaden es nicht abdeckt. Live mit LLM-Schlüssel oder ein Kopier-Prompt ohne.
>
> _Doku fragen · Lebenslauf-Anpassung + Anschreiben · Two-Pager-Autofüllung · DOCX-Export · Portal-Gesundheit · integrierter Fehlermelder · 16 Sprachen · 6 LLM-Anbieter · 46 Scanner-Adapter · Berufsorientierung · Karriereplan · Statistik-Überarbeitung · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Parität mit dem übergeordneten career-ops v1.16.0._
