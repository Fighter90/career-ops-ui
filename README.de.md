...
> **🆕 Neueste Version — v1.93.0**
>
> **Speicherschicht (Epic 24):** eine neue **`#/memory`**-Seite hält eine kurze, editierbare „das über mich merken"-Notiz. Weil sie in den geteilten Projektkontext eingebettet ist, steuert sie **jede** KI-Anfrage — Bewertung, Mock-Interview, Networking, CV Studio — über **alle** Anbieter hinweg. Sie erfasst deine Präferenzen und deinen Arbeitsstil (niemals neue Fakten über dich), und ein **aus-deinen-Daten-vorschlagen**-Helfer entwirft Verhaltens-Stichpunkte aus deinem Tracker zur Prüfung. Baut auf v1.92.0 (CV Studio), v1.91.0 (Networking-Planer) und v1.90.0 (Mock-Interview) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Marktstatistik nach Zielrolle · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
