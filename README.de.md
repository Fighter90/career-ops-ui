...
> **🆕 Neueste Version — v1.204.0** — **"Einrichtungs-Doktor" in den Einstellungen** — ein tokenfreier Check deines `cv.md` + `config/profile.yml`, der blockierende Probleme und Warnungen (Beispieldaten, hartkodierte Kennzahlen) auflistet, damit du eine unvollständige Einrichtung behebst, bevor sie Scans und Zuschnitte schwächt. **2602 Tests.**
>
