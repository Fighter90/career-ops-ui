...
> **🆕 Neueste Version — v1.94.0**
>
> **Statistik, überarbeitet (Epic 25):** die Seite **`#/stats`** ist jetzt ein **Statistik**-Bereich mit drei Tabs, mit echten Diagrammen und weit mehr Daten. Ein neuer Tab **Marktbericht** erzeugt eine KI-gestützte Gehalts- und Arbeitsmarktanalyse deiner Zielrollen — nach Stufe mit P10–P90-Perzentilen, Top-Arbeitgeber, gefragte Fähigkeiten, Zusatzleistungen, Remote-Aufteilung, Trends und Verhandlungshinweise, in der Region und **Währung** deiner Wahl (Zahlen als richtungsweisende Modellschätzungen gekennzeichnet, nie abgegriffen). Ein neuer Tab **Meine Pipeline** stellt deinen eigenen Tracker grafisch dar (Scores, Trichter, Top-Unternehmen/-Rollen, Zeitachse, Konversionsraten). Jeder Bericht lässt sich nach **Markdown oder PDF** exportieren. Baut auf v1.93.0 (Speicherschicht) und v1.92.0 (CV Studio) auf.
>
> _Statistik, überarbeitet · 16 Sprachen · 6 LLM-Anbieter · 45 Scanner-Adapter · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Repost-Detektor · Parität mit dem übergeordneten career-ops v1.16.0._
