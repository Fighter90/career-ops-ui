...
> **🆕 Neueste Version — v1.100.0**
>
> **KI-Autofüllung des Two-Pagers + Export.** Der Two-Pager (`#/two-pager`) füllt sich jetzt aus deinem Lebenslauf + Profil über deinen konfigurierten Anbieter (nichts erfunden; Prompt-kopieren-Fallback ohne Schlüssel), ergänzt eine **Vorschau und Export**-Ansicht und erhält Export als **PDF / DOCX / Markdown** — DOCX über einen neuen abhängigkeitsfreien `.docx`-Generator, auch in Markt-, Karriereplan- und Orientierungsberichte eingebunden.
>
> _Two-Pager-Autofüllung · DOCX-Export · Portal-Gesundheit · integrierter Fehlermelder · 16 Sprachen · 6 LLM-Anbieter · 46 Scanner-Adapter · Berufsorientierung · Karriereplan · Statistik-Überarbeitung · Speicherschicht · CV Studio · Networking-Planer · Mock-Interview · Markt-Fit über two-pager · Parität mit dem übergeordneten career-ops v1.16.0._
