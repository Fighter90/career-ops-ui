...
> **🆕 Neueste Version — v1.200.0** — **"Noch aktiv?"-Check für ATS-Jobs** — auf #/tracker fragt ein Klick das öffentliche JSON eines Greenhouse/Lever/Ashby/Workday/SmartRecruiters-Postings ab (null Tokens, kein Browser) und zeigt **Aktiv / Abgelaufen / Unbekannt**. **2557 Tests.**
>
