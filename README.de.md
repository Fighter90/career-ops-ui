...
> **🆕 Neueste Version — v1.227.0** — **Hongkong und schärfere Follow-ups** — JobsDB Hongkong kommt zu Jobstreet/SEEK hinzu (jetzt auf der v5-API), ein Nur-fällige-Filter auf dem Kadenz-Board, und vertrauliche Arbeitgeber zeigen die vermittelnde Agentur — Parität mit 1.30.0 des übergeordneten Projekts. **2837 Tests.**
