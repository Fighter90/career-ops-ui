...
> **🆕 Neueste Version — v1.222.0** — **Lokalisierte Anbieterhinweise** — die Schlüssel-, Modell- und Basis-URL-Hinweise der erweiterten Anbieter (DeepSeek … Volcengine Ark) unter Einstellungen → API-Schlüssel sind jetzt in alle 17 Sprachen übersetzt, nicht mehr nur Englisch. **2779 Tests.**
>
