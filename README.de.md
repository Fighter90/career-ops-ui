...
> **🆕 Neueste Version — v1.85.0**
>
> **Deutsche, italienische und türkische Sprachpakete** (Sprachparität mit dem übergeordneten career-ops v1.16.0): Die Oberfläche wird nun in **16 Sprachen** ausgeliefert — Deutsch 🇩🇪, Italiano 🇮🇹 und Türkçe 🇹🇷 gesellen sich zu den bestehenden 13, mit vollständiger Übersetzung der In-App-Hilfe, des README und des CHANGELOG sowie lokalisiertem LLM-Prompt-Gerüst. Baut auf v1.84.0 (Abklingzeit für Neubewerbungen + Vergütung), v1.83.0 (Repost-Detektor) und v1.82.0 (NoDesk) auf.
>
> _16 Sprachen · 6 LLM-Anbieter · 41 Scanner-Adapter · Repost-Detektor · Abklingzeit für Neubewerbungen · Parität mit dem übergeordneten career-ops v1.16.0._
