...
> **🆕 Neueste Version — v1.198.0** — **Intelligentere Scan-Wiederholungen** — wenn ein Board mitten im Scan kurz drosselt (HTTP 429/5xx), nutzen Wiederholungen jetzt **exponentielles Backoff + Jitter** und respektieren ein (geklemmtes) `Retry-After` statt einer festen kurzen Verzögerung. **2536 Tests.**
>
